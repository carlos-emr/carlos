...
def generate_radiology_report(filepath):
    """Generate fake diagnostic imaging / radiology report."""
    pdf = SimplePDFWriter()
    pdf.add_page([
        "# FAKE DIAGNOSTIC IMAGING REPORT",
        "",
        "## CARLOS EMR Development Radiology - FAKE DATA",
        "",
        "Patient: FAKE-Test FAKE-Patient          DOB: 1985-06-15",
        "Accession #: DEV-RAD-00001-FAKE          Exam Date: 2025-06-20",
        "Ordering Provider: Dr. FAKE-Development  Reported: 2025-06-21",
        "",
        ...
        "## FINDINGS",
        "",
        "Heart: Normal size and contour. Cardiomediastinal silhouette",
        "is within normal limits.",
        "",
        "Lungs: Clear bilaterally. No focal consolidation, pleural",
        "effusion, or pneumothorax identified.",
        "",
        "Mediastinum: Unremarkable. Trachea is midline.",
        "",
        "Osseous Structures: No acute fractures or destructive",
        "bone lesions identified. Degenerative changes noted in",
        "the thoracic spine, consistent with age.",
        "",
        "## IMPRESSION",
        "",
        ...
        "",
        "Reported by: Dr. FAKE-Radiologist (FAKE credentials)",
        "Dictated: 2025-06-21 14:30",
        "",
        "THIS IS A FAKE DOCUMENT FOR DEVELOPMENT PURPOSES ONLY.",
        "DO NOT USE FOR ANY CLINICAL DECISION MAKING.",
    ])
...
def generate_pathology_report(filepath):
    """Generate fake tissue pathology / biopsy report."""
    pdf = SimplePDFWriter()
    pdf.add_page([
        "# FAKE PATHOLOGY REPORT",
        "",
        "## CARLOS EMR Development Pathology - FAKE DATA",
        "",
        "Patient: FAKE-Test FAKE-Patient          DOB: 1985-06-15",
        "Accession #: DEV-PATH-00001-FAKE         Received: 2025-05-15",
        "Ordering Provider: Dr. FAKE-Development  Reported: 2025-05-18",
        "",
        "## SPECIMEN: Skin Biopsy, Left Forearm",
        "",
        "Clinical History: Small pigmented lesion noted on left",
        "forearm during routine skin check. Excisional biopsy performed.",
        "",
        "## GROSS DESCRIPTION",
        "",
        "Received in formalin is an ellipse of skin measuring",
        "1.2 x 0.8 x 0.4 cm with a centrally located pigmented",
        "lesion measuring 0.3 cm in greatest dimension.",
        "Specimen bisected and entirely submitted.",
        "",
        "## MICROSCOPIC DESCRIPTION",
        "",
        "Sections show skin with a benign compound melanocytic",
        "nevus. Nests of melanocytes are present at the dermal-",
        "epidermal junction and within the superficial dermis.",
        "Cells show maturation with depth. No cytologic atypia,",
        "mitotic figures, or evidence of malignancy identified.",
        "",
        "## DIAGNOSIS",
        "",
        "  Skin, left forearm, excisional biopsy:",
        "  BENIGN COMPOUND MELANOCYTIC NEVUS",
        "",
        "Pathologist: Dr. FAKE-Pathologist (FAKE credentials)",
        "",
        "THIS IS A FAKE DOCUMENT FOR DEVELOPMENT PURPOSES ONLY.",
        "DO NOT USE FOR ANY CLINICAL DECISION MAKING.",
    ])
...
def generate_insurance_letter(filepath):
    """Generate fake insurance coverage / authorization letter."""
    pdf = SimplePDFWriter()
    pdf.add_page([
        "# FAKE INSURANCE CORRESPONDENCE",
        "",
        "## FAKE Provincial Health Authority",
        "",
        "Date: June 10, 2025",
        "",
        "FAKE Health Insurance Corporation",
        "PO Box 00000, FAKE City, BC V0V 0V0",
        "Phone: 1-800-555-FAKE   Fax: 1-800-555-0000",
        "",
        "Re: Coverage Authorization",
        "Patient: FAKE-Test FAKE-Patient",
        "PHN: 0000-000-000 (FAKE)",
        "DOB: 1985-06-15",
        "",
        "Dear FAKE-Test FAKE-Patient,",
        "",
        "This letter confirms that your provincial health",
        "coverage is active and in good standing as of the",
        "date above.",
        "",
        "## Coverage Details (ALL FAKE)",
        "",
        "  Plan: FAKE Provincial Health Insurance",
        "  Group: DEV-00000",
        "  Effective Date: January 1, 2024",
        "  Status: Active",
        "",
        "## Covered Services (FAKE)",
        "",
        ...
        "",
        "Please present this letter along with your health",
        "card at your next appointment.",
        "",
        "Sincerely,",
        "FAKE Insurance Administrator",
        "",
        "THIS IS A FAKE DOCUMENT FOR DEVELOPMENT PURPOSES ONLY.",
    ])
    return pdf.write(filepath)
...
def generate_oldchart_summary(filepath):
    """Generate fake old chart transfer summary from previous clinic."""
    pdf = SimplePDFWriter()
    pdf.add_page([
        "# FAKE CHART TRANSFER SUMMARY",
        "",
        "## Patient Medical Record Transfer",
        "",
        "Transfer Date: March 15, 2025",
        "Transferring Clinic: FAKE Previous Family Practice",
        "Address: 789 FAKE Boulevard, Vancouver, BC V6T 0A0",
        "Receiving Clinic: CARLOS EMR Development Clinic",
        "",
        "Patient: FAKE-Test FAKE-Patient",
        "DOB: 1985-06-15      PHN: 0000-000-000 (FAKE)",
        "",
        "## Summary of Medical History (ALL FAKE)",
        "",
        "Active Problems:",
        "  - Essential hypertension (controlled) - dx 2019",
        "  - Seasonal allergies - dx 2010",
        "  - Mild intermittent asthma - dx childhood",
        "",
        ...
        "  - Influenza vaccine: Oct 2024",
        "  - COVID-19: 4 doses (last Dec 2023)",
        "  - Tdap booster: 2020",
        "",
        "## Allergies (FAKE)",
        "  - Penicillin (rash - reported, unconfirmed)",
        "  - NKDA otherwise",
        "",
        "## Current Medications (FAKE)",
        "  - Fake-artan 80mg PO daily",
        "  - Salbutamol inhaler PRN",
        "  - Cetirizine 10mg PO PRN",
        "",
        "Records enclosed: 47 pages (FAKE)",
        "Transferred by: Dr. FAKE-Previous FAKE-Physician",
        "",
        "THIS IS A FAKE DOCUMENT FOR DEVELOPMENT PURPOSES ONLY.",
    ])
    return pdf.write(filepath)
...
def generate_legal_consent(filepath):
    """Generate fake legal consent form."""
    pdf = SimplePDFWriter()
    pdf.add_page([
        "# FAKE CONSENT FOR TREATMENT",
        "",
        "## CARLOS EMR Development Clinic",
        "## Patient Consent and Authorization Form",
        "",
        "Patient Name: FAKE-Test FAKE-Patient",
        "Date of Birth: 1985-06-15",
        "Health Number: 0000-000-000 (FAKE)",
        "Date: June 1, 2025",
        "",
        "## Consent for General Medical Treatment",
        "",
        "I, FAKE-Test FAKE-Patient, hereby consent to receive",
        "medical care, treatment, and services as deemed",
        "necessary by my healthcare providers at CARLOS EMR",
        "Development Clinic.",
        "",
        "## Authorization for Release of Information",
        "",
        "I authorize the release of my medical information to:",
        "  - My referring physicians and specialists",
        "  - Provincial health insurance for billing purposes",
        "  - Emergency medical services as required",
        "",
        "## Acknowledgements (ALL FAKE)",
        "",
        "  [X] I have received the clinic privacy notice",
        "  [X] I understand my rights regarding my health info",
        "  [X] I consent to electronic storage of my records",
        "  [X] I may withdraw consent at any time in writing",
        "",
        "Patient Signature: ___FAKE_SIGNATURE___",
        "Date: June 1, 2025",
        "",
        "Witness: FAKE-Clinic FAKE-Staff",
        "Date: June 1, 2025",
        "",
        "THIS IS A FAKE DOCUMENT FOR DEVELOPMENT PURPOSES ONLY.",
    ])
...
def generate_misc_correspondence(filepath):
    """Generate fake miscellaneous clinical correspondence."""
    pdf = SimplePDFWriter()
    pdf.add_page([
        "# FAKE CLINICAL CORRESPONDENCE",
        "",
        "## CARLOS EMR Development Clinic - FAKE DATA",
        "",
        "Date: May 20, 2025",
        "",
        "From: Dr. FAKE-Family FAKE-Physician",
        "      CARLOS EMR Development Clinic",
        "      123 FAKE Street, Toronto, ON M5V 1A1",
        "",
        "To:   FAKE Community Health Services",
        "      456 FAKE Avenue, Toronto, ON M5V 2B2",
        "",
        "Re:   FAKE-Test FAKE-Patient",
        "      DOB: 1985-06-15",
        ...
        "",
        "This letter is written on behalf of my patient,",
        "FAKE-Test FAKE-Patient, who has been under my care",
        "since January 2024.",
        "",
        "The patient requires the following community health",
        "services (ALL FAKE):",
        "",
        "  - Home care nursing assessment",
        "  - Occupational therapy evaluation",
        "  - Physiotherapy referral for mobility",
        "",
        "Please contact our clinic to coordinate scheduling.",
        "",
        "Thank you for your assistance with this FAKE patient.",
        "",
        "Sincerely,",
        "Dr. FAKE-Family FAKE-Physician",
        "FAKE Medical License #DEV-00000",
        "",
        "THIS IS A FAKE DOCUMENT FOR DEVELOPMENT PURPOSES ONLY.",
    ])
...
DOCUMENT_GENERATORS = {
    ...
    # New scanned document types
    'FAKE_Radiology_Report.pdf': generate_radiology_report,
    'FAKE_Pathology_Report.pdf': generate_pathology_report,
    'FAKE_Insurance_Letter.pdf': generate_insurance_letter,
    'FAKE_OldChart_Summary.pdf': generate_oldchart_summary,
    'FAKE_Legal_Consent.pdf': generate_legal_consent,
    'FAKE_Miscellaneous_Document.pdf': generate_misc_correspondence,
}
