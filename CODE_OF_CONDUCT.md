# CARLOS EMR Code of Conduct

## Our Pledge

We as members, contributors, and maintainers of the CARLOS EMR project pledge to make
...
CARLOS is healthcare software used in clinical environments. We hold ourselves to a higher
standard because of the trust placed in us by healthcare providers and the patients they
serve. In addition to the general standards above:

- Never share, reference, or include real patient data (PHI) in issues, pull requests,
  discussions, or any public communication
- Respect the sensitive nature of healthcare workflows when discussing features and bugs
- Understand that reliability and security are not just technical goals — they directly
  affect patient care
...
issue tracker, pull requests, and any other forums used for project communication. It also
...
- **GitHub**: Open a report via [GitHub's reporting tools](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam) or contact a maintainer directly
...
The Healthcare Context section is specific to the CARLOS EMR project.
