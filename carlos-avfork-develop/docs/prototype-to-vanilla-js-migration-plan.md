...
- `encounter/js/encounter.js` — navbar section loading (3 calls)
...
- `encounter/js/encounter.js` (3 calls in navBarLoader)
...
| `WEB-INF/jsp/prevention/PreventionReporting.jsp` | Prototype + sortable.js |
...
**File**: `src/main/webapp/encounter/js/encounter.js`
...
**File**: `src/main/webapp/encounter/includes/encounter-head.jspf`
...
| `encounter/Index.jsp` | Legacy encounter page, Prototype + Ajax.Request |
| `encounter/LeftNavBarDisplay.jsp` | Generates `bindAsEventListener` / `Element.observe` JS dynamically from Java |
| `encounter/oscarMeasurements/AddMeasurementData.jsp` | Remove Prototype include |
...
- `encounter/Index.jsp` (lines 783, 808) — used as `postBody`
...
**Files**: `js/newCaseManagementView.js.jsp` (398 `$()` calls), `encounter/js/encounter.js` (~20), `encounter/LeftNavBarDisplay.jsp`, `encounter/Index.jsp`
...
- `encounter/js/encounter.js` — 3 `bindAsEventListener`, 6 observe/stopObserving
- `encounter/LeftNavBarDisplay.jsp` — dynamically generated from Java
...
**Files affected**: `encounter/js/encounter.js` (3 calls), `js/newCaseManagementView.js.jsp` (5 calls)
...
**Files affected**:
- `encounter/js/encounter.js` (lines 656-659) — template autocomplete
...
**Files affected**:
- `encounter/Index.jsp` (lines 787, 812) — `postBody: pars` (pre-serialized Form.serialize result)
