...
/**
 * View gate for {@code rx/SideLinksEditFavorites2.jsp} (formerly reachable at
 * {@code /rx/SideLinksEditFavorites2.jsp}). Enforces {@code _allergy} {@code r}
 * privilege before forwarding to the JSP at its {@code /WEB-INF/jsp/rx/}
 * location. Part of the oscarRx -> rx rebrand migration.
 *
 * @since 2026-04-13
 */
public final class ViewSideLinksEditFavorites22Action extends ActionSupport {
