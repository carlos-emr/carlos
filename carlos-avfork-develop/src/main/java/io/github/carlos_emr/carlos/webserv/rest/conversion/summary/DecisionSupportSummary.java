        ...
        for (DSGuideline dsGuideline : dsGuidelines) {
            ...
            try {
                ...
                for (DSConsequence dsConsequence : dsConsequences) {
                    ...
                    String url = "../encounter/decisionSupport/guidelineAction?method=detail&guidelineId=" + dsGuideline.getId() + "&provider_no=" + loggedInInfo.getLoggedInProviderNo() + "&demographic_no=" + demographicNo + "&parentAjaxId='); return false;";
