...
<script>
    ...
    function openVacancy(vacancyId) {
        document.programManagerForm.elements['vacancyOrTemplateId'].value = vacancyId || '';
...
<table id="vacancyTable" width="100%" border="1" cellspacing="2" cellpadding="3">
    ...
    <tr class="b">
        <td style="text-align:left;">
            <a onclick="openVacancy('<%=v.getId() %>');return false;" href="javascript:void(0)"><%=v.getName() %></a>
        </td>
        <td style="text-align:left;" class="beright"><%=(vt == null ? "No Template for This Vacancy" : vt.getName()) %></td>
