-- V1.0.18 — performance indexes for British Columbia billing (`billingmaster`).
-- See common/V1.0.3 and common/V1.0.17 for the rationale: forward migration so both fresh installs
...
-- common/V1.0.17__performance_indexes_2.sql, so this file takes V1.0.18 and the next free number for
-- ANY location is V1.0.19.
