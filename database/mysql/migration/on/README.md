...
The version line is global across `common` + `on`, so the next free number is `V1.0.25` (the
highest version in use, also on the Ontario path, is `common/V1.0.24` — see
