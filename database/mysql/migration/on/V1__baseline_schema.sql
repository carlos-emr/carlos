-- CARLOS consolidated schema baseline (Ontario) — GENERATED by build-baseline.sh, do not edit by hand.
-- Structure only (no seed/demo data). Captured from the devcontainer script build:
-- createdatabase_generic.sh on 9 + the required updates/*.sql. Regenerate with build-baseline.sh.
