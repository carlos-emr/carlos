...
CREATE TABLE IF NOT EXISTS `fax_config` (
  ...
  `rc_client_id` varchar(128) DEFAULT NULL,
  `rc_client_secret` text DEFAULT NULL,
  `rc_jwt_token` text DEFAULT NULL,
  `rc_account_id` varchar(64) DEFAULT NULL,
  `rc_extension_id` varchar(64) DEFAULT NULL,
