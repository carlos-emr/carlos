...
--
-- Table `formAR` deprecated
-- Table `formAdf` deprecated
--
...
--
-- Table `formType2Diabetes` deprecated
--
...
CREATE TABLE IF NOT EXISTS `fax_config` (
  ...
  `hf_host` varchar(255) DEFAULT '',
  `hf_port` int DEFAULT 4559,
  `hf_username` varchar(64) DEFAULT '',
  `hf_password` varchar(255) DEFAULT '',
  `hf_modem` varchar(32) DEFAULT '',
  `hf_use_ssh` tinyint(1) DEFAULT 0,
  `hf_ssh_key` text,
  `hf_recvq_path` varchar(255) DEFAULT '',
