# OHIP Remittance Advice Explanatory Codes/Messages

> **Source**: <https://www.health.gov.on.ca/en/pro/programs/ohip/claims_submission/remittance_advice_explanatory_codes.pdf>
> **Fetched**: 2026-04-29
> **Pages**: 14
...
Remittance advice explanatory codes/messages clarify payment exceptions found in a monthly remittance advice statement of approved claims. These codes are at times referred to simply as “Explanatory codes” or “Explan codes”.

| Code | Description |
|------|-------------|
| 30 | Service is not a benefit of OHIP (Ontario Health Insurance Plan) |
...
| 37 | Effective April 1, 1993 the listed benefit for this code is 0 Laboratory Medicine Services (LMS) units |
...
| 42 | FSC Billed Included in Other Procedure |
| 45 | Specialty code restriction on Fee Schedule Code |
| 46 | Paid Per 2nd Review by Medical Advisor (MA) |
...
| AH | Not allowed in addition to health exam |
...
| B4 | Virtual Service not allowed in addition to In-Person Equivalent Service |
...
| E3 | Version Code not on File for HN (Health Number) |
...
| EP | This payment is an adjustment of an earlier account due to provider registration update |
...
| J5 | Coverage Applied For; Premiums Not Yet Paid |
...
| ME | Maximum number of e-assessments paid |
...
| MY | Yearly maximum has been exceeded |
...
| P8 | Health Care Connect greater than 3 months |
...
| RD | Duplicate, paid in Reciprocal Medical Billing System (RMBS) |
...
| V5 | Only one Oculo-Visual Assessment (OVA) allowed within a 12-month period for age 19 and under, or 65 and over-and one within 24 months for age 20-64 |
...
| VB | Additional Oculo-Visual Assessment (OVA) is allowed once within the second year for patients aged 20-64, following a periodic OVA |
| VC | Procedure Paid Previously Not Allowed In Addition To Visit Fee. Fee Adjusted To Pay The Difference |
...
| VR | Visit reduced premium not applicable |
| VS | Date of service was a Saturday, Sunday or statutory holiday |
| VX | Complexity premium not applicable to visit fee |
| W3 | Warning: - Service date is older than 3 months |
| W4 | Warning:-service location indicator code missing |
| X2 | Gastrointestinal (G.I.) tract includes cine and video tape |
| X3 | Gastrointestinal (G.I.) tract includes survey film of abdomen |
| X4 | Only one Bone Mineral Density (BMD) allowed within a 36 month period for a low risk patient |
| X5 | Only one Bone Mineral Density (BMD) allowed within a 12 month period for a high risk patient |
| X6 | Only one Bone Mineral Density (BMD) allowed within a 60 month period for a low risk patient |
