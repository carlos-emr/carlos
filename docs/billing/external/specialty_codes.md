# OHIP Specialty Codes

> **Source**: <https://www.health.gov.on.ca/en/pro/programs/ohip/claims_submission/specialty_codes.pdf>
> **Fetched**: 2026-04-29
> **Pages**: 5
...
This is a list of health care provider specialties or disciplines recognized by the Royal College of Physicians and Surgeons of Canada relevant to services covered by the Ministry of Health.

### Physician specialty codes

| Code | Specialty / Discipline |
|------|------------------------|
...
### Practitioner specialty codes

| Code | Specialty / Discipline |
|------|------------------------|
| 56 | Optometry / Optometrist |
| 57 | Osteopathy |
...
| 86 | Generic Referral |
| 90 | Independent Health Facility (IHF) Non-Medical Practitioner (Provider Number Must Be 991000) |
| 99 | RMBS OOP/OOC |
