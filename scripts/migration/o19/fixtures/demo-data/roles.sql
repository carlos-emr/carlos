...
-- includes the removed-module object _pmm the merge must not carry
...
INSERT INTO `provider` (`provider_no`, `last_name`, `first_name`, `provider_type`, `specialty`, `status`, `lastUpdateUser`, `lastUpdateDate`) VALUES
  ('999901', 'FIXTURE', 'TRIAGE', 'nurse', 'Triage', '1', '999998', NOW()),
  ('999902', 'FIXTURE', 'NULLROLE', 'doctor', 'Family Practice', '1', '999998', NOW()),
  ('999903', 'FIXTURE', 'EXPIRED', 'doctor', 'Family Practice', '1', '999998', NOW());
...
INSERT INTO `secUserRole` (`provider_no`, `role_name`, `orgcd`, `activeyn`, `lastUpdateDate`) VALUES
  ('999901', 'Triage Nurse', 'R0000001', 1,    NOW()),
  ('999902', 'doctor',       'R0000001', NULL, NOW()),
  ('999903', 'doctor',       'R0000001', 1,    NOW());

-- a second document queue with its privilege object (rides in through the
-- merge; the queue itself is replace_seed)
...
-- a legacy prevention type code (Flu -> Inf under Health Canada naming)
INSERT INTO `preventions` (`demographic_no`, `creation_date`, `prevention_date`, `provider_no`, `prevention_type`, `deleted`, `refused`, `never`, `creator`, `lastUpdateDate`)
  SELECT MIN(`demographic_no`), NOW(), '2019-11-01 00:00:00', '999998', 'Flu', '0', '0', '0', 999998, NOW() FROM `demographic`;
