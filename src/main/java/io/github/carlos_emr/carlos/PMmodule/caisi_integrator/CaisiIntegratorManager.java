...
import io.github.carlos_emr.carlos.caisi_integrator.ws.transfer.FacilityConsentPair;
...
import io.github.carlos_emr.carlos.caisi_integrator.ws.ConnectException_Exception;
...
import io.github.carlos_emr.carlos.caisi_integrator.ws.DemographicWsService;
import io.github.carlos_emr.carlos.caisi_integrator.ws.DuplicateHinExceptionException;
...
import io.github.carlos_emr.carlos.caisi_integrator.ws.FacilityWsService;
import io.github.carlos_emr.carlos.caisi_integrator.ws.GetConsentTransfer;
import io.github.carlos_emr.carlos.caisi_integrator.ws.HnrWs;
import io.github.carlos_emr.carlos.caisi_integrator.ws.HnrWsService;
import io.github.carlos_emr.carlos.caisi_integrator.ws.InvalidHinExceptionException;
import io.github.carlos_emr.carlos.caisi_integrator.ws.MatchingDemographicParameters;
import io.github.carlos_emr.carlos.caisi_integrator.ws.ProgramWs;
import io.github.carlos_emr.carlos.caisi_integrator.ws.ProgramWsService;

import io.github.carlos_emr.carlos.caisi_integrator.ws.ProviderWs;
import io.github.carlos_emr.carlos.caisi_integrator.ws.ProviderWsService;
import io.github.carlos_emr.carlos.caisi_integrator.ws.ReferralWs;
import io.github.carlos_emr.carlos.caisi_integrator.ws.ReferralWsService;
...
import io.github.carlos_emr.carlos.commn.model.IntegratorConsent.ConsentStatus;
import io.github.carlos_emr.carlos.commn.model.IntegratorConsent.SignatureStatus;
...
public class CaisiIntegratorManager {
    ...
    public static io.github.carlos_emr.carlos.ws.Client getHnrClient(LoggedInInfo loggedInInfo, Facility facility, Integer linkingId) throws MalformedURLException, ConnectException_Exception {
        HnrWs hnrWs = getHnrWs(loggedInInfo, facility);
        io.github.carlos_emr.carlos.ws.Client client = hnrWs.getHnrClient(linkingId);
        return (client);
    }

    public static Integer setHnrClient(LoggedInInfo loggedInInfo, Facility facility, io.github.carlos_emr.carlos.ws.Client hnrClient) throws MalformedURLException, DuplicateHinExceptionException, InvalidHinExceptionException, ConnectException_Exception {
        HnrWs hnrWs = getHnrWs(loggedInInfo, facility);
    ...
    public static void pushConsent(LoggedInInfo loggedInInfo, Facility facility, IntegratorConsent integratorConsent) throws MalformedURLException {
        if (integratorConsent.getClientConsentStatus() == ConsentStatus.GIVEN || integratorConsent.getClientConsentStatus() == ConsentStatus.REVOKED) {
            ...
            io.github.carlos_emr.carlos.caisi_integrator.ws.SetConsentTransfer consentTransfer = makeSetConsentTransfer(integratorConsent);
     ...
     */
    private static io.github.carlos_emr.carlos.caisi_integrator.ws.SetConsentTransfer makeSetConsentTransfer(IntegratorConsent integratorConsent) {
        Calendar calendar = Calendar.getInstance();
        io.github.carlos_emr.carlos.caisi_integrator.ws.SetConsentTransfer consentTransfer = new io.github.carlos_emr.carlos.caisi_integrator.ws.SetConsentTransfer();
        ...
        for (Entry<Integer, Boolean> entry : integratorConsent.getConsentToShareData().entrySet()) {
            io.github.carlos_emr.carlos.caisi_integrator.ws.FacilityConsentPair pair = new io.github.carlos_emr.carlos.caisi_integrator.ws.FacilityConsentPair();
