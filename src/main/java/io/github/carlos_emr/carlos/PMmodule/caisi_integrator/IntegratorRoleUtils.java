...
public final class IntegratorRoleUtils {
     ...
     */
    public static io.github.carlos_emr.carlos.caisi_integrator.ws.Role getIntegratorRole(String oscarRole) {
        if (oscarRole == null) return (null);

        try {
            return (io.github.carlos_emr.carlos.caisi_integrator.ws.Role.valueOf(oscarRole.toUpperCase().replaceAll(" ", "_")));
        } catch (Exception e) {
