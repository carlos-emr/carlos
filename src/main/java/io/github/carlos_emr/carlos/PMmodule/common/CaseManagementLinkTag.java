...
public class CaseManagementLinkTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            builder.append("providerNo=").append(Encode.forUriComponent(providerNo)).append("&");
            builder.append("appointmentNo=").append(0).append("&");
            builder.append("demographicNo=").append(demographicNo).append("&");
            builder.append("curProviderNo=").append(Encode.forUriComponent(providerNo)).append("&");
            builder.append("reason=").append("&");
            builder.append("userName=").append(Encode.forUriComponent(providerName)).append("&");
