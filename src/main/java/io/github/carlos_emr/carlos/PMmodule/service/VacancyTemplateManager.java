		...
		*/
        ...
        if (!ctype.getFieldType().equalsIgnoreCase("number")) {
            ...
            for (CriteriaTypeOption option : options) {
                ...
                String htmlEscapedName = Encode.forHtmlAttribute(label);
                ...
                sb.append("<option " + selectedOrNot + " value=\"" + Encode.forHtmlAttribute(option.getOptionValue()) + "\" title=\"" + htmlEscapedName + "\">" + htmlEscapedName + "</option>");
        ...
        if (ctype.getFieldType().equalsIgnoreCase("select_one_range")) {
            ...
            for (CriteriaSelectionOption cso : selectedOptions) {
                ...
                sb.append("<option " + selected + " value=\"" + Encode.forHtmlAttribute(option2.getOptionValue()) + "\" title=\"" + htmlEscapedName + "\">" + htmlEscapedName + "</option>");
            }
