...
/**
 * View gate for {@code PMmodule/Admin/Facility/ListFacilities.jsp}. The PMmodule tree is filter-gated
 ...
 * @since 2026-04-13
 */
public final class ViewFacilityList2Action extends ActionSupport {

    private SecurityInfoManager securityInfoManager = SpringUtils.getBean(SecurityInfoManager.class);

    /**
     * Validates the current user's {@code _admin} read privilege before
     * forwarding to the facility list JSP via the Struts {@code success}
     * result.
     *
