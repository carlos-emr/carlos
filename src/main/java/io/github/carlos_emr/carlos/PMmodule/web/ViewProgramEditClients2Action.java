...
/**
 * View gate for {@code PMmodule/Admin/ProgramEdit/clients.jsp}. The PMmodule tree is filter-gated
 ...
 * @since 2026-04-13
 */
public final class ViewProgramEditClients2Action extends ActionSupport {

    private SecurityInfoManager securityInfoManager = SpringUtils.getBean(SecurityInfoManager.class);

    /**
     * Validates the current user's {@code _admin} read privilege before
     * forwarding to the program edit clients JSP via the Struts
     * {@code success} result.
     *
