...
/**
 * View gate for {@code PMmodule/Admin/ProgramView/vacancies.jsp}. The PMmodule tree is filter-gated
 ...
 * @since 2026-04-13
 */
public final class ViewProgramViewVacancies2Action extends ActionSupport {

    private SecurityInfoManager securityInfoManager = SpringUtils.getBean(SecurityInfoManager.class);

    /**
     * Validates the current user's {@code _admin} read privilege before
     * forwarding to the program view vacancies JSP via the Struts
     * {@code success} result.
     *
