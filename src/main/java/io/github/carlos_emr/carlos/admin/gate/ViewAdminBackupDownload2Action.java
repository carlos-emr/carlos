...
/**
 * View gate for {@code admin/adminbackupdownload.jsp}. Requires {@code r} on {@code _admin} or {@code _admin.backup} (matches the source JSP's {@code <security:oscarSec>} OR-list) before forwarding
 ...
 * @since 2026-04-13
 */
public final class ViewAdminBackupDownload2Action extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        if (!authorized) {
            throw new SecurityException("missing required security object: _admin or _admin.backup");
        }
