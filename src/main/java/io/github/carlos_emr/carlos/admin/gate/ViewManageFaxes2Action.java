...
/**
 * View gate for {@code admin/manageFaxes.jsp}. Requires {@code r} on {@code _admin} or {@code _admin.fax} (matches the source JSP's {@code <security:oscarSec>} OR-list) before forwarding
 ...
 * @since 2026-04-13
 */
public final class ViewManageFaxes2Action extends ActionSupport {
