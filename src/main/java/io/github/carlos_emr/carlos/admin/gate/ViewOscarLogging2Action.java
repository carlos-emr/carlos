...
/**
 * View gate for {@code admin/oscarLogging.jsp}. Requires {@code r} on {@code _admin} or {@code _admin.reporting} (matches the source JSP's {@code <security:oscarSec>} OR-list) before forwarding
 ...
 * @since 2026-04-13
 */
public final class ViewOscarLogging2Action extends ActionSupport {
