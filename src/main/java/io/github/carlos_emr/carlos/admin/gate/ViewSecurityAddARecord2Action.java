...
/**
 * View gate for {@code admin/securityaddarecord.jsp}. Requires {@code r} on {@code _admin} or {@code _admin.userAdmin} (matches the source JSP's {@code <security:oscarSec>} OR-list) before forwarding
 ...
 * @since 2026-04-13
 */
public final class ViewSecurityAddARecord2Action extends ActionSupport {

    private final transient SecurityInfoManager securityInfoManager;

    public ViewSecurityAddARecord2Action(SecurityInfoManager securityInfoManager) {
