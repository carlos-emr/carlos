...
/**
 * View gate for {@code admin/traceReport.jsp}. Requires {@code r} on {@code _admin} or {@code _admin.traceability} (matches the source JSP's {@code <security:oscarSec>} OR-list) before forwarding
 ...
 * @since 2026-04-13
 */
public final class ViewTraceReport2Action extends ActionSupport {
