...
/**
 * Security gate for the Resource Base URL admin page.
 *
 * <p>Requires {@code _admin} write privilege. When a mutation parameter
 * ({@code websiteSave} or {@code detailsSave}) is present, a POST request is
...
public class ResourceBaseUrl2Action extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        boolean isMutation = request.getParameter("websiteSave") != null
                || request.getParameter("detailsSave") != null;
