...
/**
 * JPA entity representing an HL7 PID (Patient Identification) segment in the BC PathNet lab integration.
 * Maps to the {@code hl7_pid} table, storing patient identification fields including
 * name, external ID (health insurance number), and message association.
 *
 * @since 2026-03-17
 */
@Entity
