...
/**
 * Represents the GST report for billing administration in British Columbia. Contains operations to generate and manage GST records.
 */
public class GstReport {

    public Vector<Properties> getGST(LoggedInInfo loggedInInfo, String[] providerNos, String startDate, String endDate) {
        // Initialize execution context for GstReport
