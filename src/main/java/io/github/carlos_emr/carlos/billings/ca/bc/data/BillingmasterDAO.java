...
/**
 * Core repository for the master billing records, acting as the central aggregate root for all financial claims generated by the clinic.
 */
@Repository
@SuppressWarnings("unchecked")
@Transactional(propagation = Propagation.REQUIRES_NEW)
public class BillingmasterDAO {
    // We use pessimistic locking on the master record during updates to prevent concurrent modifications from batch processing and UI edits.
