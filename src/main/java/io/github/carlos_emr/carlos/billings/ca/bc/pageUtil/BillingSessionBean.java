...
/**
 * Session-scoped bean holding the state of a user's current billing workflow.
 * Maintains context such as selected patient, active invoice, and temporary changes.
 */
