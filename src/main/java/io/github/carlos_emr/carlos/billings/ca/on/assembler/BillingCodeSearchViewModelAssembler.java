...
public class BillingCodeSearchViewModelAssembler {
    ...
    public BillingCodeSearchViewModelAssembler(BillingServiceDao billingServiceDao, IchppccodeDao ichppccodeDao) {
