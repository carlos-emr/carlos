 ...
 * @since 2026-04-26
 */
public final class BillingON3rdInvDataAssembler {
     ...
     * @return populated view model. {@link BillingON3rdInvViewModel#isInvoiceLoaded()}
    ...
    public BillingON3rdInvViewModel assemble(HttpServletRequest request, LoggedInInfo loggedInInfo) {
        ...
        BillingON3rdInvViewModel.Builder b = BillingON3rdInvViewModel.builder()
        ...
        for (BillingONItem item : billingItems) {
            ...
            itemRows.add(new BillingON3rdInvViewModel.InvoiceItem(
    ...
    private void populateClinicHeader(BillingON3rdInvViewModel.Builder b,
                                      boolean isMultisite,
                                      String siteName,
    ...
    private void populatePatientHeader(BillingON3rdInvViewModel.Builder b, BillingONCHeader1 bCh1) {
