...
/**
 * Assembles {@link BillingOhipBillingHistoryViewModel} for {@code billingOB2.jsp}, the
...
public class BillingOhipBillingHistoryViewModelAssembler {
    ...
    public BillingOhipBillingHistoryViewModelAssembler(BillingDao billingDao,
     ...
     *         in that case.
     */
    public BillingOhipBillingHistoryViewModel assemble(String billingNo) {
        BillingOhipBillingHistoryViewModel.Builder b = BillingOhipBillingHistoryViewModel.builder();
    ...
    private void applyBill(BillingOhipBillingHistoryViewModel.Builder b, Billing bill) {
    ...
    private void applyDemo(BillingOhipBillingHistoryViewModel.Builder b, String demoNo) {
    ...
    private void applyProviderFields(BillingOhipBillingHistoryViewModel.Builder b, Billing bill) {
