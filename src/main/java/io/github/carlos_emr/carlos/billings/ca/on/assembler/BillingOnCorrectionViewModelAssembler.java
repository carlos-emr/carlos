...
public class BillingOnCorrectionViewModelAssembler {
    ...
    public BillingOnCorrectionViewModelAssembler(SecurityInfoManager securityInfoManager,
    ...
    public BillingOnCorrectionViewModel assemble(HttpServletRequest request, LoggedInInfo loggedInInfo) {
        ...
        if (renderContextComposer != null) {
            ...
            // Render-helpers (multisite per-site provider HTML, BillingOnConstants
    ...
    private BillRecordContext loadBillRecord(LoggedInInfo loggedInInfo,
        ...
        // a BillingOnRaService regression is visible to ops.
        try {
