...
/**
 * Mutation gate for {@code billing/CA/ON/inr/onGenINRbilling.jsp}. The JSP's scriptlet
 * performs INR billing merge. Enforces {@code _billing} w privilege AND POST-only
