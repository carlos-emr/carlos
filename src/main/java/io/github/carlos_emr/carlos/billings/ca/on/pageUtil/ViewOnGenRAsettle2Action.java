...
/**
 * Mutation gate for {@code billing/CA/ON/onGenRAsettle.jsp}. The JSP's scriptlet
 * performs RA header settle merge. Enforces {@code _billing} w privilege AND POST-only
