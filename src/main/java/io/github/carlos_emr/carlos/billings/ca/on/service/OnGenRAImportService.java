 ...
 * service before the read-only {@code OnGenRADataAssembler} builds the view
 * model.</p>
 */
@Service
public class OnGenRAImportService {

    private final BillingONRemittanceAdviceService remittanceAdviceService;

    public OnGenRAImportService(BillingONRemittanceAdviceService remittanceAdviceService) {
