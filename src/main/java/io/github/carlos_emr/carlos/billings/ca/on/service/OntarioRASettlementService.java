...
public class OntarioRASettlementService {
    ...
    public OntarioRASettlementService(RaHeaderDao raHeaderDao, RaDetailDao raDetailDao, BillingRAReportService billingRAReportService) {
