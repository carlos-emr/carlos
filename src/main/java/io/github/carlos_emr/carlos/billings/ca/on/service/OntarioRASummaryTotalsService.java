...
@Service
public class OntarioRASummaryTotalsService {

    private final RaHeaderDao raHeaderDao;

    public OntarioRASummaryTotalsService(RaHeaderDao raHeaderDao) {
        this.raHeaderDao = raHeaderDao;
    }

    @Transactional
    public void mergeTotals(OntarioRASummaryViewModel model) {
        if (model == null) {
            return;
        }
