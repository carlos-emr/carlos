 ...
 * @since 2026-04-26
 */
public final class BillingDiagCodeSearchAjaxViewModel {

    private final List<Suggestion> suggestions;

    public record Suggestion(String value, String label, String code, String description) {}

    private BillingDiagCodeSearchAjaxViewModel(Builder b) {
    ...
    public static final class Builder {
        ...
        public BillingDiagCodeSearchAjaxViewModel build() { return new BillingDiagCodeSearchAjaxViewModel(this); }
    }
}
