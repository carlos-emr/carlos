 ...
 * @since 2026-04-26
 */
public final class BillingDiagCodeUpdateViewModel {

    private final boolean error;

    private BillingDiagCodeUpdateViewModel(Builder b) {
        this.error = b.error;
    }
    ...
    public static final class Builder {
        ...
        public BillingDiagCodeUpdateViewModel build() { return new BillingDiagCodeUpdateViewModel(this); }
    }
}
