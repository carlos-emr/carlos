...
/**
 * Provider-picker and assigned-provider presentation data for the form.
 */
public record BillingOnProviderPresentation(
        String providerView,
        String assgProviderNo,
        String assgProviderDisplay,
        List<BillingOnFormViewModel.ProviderOption> providers) {

    public static final BillingOnProviderPresentation EMPTY = new BillingOnProviderPresentation(
            "", "", "", List.of());
