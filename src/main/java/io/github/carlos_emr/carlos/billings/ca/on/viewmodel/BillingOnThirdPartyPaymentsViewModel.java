 ...
 * {@link io.github.carlos_emr.carlos.billings.ca.on.web.BillingOnPayments2Action}
 * and is exposed as {@code paymentsViewModel} on the request.</p>
 *
 * @since 2026-04-25
 */
public final class BillingOnThirdPartyPaymentsViewModel {
    ...
    private BillingOnThirdPartyPaymentsViewModel(Builder b) {
    ...
    public static final class Builder {
        ...
        public BillingOnThirdPartyPaymentsViewModel build() { return new BillingOnThirdPartyPaymentsViewModel(this); }
    }
}
