 ...
 * @since 2026-04-25
 */
public class BillingLreport2Action extends ActionSupport {

    private final SecurityInfoManager securityInfoManager;

    public BillingLreport2Action(SecurityInfoManager securityInfoManager) {
    ...
    public String execute() throws Exception {
        ...
        BillingLreportViewModel model = BillingLreportViewModel.builder()
                .filename(filename)
                .xslName(xslName)
