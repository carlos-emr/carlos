...
/**
 * AJAX endpoint for jQuery-UI Autocomplete on ICD-9 diagnostic codes.
 ...
 * @since 2026-04-26
 */
public class ViewBillingDiagSearchAjax2Action extends ActionSupport {
    ...
    public ViewBillingDiagSearchAjax2Action(SecurityInfoManager securityInfoManager,
    ...
    public String execute() {
        ...
        try {
            ...
            MiscUtils.getLogger().warn("Failed to write dx code search response", e);
        }
        return NONE;
    }
}
