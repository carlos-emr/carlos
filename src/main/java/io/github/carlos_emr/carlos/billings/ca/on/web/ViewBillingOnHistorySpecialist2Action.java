 ...
 * {@code r} privilege and assembles a {@link BillingOnHistorySpecialistViewModel}
 * via {@link BillingOnHistorySpecialistViewModelAssembler} so the JSP can render the
 * pre-resolved billing history rows instead of doing date-range math and
 * JDBC lookups inline.
 *
 * @since 2026-04-13
 */
public class ViewBillingOnHistorySpecialist2Action extends ActionSupport {

    private final SecurityInfoManager securityInfoManager;

    private final BillingOnHistorySpecialistViewModelAssembler billingONHistorySpecAssembler;

    public ViewBillingOnHistorySpecialist2Action(SecurityInfoManager securityInfoManager,
                                            BillingOnHistorySpecialistViewModelAssembler billingONHistorySpecAssembler) {
    ...
    public String execute() throws Exception {
        ...
        BillingOnHistorySpecialistViewModel model = billingONHistorySpecAssembler.assemble(
