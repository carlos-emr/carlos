 ...
 * @since 2026-04-13
 */
public class ViewBillingOnThirdPartyInvoice2Action extends ActionSupport {

    private final SecurityInfoManager securityInfoManager;

    private final BillingOnThirdPartyInvoiceViewModelAssembler billingON3rdInvAssembler;

    public ViewBillingOnThirdPartyInvoice2Action(SecurityInfoManager securityInfoManager,
