...
/**
 * Mutation gate for {@code billing/CA/ON/inr/genINRbilling.jsp}. The JSP's scriptlet
 * performs INR billing persist/merge batch. Enforces {@code _billing} w privilege AND POST-only
