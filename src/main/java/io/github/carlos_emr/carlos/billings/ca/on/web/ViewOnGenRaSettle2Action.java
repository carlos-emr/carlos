 ...
 * {@link OnRaSettlementService#settle} runs the mutation that the JSP
...
public class ViewOnGenRaSettle2Action extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        settlementService.settle(request.getParameter("rano"), OnRaSettlementService.Mode.STANDARD);
