 ...
 * {@link BillingOnDiskService#regenerateDisk}; this action enforces
 * {@code _billing} {@code w} + POST and chains to the display action.
 *
 * @since 2026-04-13
 */
public class ViewOnReportRegeneration2Action extends ActionSupport {

    private final SecurityInfoManager securityInfoManager;
    private final BillingOnDiskService onBillingDiskService;

    public ViewOnReportRegeneration2Action(SecurityInfoManager securityInfoManager,
