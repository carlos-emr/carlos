 ...
 * OnSearch3rdBillAddrViewModel} the JSP renders so the JSP body is pure
 * EL/JSTL.
 *
 * @since 2026-04-13
 */
public class ViewOnSearch3rdBillAddr2Action extends ActionSupport {
     ...
     */
    public OnSearch3rdBillAddrViewModel assembleViewModel(HttpServletRequest request) {
        ...
        List<OnSearch3rdBillAddrViewModel.AddressEntry> addresses = new ArrayList<>();
        ...
        if (searched) {
            ...
            for (Billing3rdPartyAddress ba : billing3rdPartyAddressDao.findAddresses(searchMode, orderBy, keyword, strLimit1, strLimit2)) {
                ...
                addresses.add(new OnSearch3rdBillAddrViewModel.AddressEntry(
                        prop.getProperty("id"),
        ...
        return OnSearch3rdBillAddrViewModel.builder()
                .param(paramVal)
                .param2(param2Val)
