...
package io.github.carlos_emr.carlos.billings.data;
...
/**
 * Data access helper for billing form reference data including diagnostic codes,
 * service codes, visit types, and billing location lookups.
 *
 * @since 2001-01-01
 */
public class BillingFormData {
    ...
    public BillingService[] getServiceList(String serviceGroup, String serviceType, String billRegion) {
        ...
        for (io.github.carlos_emr.carlos.commn.model.BillingService bs : dao.findByRegionGroupAndType(billRegion, serviceGroup, serviceType)) {
    ...
    public String getServiceDesc(String code, String reg) {
        String codeDesc = "";
        BillingServiceDao dao = SpringUtils.getBean(BillingServiceDao.class);
        for (io.github.carlos_emr.carlos.commn.model.BillingService bs : dao.findBillingCodesByCode(code, reg)) {
