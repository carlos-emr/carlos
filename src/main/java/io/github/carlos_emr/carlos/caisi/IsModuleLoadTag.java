...
/**
 * Custom JSP tag used to determine if a specific CAISI module is loaded or active.
 * Enables conditional rendering of UI elements based on module availability.
 */
