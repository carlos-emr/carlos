...
public class EventLog extends AbstractModel<Long> implements PersistenceCapable
{
    ...
    public Object pcNewObjectIdInstance(final Object o) {
        return new LongId((EventLog.class$Lca$openosp$openo$caisi_integrator$dao$EventLog != null) ? EventLog.class$Lca$openosp$openo$caisi_integrator$dao$EventLog : (EventLog.class$Lca$openosp$openo$caisi_integrator$dao$EventLog = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.EventLog")), (String)o);
    }
    ...
    public Object pcNewObjectIdInstance() {
        return new LongId((EventLog.class$Lca$openosp$openo$caisi_integrator$dao$EventLog != null) ? EventLog.class$Lca$openosp$openo$caisi_integrator$dao$EventLog : (EventLog.class$Lca$openosp$openo$caisi_integrator$dao$EventLog = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.EventLog")), this.id);
    }
