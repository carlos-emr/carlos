...
import io.github.carlos_emr.carlos.caisi_integrator.util.EncryptionUtils;
...
public class Facility extends AbstractModel<Integer> implements Named, PersistenceCapable
{
    ...
    public Object pcNewObjectIdInstance(final Object o) {
        return new IntId((Facility.class$Lca$openosp$openo$caisi_integrator$dao$Facility != null) ? Facility.class$Lca$openosp$openo$caisi_integrator$dao$Facility : (Facility.class$Lca$openosp$openo$caisi_integrator$dao$Facility = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.Facility")), (String)o);
    }
    ...
    public Object pcNewObjectIdInstance() {
        return new IntId((Facility.class$Lca$openosp$openo$caisi_integrator$dao$Facility != null) ? Facility.class$Lca$openosp$openo$caisi_integrator$dao$Facility : (Facility.class$Lca$openosp$openo$caisi_integrator$dao$Facility = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.Facility")), this.id);
    }
