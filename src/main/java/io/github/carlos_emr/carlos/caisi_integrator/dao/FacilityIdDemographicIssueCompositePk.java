 ...
 *
 * @see io.github.carlos_emr.carlos.caisi_integrator.util.CodeType
...
public class FacilityIdDemographicIssueCompositePk implements Serializable, PersistenceCapable
{
    ...
    static {
        ...
        FacilityIdDemographicIssueCompositePk.pcFieldTypes = new Class[] { (FacilityIdDemographicIssueCompositePk.class$Ljava$lang$Integer != null) ? FacilityIdDemographicIssueCompositePk.class$Ljava$lang$Integer : (FacilityIdDemographicIssueCompositePk.class$Ljava$lang$Integer = class$("java.lang.Integer")), (FacilityIdDemographicIssueCompositePk.class$Lca$openosp$openo$caisi_integrator$util$CodeType != null) ? FacilityIdDemographicIssueCompositePk.class$Lca$openosp$openo$caisi_integrator$util$CodeType : (FacilityIdDemographicIssueCompositePk.class$Lca$openosp$openo$caisi_integrator$util$CodeType = class$("io.github.carlos_emr.carlos.caisi_integrator.util.CodeType")), (FacilityIdDemographicIssueCompositePk.class$Ljava$lang$Integer != null) ? FacilityIdDemographicIssueCompositePk.class$Ljava$lang$Integer : (FacilityIdDemographicIssueCompositePk.class$Ljava$lang$Integer = class$("java.lang.Integer")), (FacilityIdDemographicIssueCompositePk.class$Ljava$lang$String != null) ? FacilityIdDemographicIssueCompositePk.class$Ljava$lang$String : (FacilityIdDemographicIssueCompositePk.class$Ljava$lang$String = class$("java.lang.String")) };
        FacilityIdDemographicIssueCompositePk.pcFieldFlags = new byte[] { 26, 26, 26, 26 };
        PCRegistry.register((FacilityIdDemographicIssueCompositePk.class$Lca$openosp$openo$caisi_integrator$dao$FacilityIdDemographicIssueCompositePk != null) ? FacilityIdDemographicIssueCompositePk.class$Lca$openosp$openo$caisi_integrator$dao$FacilityIdDemographicIssueCompositePk : (FacilityIdDemographicIssueCompositePk.class$Lca$openosp$openo$caisi_integrator$dao$FacilityIdDemographicIssueCompositePk = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.FacilityIdDemographicIssueCompositePk")), FacilityIdDemographicIssueCompositePk.pcFieldNames, FacilityIdDemographicIssueCompositePk.pcFieldTypes, FacilityIdDemographicIssueCompositePk.pcFieldFlags, FacilityIdDemographicIssueCompositePk.pcPCSuperclass, (String)null, (PersistenceCapable)new FacilityIdDemographicIssueCompositePk());
    }
