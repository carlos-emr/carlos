 ...
 * @see io.github.carlos_emr.carlos.caisi_integrator.dao.AbstractModel
 *
 * @since 2026-01-24
 */
@Entity
...
public class ImportLog extends AbstractModel<Long> implements PersistenceCapable
{
    ...
    public Object pcNewObjectIdInstance(final Object o) {
        return new LongId((ImportLog.class$Lca$openosp$openo$caisi_integrator$dao$ImportLog != null) ? ImportLog.class$Lca$openosp$openo$caisi_integrator$dao$ImportLog : (ImportLog.class$Lca$openosp$openo$caisi_integrator$dao$ImportLog = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.ImportLog")), (String)o);
    }
    ...
    public Object pcNewObjectIdInstance() {
        return new LongId((ImportLog.class$Lca$openosp$openo$caisi_integrator$dao$ImportLog != null) ? ImportLog.class$Lca$openosp$openo$caisi_integrator$dao$ImportLog : (ImportLog.class$Lca$openosp$openo$caisi_integrator$dao$ImportLog = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.ImportLog")), this.id);
    }
