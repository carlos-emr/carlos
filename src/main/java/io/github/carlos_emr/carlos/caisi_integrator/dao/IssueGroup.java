package io.github.carlos_emr.carlos.caisi_integrator.dao;
...
import io.github.carlos_emr.carlos.caisi_integrator.util.Named;
...
public class IssueGroup extends AbstractModel<Integer> implements Named, PersistenceCapable
{
    ...
    static {
        ...
        IssueGroup.pcFieldTypes = new Class[] { (IssueGroup.class$Lca$openosp$openo$caisi_integrator$util$CodeType != null) ? IssueGroup.class$Lca$openosp$openo$caisi_integrator$util$CodeType : (IssueGroup.class$Lca$openosp$openo$caisi_integrator$util$CodeType = class$("io.github.carlos_emr.carlos.caisi_integrator.util.CodeType")), (IssueGroup.class$Ljava$lang$Integer != null) ? IssueGroup.class$Ljava$lang$Integer : (IssueGroup.class$Ljava$lang$Integer = class$("java.lang.Integer")), (IssueGroup.class$Ljava$lang$String != null) ? IssueGroup.class$Ljava$lang$String : (IssueGroup.class$Ljava$lang$String = class$("java.lang.String")), (IssueGroup.class$Ljava$lang$String != null) ? IssueGroup.class$Ljava$lang$String : (IssueGroup.class$Ljava$lang$String = class$("java.lang.String")) };
        IssueGroup.pcFieldFlags = new byte[] { 26, 26, 26, 26 };
        PCRegistry.register((IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup != null) ? IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup : (IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.IssueGroup")), IssueGroup.pcFieldNames, IssueGroup.pcFieldTypes, IssueGroup.pcFieldFlags, IssueGroup.pcPCSuperclass, "IssueGroup", (PersistenceCapable)new IssueGroup());
    }
    ...
    public Object pcNewObjectIdInstance(final Object o) {
        return new IntId((IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup != null) ? IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup : (IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.IssueGroup")), (String)o);
    }
    ...
    public Object pcNewObjectIdInstance() {
        return new IntId((IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup != null) ? IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup : (IssueGroup.class$Lca$openosp$openo$caisi_integrator$dao$IssueGroup = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.IssueGroup")), this.id);
    }
