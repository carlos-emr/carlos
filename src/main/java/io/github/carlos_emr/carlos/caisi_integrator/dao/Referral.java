...
public class Referral extends AbstractModel<Integer> implements PersistenceCapable
{
    ...
    public Object pcNewObjectIdInstance(final Object o) {
        return new IntId((Referral.class$Lca$openosp$openo$caisi_integrator$dao$Referral != null) ? Referral.class$Lca$openosp$openo$caisi_integrator$dao$Referral : (Referral.class$Lca$openosp$openo$caisi_integrator$dao$Referral = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.Referral")), (String)o);
    }
    ...
    public Object pcNewObjectIdInstance() {
        return new IntId((Referral.class$Lca$openosp$openo$caisi_integrator$dao$Referral != null) ? Referral.class$Lca$openosp$openo$caisi_integrator$dao$Referral : (Referral.class$Lca$openosp$openo$caisi_integrator$dao$Referral = class$("io.github.carlos_emr.carlos.caisi_integrator.dao.Referral")), this.id);
    }
