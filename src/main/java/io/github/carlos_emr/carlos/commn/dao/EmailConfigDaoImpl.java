...
public class EmailConfigDaoImpl extends AbstractDaoImpl<EmailConfig> implements EmailConfigDao {
    ...
    /**
     * Finds an active email configuration by sender email address.
     * @param senderEmail the sender email address to search for
     * @return the matching active email configuration, or null if no match is found
     */
     ...
     * Finds an active email configuration by its database ID.
     *
     * @param id the primary key of the email configuration
     * @return the matching active email configuration, or null if no active config exists with this ID
     */
