...
public interface OutboundEmailArchiveLegalHoldEventDao extends AbstractDao<OutboundEmailArchiveLegalHoldEvent> {
    ...
    /**
     * Finds the legal hold history for an archive, newest event first.
     *
     * @param archiveId persisted archive identifier
     * @return legal hold events ordered by event date descending
     */
    List<OutboundEmailArchiveLegalHoldEvent> findByArchiveId(Integer archiveId);
}
