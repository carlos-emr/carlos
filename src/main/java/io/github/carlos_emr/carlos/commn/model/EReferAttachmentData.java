...
/**
 * Domain entity representing the binary data payload for an eReferral attachment. Stores the actual file bytes separately from metadata to optimize queries.
 */
@Entity
