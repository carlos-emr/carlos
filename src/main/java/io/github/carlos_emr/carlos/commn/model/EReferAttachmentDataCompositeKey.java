...
/**
 * Composite primary key definition for EReferAttachmentData.
 * Required by JPA to map legacy tables that lack a single surrogate key, ensuring correct identity resolution.
 */
