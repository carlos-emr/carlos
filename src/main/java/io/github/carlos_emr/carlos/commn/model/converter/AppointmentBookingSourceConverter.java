...
/**
 * JPA Attribute Converter for the AppointmentBookingSource enum.
 * Tracks the origin of an appointment (e.g., Online, In-Person, Phone) for analytical and reporting purposes.
 */
