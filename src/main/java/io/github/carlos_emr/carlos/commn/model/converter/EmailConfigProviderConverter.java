...
/**
 * JPA Attribute Converter for the EmailConfigProvider enum.
 * Identifies the specific external email service provider (e.g., SendGrid, Mailgun) used by the configuration.
 */
