...
/**
 * JPA AttributeConverter mapping the chart display option enum for email logs, determining whether an email record should be visible in the patient's main chart.
 */
@Converter
