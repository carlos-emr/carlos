...
/**
 * JPA AttributeConverter that maps the EmailLogTransactionType enum to a database column, tracking the context of sent emails (e.g., appointment reminder, invoice).
 */
@Converter
