...
/**
 * JPA AttributeConverter mapping the HNR (Health Network Record) validation type enum to its database column value for external health record sync tracking.
 */
@Converter
