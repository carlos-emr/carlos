...
/**
 * View gate for common/OntarioMDRedirect.jsp — SSO redirect to Ontario MD. Requires both _admin r (to read the Ontario MD config) and _eChart r (clinical context). GET/HEAD only.
 */
public final class ViewOntarioMDRedirect2Action extends ActionSupport {
