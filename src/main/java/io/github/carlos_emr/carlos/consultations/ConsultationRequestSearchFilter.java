...
public class ConsultationRequestSearchFilter {
    ...
    /**
     * Returns the consultation request ID filter.
     *
     * @return Integer the consultation request ID, or {@code null} if not set
     */
    ...
    /**
     * Sets the consultation request ID filter.
     *
     * @param id Integer the consultation request ID to filter by
     */
    ...
    /**
     * Returns the consultation request status filter.
     *
    ...
    /**
     * Sets the consultation request status filter.
     *
