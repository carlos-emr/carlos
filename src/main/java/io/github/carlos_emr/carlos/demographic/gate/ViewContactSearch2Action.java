...
/**
 * View gate for {@code demographic/contactSearch.jsp}. Enforces {@code _demographic}
 ...
 * @since 2026-04-13
 */
public final class ViewContactSearch2Action extends ActionSupport {

    private final transient SecurityInfoManager securityInfoManager;

    public ViewContactSearch2Action(SecurityInfoManager securityInfoManager) {
        this.securityInfoManager = securityInfoManager;
    }

    public ViewContactSearch2Action() {
