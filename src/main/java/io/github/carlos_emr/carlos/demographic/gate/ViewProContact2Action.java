...
/**
 * View gate for {@code demographic/procontact.jsp}. Enforces {@code _demographic}
 ...
 * @since 2026-04-13
 */
public final class ViewProContact2Action extends ActionSupport {

    private final transient SecurityInfoManager securityInfoManager;

    public ViewProContact2Action(SecurityInfoManager securityInfoManager) {
        this.securityInfoManager = securityInfoManager;
    }

    public ViewProContact2Action() {
