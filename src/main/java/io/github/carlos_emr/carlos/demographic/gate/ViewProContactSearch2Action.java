...
/**
 * View gate for {@code demographic/procontactSearch.jsp}. Enforces {@code _demographic}
 ...
 * @since 2026-04-13
 */
public final class ViewProContactSearch2Action extends ActionSupport {

    private final transient SecurityInfoManager securityInfoManager;

    public ViewProContactSearch2Action(SecurityInfoManager securityInfoManager) {
        this.securityInfoManager = securityInfoManager;
    }

    public ViewProContactSearch2Action() {
