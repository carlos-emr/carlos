...
/**
 * View gate for {@code demographic/search.jsp}. Enforces {@code _search}
...
public final class ViewSearch2Action extends ActionSupport {
    ...
    public ViewSearch2Action(SecurityInfoManager securityInfoManager) {
        this.securityInfoManager = securityInfoManager;
    }

    public ViewSearch2Action() {
