...
/**
 * View gate for {@code demographic/zdemographicswipe.jsp}. Enforces {@code _demographic}
 ...
 * @since 2026-04-13
 */
public final class ViewZdemographicSwipe2Action extends ActionSupport {

    private final transient SecurityInfoManager securityInfoManager;

    public ViewZdemographicSwipe2Action(SecurityInfoManager securityInfoManager) {
        this.securityInfoManager = securityInfoManager;
    }

    public ViewZdemographicSwipe2Action() {
