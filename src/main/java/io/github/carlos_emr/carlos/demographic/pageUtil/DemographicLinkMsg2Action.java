 ...
 * Forwards to the patient selection popup ({@code msgSearchDemo.jsp})
 * used by the messenger system for linking a demographic to a message.
 *
 * @since 2026-04-04
 */
public class DemographicLinkMsg2Action extends ActionSupport {
    ...
    public String execute() {
        ...
        if (loggedInInfo == null) {
            logger.warn("DemographicLinkMsg2Action: missing session");
