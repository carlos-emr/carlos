...
import io.github.carlos_emr.carlos.hospitalReportManager.model.*;
...
import io.github.carlos_emr.carlos.lab.ca.all.upload.handlers.CMLHandler;
import io.github.carlos_emr.carlos.lab.ca.all.upload.handlers.ExcellerisOntarioHandler;
import io.github.carlos_emr.carlos.lab.ca.all.upload.handlers.GDMLHandler;
import io.github.carlos_emr.carlos.lab.ca.all.upload.handlers.MDSHandler;
import io.github.carlos_emr.carlos.lab.ca.all.upload.handlers.MessageHandler;
import io.github.carlos_emr.carlos.lab.ca.all.upload.handlers.PATHL7Handler;
...
import io.github.carlos_emr.carlos.prescript.data.RxDrugData.DrugMonograph;
...
public class ImportDemographicDataAction42Action extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        if (admProviderNo == null || admProviderNo.isBlank() || "null".equalsIgnoreCase(admProviderNo.trim())) {
...
//                    	preventionType = mapPreventionTypeByCode(immuArray[i].getImmunizationCode());
    ...
    String updateExternalProvider(String firstName, String lastName, String ohipNo, String cpsoNo, ProviderData pd) {
        ...
        io.github.carlos_emr.carlos.commn.model.ProviderData newpd = providerDataDao.findByProviderNo(pd.getProviderNo());
