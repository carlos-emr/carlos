...
public class AddEForm2Action extends ActionSupport {
     ...
     * Example: "999998_12345_67_referralForm", "doc1_100_5_m$bloodpressure#systolic"
     *
     * <p>The field-name segment permits letters, digits, underscore, dot, hyphen, {@code $},
     * and {@code #} to support measurement AP field names (e.g., {@code m$type#field})
     * generated by CARLOS eForm editors.</p>
     *
...
//        }
    ...
    void addEmailAttachmentsToSession(HttpServletRequest request, EmailAttachmentSettings settings) {
        ...
        session.setAttribute("attachEFormItSelf", settings.attachEFormItSelf()); // nosemgrep: java/TrustBoundaryViolation -- boolean value (sanitized by "true".equals() in EmailAttachmentSettings.of())
        ...
        session.setAttribute("emailPatientChartOption", settings.emailPatientChartOption()); // nosemgrep: java/TrustBoundaryViolation -- allowlist-validated via validateChartOption() in EmailAttachmentSettings
    }
    ...
    static String[] validateIntIdArray(String[] ids) {
        ...
        if (rejected > 0) {
            logger.warn("Rejected {} non-integer or negative ID(s) during trust boundary enforcement", rejected);
        }
