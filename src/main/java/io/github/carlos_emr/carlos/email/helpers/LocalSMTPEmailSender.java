...
/**
 * Implementation of an email sender utilizing a local or specifically configured SMTP relay.
 * <p>
 * Handles the construction and transmission of MIME messages based on system configuration.
 *
 * @since 2026-05-05
 */
