...
/**
 * Utility class for handling attachments within the Ocean eReferral integration.
 * Provides methods to extract, process, and attach documents to outgoing eReferrals to the Ocean network.
 */
