...
public class EctDisplayLabAction22Action extends EctDisplayAction {
    ...
    public boolean getInfo(EctSessionBean bean, HttpServletRequest request, NavBarDisplayDAO Dao) {
        ...
        if (!securityInfoManager.hasPrivilege(loggedInInfo, "_lab", "r", null)) {
            ...
            Dao.setLeftPopup(700, 599, winName, request.getContextPath() + "/lab/ViewDemographicLab.do?demographicNo=" + bean.demographicNo);
            ...
            if (CarlosProperties.getInstance().getBooleanProperty("HL7TEXT_LABS", "yes")) {
                Dao.addPopUpMenu(700, 1000, winName, request.getContextPath() + "/lab/ViewCumulativeLabValues3.do?demographic_no=" + bean.demographicNo);
                ...
                if (CarlosProperties.getInstance().getProperty("labs.hide_old_grid_display", "false").equals("false")) {
                    Dao.addPopUpMenu(700, 1000, winName, request.getContextPath() + "/lab/ViewCumulativeLabValues2.do?demographic_no=" + bean.demographicNo);
            ...
            Dao.addPopUpMenu(700, 1000, winName, request.getContextPath() + "/lab/ViewCumulativeLabValues.do?demographic_no=" + bean.demographicNo);
            ...
            for (int j = 0; j < labs.size(); j++) {
                ...
                if (result.isMDS()) {
                    ...
                    url = request.getContextPath() + "/lab/CA/ON/ViewCMLDisplay.do?demographicId=" + bean.demographicNo + "&providerNo=" + bean.providerNo + "&segmentID=" + result.segmentID + "&multiID=" + result.multiLabId;
                    ...
                    url = request.getContextPath() + "/lab/CA/BC/ViewLabDisplay.do?demographicId=" + bean.demographicNo + "&segmentID=" + result.segmentID + "&providerNo=" + bean.providerNo + "&multiID=" + result.multiLabId;
                }
                String labRead = "";
