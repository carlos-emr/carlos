package io.github.carlos_emr.carlos.flowsheets.impl;
...
/**
 * Apache XMLBeans implementation of the FlowsheetDocument interface for CARLOS EMR.
 *
 ...
 * data within the CARLOS EMR system. All XML operations are synchronized for thread safety in
...
public class FlowsheetDocumentImpl extends XmlComplexContentImpl implements FlowsheetDocument {
    ...
    * Flowsheets are used in CARLOS EMR to systematically track patient data over time with built-in
