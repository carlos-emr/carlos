...
public class Frm2MinWalkRecord extends FrmRecord {
    ...
    public Properties getFormRecord(LoggedInInfo loggedInInfo, int demographicNo, int existingID)
        ...
        if (existingID <= 0) {
            ...
            sql = "SELECT * FROM form2MinWalk WHERE demographic_no = ? AND ID = ?";
    ...
    public int saveFormRecord(Properties props) throws SQLException {
        ...
        String sql = "SELECT * FROM form2MinWalk WHERE demographic_no=? AND ID=0";
    ...
    public Properties getPrintRecord(int demographicNo, int existingID)
            throws SQLException {
        String sql = "SELECT * FROM form2MinWalk WHERE demographic_no = ? AND ID = ?";
        FrmRecordHelp frh = new FrmRecordHelp();
        frh.setDateFormat(_dateFormat);
