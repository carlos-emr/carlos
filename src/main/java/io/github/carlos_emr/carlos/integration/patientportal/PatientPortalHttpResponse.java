 ...
 *
 * <p>The body is deliberately left unparsed here. Portal error bodies are {@code {"detail": "..."}}
 * and success bodies vary per endpoint, so parsing belongs with the endpoint that knows the shape.
 *
