...
import io.github.carlos_emr.carlos.lab.ca.all.util.MEDVUEUtilities;
    ...
    private void updateLabStatus(int n) {
        ...
        while (iter.hasNext() && n > 0) {
            if (!iter.next().getResultStatus().equals("A")) {
                io.github.carlos_emr.carlos.lab.ca.all.parsers.MessageHandler h = Factory.getHandler(((Integer) iter.next().getLabNumber()).toString());
