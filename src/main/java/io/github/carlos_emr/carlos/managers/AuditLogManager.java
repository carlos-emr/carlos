...
public class AuditLogManager {
    ...
    public int purgeAuditLog(LoggedInInfo loggedInInfo, Date endDateToPurge) throws Exception {
        ...
        try {
            ...
            // nosemgrep: java.lang.security.audit.command-injection.formatted-or-concatenated-string-in-processbuilder-call, java.lang.security.audit.command-injection.formatted-or-concatenated-string-in-processbuilder-call-deepsemgrep, formatted-or-concatenated-string-in-processbuilder-call
