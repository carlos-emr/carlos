...
public class AuditLogManager {
    ...
    public int purgeAuditLog(LoggedInInfo loggedInInfo, Date endDateToPurge) throws Exception {
        ...
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder(mysqldump, "--user=" + user, "-w", "dateTime < '" + formatter2.format(endDateToPurge) + "'", "-t", "--result-file=" + filename, dbName, "log"); // nosemgrep: java.lang.security.audit.command-injection.formatted-or-concatenated-string-in-processbuilder-call.formatted-or-concatenated-string-in-processbuilder-call
