 ...
 * </p>
 *
 * @see io.github.carlos_emr.carlos.commn.model.ProfessionalSpecialist
 * @see io.github.carlos_emr.carlos.commn.dao.ProfessionalSpecialistDao
...
public class ProfessionalSpecialistsManager implements Serializable {
     ...
     * @throws RuntimeException if the current user lacks READ privilege on the
     *                          consultation security object (_con)
     * @see io.github.carlos_emr.carlos.commn.dao.ProfessionalSpecialistDao#search(String)
     */
