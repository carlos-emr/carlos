...
import io.github.carlos_emr.carlos.commn.model.ProviderPreference.QuickLink;
...
public class ProviderManager2 {
		...
		*/
        ...
        if (pp.getAppointmentScreenQuickLinks() != null) {
            for (QuickLink ql : pp.getAppointmentScreenQuickLinks()) {
                io.github.carlos_emr.carlos.managers.model.QuickLink qt = new io.github.carlos_emr.carlos.managers.model.QuickLink();
    ...
    public void updateProviderSettings(LoggedInInfo loggedInInfo, String providerNo, ProviderSettings settings) {
        ...
        for (io.github.carlos_emr.carlos.managers.model.QuickLink ql : settings.getAppointmentScreenQuickLinks()) {
