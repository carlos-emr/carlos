...
public class MsgViewMessageByPosition2Action extends ActionSupport {
    ...
    public String execute() throws IOException, ServletException {
        ...
        try {
            Query query = em.createNativeQuery(sql); // nosemgrep: jpa-sqli, formatted-sql-string // codeql[java/Sqli] — demographic_no bound via setParameter; orderBy from MsgDisplayMessagesBean allowlist
