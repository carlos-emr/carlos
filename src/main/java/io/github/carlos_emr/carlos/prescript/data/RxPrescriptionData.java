...
public class RxPrescriptionData {
    ...
    private Prescription toPrescription(int demographicNo, Drug drug, io.github.carlos_emr.carlos.commn.model.Prescription rx) {
    ...
    public Favorite[] getFavorites(String providerNo) {
        ...
        for (io.github.carlos_emr.carlos.commn.model.Favorite f : dao.findByProviderNo(providerNo))
    ...
    public String getScriptComment(String scriptNo) {
        PrescriptionDao dao = SpringUtils.getBean(PrescriptionDao.class);
        io.github.carlos_emr.carlos.commn.model.Prescription p = dao.find(ConversionUtils.fromIntString(scriptNo));
    ...
    public static class Prescription {
        ...
        public boolean Print(LoggedInInfo loggedInInfo) {
            PrescriptionDao dao = SpringUtils.getBean(PrescriptionDao.class);
            io.github.carlos_emr.carlos.commn.model.Prescription p = dao.find(ConversionUtils.fromIntString(getScript_no()));
    ...
    public static class Favorite {
        ...
        public boolean Save() {
            ...
            if (this.getFavoriteId() == 0) {
                ...
                if (this.getFavoriteId() == 0) {
                    favorite = new io.github.carlos_emr.carlos.commn.model.Favorite();
        ...
        private io.github.carlos_emr.carlos.commn.model.Favorite syncFavorite(io.github.carlos_emr.carlos.commn.model.Favorite f) {
