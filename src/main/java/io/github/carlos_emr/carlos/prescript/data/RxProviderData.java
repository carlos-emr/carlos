...
public class RxProviderData {
    ...
    public List<Provider> getAllProviders() {
        List<io.github.carlos_emr.carlos.commn.model.Provider> providers = providerDao.getActiveProviders();
        ArrayList<Provider> results = new ArrayList<Provider>();
        for (io.github.carlos_emr.carlos.commn.model.Provider p : providers) {
    ...
    public Provider convertProvider(io.github.carlos_emr.carlos.commn.model.Provider p) {
