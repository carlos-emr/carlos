...
/**
 * View gate for {@code rx/chartDrugProfile.jsp} (formerly reachable at
 * {@code /rx/chartDrugProfile.jsp}). Enforces {@code _rx} {@code r}
 * privilege before forwarding to the JSP at its {@code /WEB-INF/jsp/rx/}
 * location. Part of the oscarRx -> rx rebrand migration.
 *
 * @since 2026-04-13
 */
public final class ViewChartDrugProfile2Action extends ActionSupport {
