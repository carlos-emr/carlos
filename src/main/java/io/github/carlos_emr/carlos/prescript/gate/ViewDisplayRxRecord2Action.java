...
/**
 * View gate for {@code rx/DisplayRxRecord.jsp} (formerly reachable at
 * {@code /rx/DisplayRxRecord.jsp}). Enforces {@code _rx} {@code r}
 * privilege before forwarding to the JSP at its {@code /WEB-INF/jsp/rx/}
 * location. Part of the oscarRx -> rx rebrand migration.
 *
 * @since 2026-04-13
 */
public final class ViewDisplayRxRecord2Action extends ActionSupport {
