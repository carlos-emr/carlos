...
/**
 * View gate for {@code rx/PrintDrugProfile2.jsp} (formerly reachable at
 * {@code /rx/PrintDrugProfile2.jsp}). Enforces {@code _rx} {@code r}
 * privilege before forwarding to the JSP at its {@code /WEB-INF/jsp/rx/}
 * location. Part of the oscarRx -> rx rebrand migration.
 *
 * @since 2026-04-13
 */
public final class ViewPrintDrugProfile22Action extends ActionSupport {
