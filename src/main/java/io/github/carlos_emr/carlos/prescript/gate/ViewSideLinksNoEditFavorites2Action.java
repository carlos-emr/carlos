...
/**
 * View gate for {@code rx/SideLinksNoEditFavorites.jsp} (formerly reachable at
 * {@code /rx/SideLinksNoEditFavorites.jsp}). Enforces {@code _allergy} {@code r}
 * privilege before forwarding to the JSP at its {@code /WEB-INF/jsp/rx/}
 * location. Part of the oscarRx -> rx rebrand migration.
 *
 * @since 2026-04-13
 */
public final class ViewSideLinksNoEditFavorites2Action extends ActionSupport {
