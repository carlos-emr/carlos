/**
 * Copyright (c) 2026. openo-beta/open-o contributors. All Rights Reserved.
 ...
 *
 * Ported to the CARLOS EMR Project (2026+).
 ...
 * <p>
 * Mapped in {@code web.xml} to the current Rx, case-management, and messenger
 * action routes.
 * <p>
 * Originally authored by LiamStanziani in openo-beta/open-o PR #2261.
 *
...
public class RxSessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        if (session != null) {
            ...
            if (demographicNo <= 0) {
                // Try demographic_no as well (used by some JSPs like generatePreviewPDF)
