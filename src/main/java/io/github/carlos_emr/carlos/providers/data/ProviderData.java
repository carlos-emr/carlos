 ...
 * @deprecated use {@link io.github.carlos_emr.carlos.commn.model.ProviderData} instead
 */
@Deprecated
public class ProviderData {
	...
	*/
    ...
    private void fromProvider(io.github.carlos_emr.carlos.commn.model.ProviderData p) {
        provider_no = p.getId();
    ...
    public List<String> getProviderListWithInsuranceNo(String insurerNo) {
        ...
        List<io.github.carlos_emr.carlos.commn.model.ProviderData> providers = dao.findByTypeAndOhip(PROVIDER_TYPE_DOCTOR, insurerNo);
    ...
    public void getProvider(String providerNo) {
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        io.github.carlos_emr.carlos.commn.model.ProviderData provider = dao.findByProviderNo(providerNo);
        if (provider != null) {
    ...
    public static List<Map<String, String>> getProviderList() {
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        List<io.github.carlos_emr.carlos.commn.model.ProviderData> providers = dao.findAll(false);
    ...
    private static Map<String, String> toMap(io.github.carlos_emr.carlos.commn.model.ProviderData p) {
    ...
    public static List<Map<String, String>> searchProvider(String searchStr, boolean onlyActive) {
        ...
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        List<io.github.carlos_emr.carlos.commn.model.ProviderData> providers = dao.findByName(firstname, lastname, onlyActive);
    ...
    public static List<Map<String, String>> getProviderListOfAllTypes(boolean inactive) {
        ...
        List<io.github.carlos_emr.carlos.commn.model.ProviderData> providers = dao.findAll(inactive);
        for (io.github.carlos_emr.carlos.commn.model.ProviderData p : providers) {
            result.add(toMap(p));
        }
        return result;
    ...
    public static String getProviderName(String providerNo) {
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        io.github.carlos_emr.carlos.commn.model.ProviderData p = dao.findByProviderNo(providerNo);
        if (p == null)
            return "";
    ...
    public void getProviderWithOHIP(String ohipNo) {
        if (filled(ohipNo)) {
            ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
            io.github.carlos_emr.carlos.commn.model.ProviderData p = dao.findByOhipNumber(ohipNo);
            if (p != null)
                fromProvider(p);
        }
    }
    ...
    public void getProviderWithNames(String firstName, String lastName) {
        if (filled(firstName) && filled(lastName)) {
            ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
            List<io.github.carlos_emr.carlos.commn.model.ProviderData> providers = dao.findByName(firstName, lastName, false);
