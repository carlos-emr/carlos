...
/**
 * View gate for {@code provider/providerchangepassword.jsp}. Enforces
 * {@code _appointment} {@code r} privilege before forwarding to the JSP.
 *
 * @since 2026-04-13
 */
public final class ViewProviderChangePassword2Action extends BaseProviderViewGate2Action {
