...
public class DemographicSets {
    ...
    public void addDemographicSet(String setName, List<String> demoList) {
        ...
        for (int i = 0; i < demoList.size(); i++) {
            ...
            io.github.carlos_emr.carlos.commn.model.DemographicSets ds = new io.github.carlos_emr.carlos.commn.model.DemographicSets();
            ds.setName(setName);
    ...
    public List<String> getDemographicSet(String setName) {
        ...
        List<io.github.carlos_emr.carlos.commn.model.DemographicSets> dss = demographicSetsDao.findBySetName(setName);
        for (io.github.carlos_emr.carlos.commn.model.DemographicSets ds : dss) {
    ...
    public List<String> getDemographicSet(List<String> setNames) {
        ...
        List<io.github.carlos_emr.carlos.commn.model.DemographicSets> dss = demographicSetsDao.findBySetNames(setNames);
        for (io.github.carlos_emr.carlos.commn.model.DemographicSets ds : dss) {
            retval.add(String.valueOf(ds.getDemographicNo()));
        }
    ...
    public List<String> getIneligibleDemographicSet(String setName) {
        List<String> retval = new ArrayList<String>();
        List<io.github.carlos_emr.carlos.commn.model.DemographicSets> dss = demographicSetsDao.findBySetNameAndEligibility(setName, "1");
        for (io.github.carlos_emr.carlos.commn.model.DemographicSets ds : dss) {
            retval.add(String.valueOf(ds.getDemographicNo()));
        }
        return retval;
    ...
    public List<String> getEligibleDemographicSet(String setName) {
        List<String> retval = new ArrayList<String>();
        List<io.github.carlos_emr.carlos.commn.model.DemographicSets> dss = demographicSetsDao.findBySetNameAndEligibility(setName, "0");
        for (io.github.carlos_emr.carlos.commn.model.DemographicSets ds : dss) {
            retval.add(String.valueOf(ds.getDemographicNo()));
        }
        return retval;
    ...
    public List<String> setDemographicIneligible(String setName, String demoNo) {
        List<String> retval = new ArrayList<String>();
        List<io.github.carlos_emr.carlos.commn.model.DemographicSets> dss = demographicSetsDao.findBySetNameAndDemographicNo(setName, Integer.parseInt(demoNo));
        for (io.github.carlos_emr.carlos.commn.model.DemographicSets ds : dss) {
            ds.setEligibility("1");
