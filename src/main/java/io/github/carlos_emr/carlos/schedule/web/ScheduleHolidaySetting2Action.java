...
/**
 * Gate action for the holiday settings page.
 * Enforces schedule admin write privilege before forwarding to the JSP.
 * Save and Delete operations require POST; GET is permitted for calendar navigation
 * (prev/next month links use GET with bFirstDisp=0).
 *
 * @since 2026-04-05
 */
public final class ScheduleHolidaySetting2Action extends ActionSupport {
