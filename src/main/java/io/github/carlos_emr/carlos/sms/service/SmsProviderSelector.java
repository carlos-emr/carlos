 ...
 * A per-command override hook is provided for future per-message routing.
 */
@Service
public class SmsProviderSelector {
    ...
    /**
     * Resolves the provider type for a specific outbound command. Today this is always the configured
     * default; a per-command override would be honoured here before falling back to the default.
     */
    public SmsProviderType selectForOutbound(SmsSendCommand command) {
