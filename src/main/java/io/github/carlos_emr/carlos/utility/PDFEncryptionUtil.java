...
/**
 * Utility class responsible for applying strong encryption and access permissions to generated PDF documents.
 */
...
public class PDFEncryptionUtil {
    ...
    // Applies standard encryption settings and owner/user passwords to the output PDF stream.
