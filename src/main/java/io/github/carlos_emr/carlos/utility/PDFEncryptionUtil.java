...
/**
 * Utility class providing methods to encrypt and decrypt PDF documents.
 * Implements security measures for PDF files such as setting user/owner passwords and restricting permissions.
 */
