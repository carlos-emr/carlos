...
/**
 * Utility class providing cryptographic operations for PDF documents.
 * Secures sensitive medical records by applying password protection and restricting permissions (e.g., prevent printing)
 * prior to exporting or emailing them.
 */
