 ...
 * those trigger Tomcat's error-page mechanism which forwards to {@code /WEB-INF/jsp/error/errorpage.jsp}.</p>
 *
 * <h3>Configuration</h3>
...
public class ResponseSanitizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Tomcat's error-page mechanism will forward to /WEB-INF/jsp/error/errorpage.jsp, which is already safe.
    ...
    private static class CapturingResponseWrapper extends HttpServletResponseWrapper {
         ...
         * Tomcat's error-page mechanism will forward to {@code /WEB-INF/jsp/error/errorpage.jsp}.
         *
