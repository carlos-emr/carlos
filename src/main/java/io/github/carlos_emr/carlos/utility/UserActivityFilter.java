...
public final class UserActivityFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (request instanceof HttpServletRequest) {
            ...
            if (session != null && !httpRequest.getRequestURL().toString().contains(httpRequest.getContextPath() + "/login/viewLogout.do")) {
        ...
        if (redirectToLogout) {
            ...
            httpResponse.sendRedirect(((HttpServletRequest) request).getContextPath() + "/login/viewLogout.do?autoLogout=true&errorMessage=logged out due to inactivity");
        } else {
