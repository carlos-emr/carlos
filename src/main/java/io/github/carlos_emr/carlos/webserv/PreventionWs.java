...
/**
 * SOAP web service endpoint for immunization and prevention operations in the inter-EMR Integrator system.
 *
 * <p>Provides methods for retrieving and synchronizing patient immunization and
 * preventive care records between CARLOS EMR installations.
 *
 * @since 2012-08-13
 */
