...
import io.github.carlos_emr.carlos.managers.PreferenceManagerImpl;
import io.github.carlos_emr.carlos.managers.SecurityInfoManager;
import io.github.carlos_emr.carlos.utility.LoggedInInfo;
import io.github.carlos_emr.carlos.utility.MiscUtils;
import io.github.carlos_emr.carlos.utility.SpringUtils;
import io.github.carlos_emr.carlos.webserv.rest.conversion.EncounterTemplateConverter;
...
public class RecordUxService extends AbstractServiceImpl {
    ...
    public List<MenuItemTo1> getRecordMenu(@PathParam("demographicNo") Integer demographicNo) {
        ...
        if (securityInfoManager.hasPrivilege(loggedInInfo, "_newCasemgmt.documents", "r", null)) {
            morelist.add(new MenuItemTo1(idCounter++, "Documents", "../documentManager/ViewDocumentReport?function=demographic&doctype=lab&functionid=" + Encode.forUriComponent(String.valueOf(demographicNo))));
        }
