...
public class PreventionsSummary implements Summary {
    ...
    private void preventionsList(LoggedInInfo loggedInInfo, List<SummaryItemTo1> list, Integer demographicNo) {
        ...
        String url = "../encounter/displayPrevention.do?demographic_no=" + demographicNo;
        ...
        io.github.carlos_emr.carlos.prevention.Prevention p = PreventionData.getPrevention(loggedInInfo, demographicNo);
