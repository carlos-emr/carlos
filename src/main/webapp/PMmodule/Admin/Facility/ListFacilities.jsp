...
<form action="${pageContext.request.contextPath}/PMmodule/FacilityManager.do" method="post">
    <display:table class="simple" cellspacing="2" cellpadding="3"
        ...
        <display:column sortable="false" title="">
            <a
                    href="<%=request.getContextPath() %>/PMmodule/FacilityManager.do?method=view&id=${e:forUriComponent(facility.id)}">
                Details </a>
        </display:column>
        <display:column sortable="false" title="">
            <a
                    href="<%=request.getContextPath() %>/PMmodule/FacilityManager.do?method=edit&id=${e:forUriComponent(facility.id)}">
                Edit </a>
        </display:column>
        <display:column sortable="false" title="">
