...
<script>
    function do_admission() {
        ...
        form.elements['method'].value='admit';
        form.submit();

    }
    function do_rejection() {
        var form = document.programManagerViewForm;
        form.elements['method'].value='reject_from_queue';
        form.submit();

    }
    function refresh_queue() {
        var form = document.programManagerViewForm;
        form.elements['method'].value='view';
        form.submit();
    }
    ...
    function select_client(client_id,action,queue_id) {
        ...
        if(action == 'admit') {
            form.elements['method'].value='select_client_for_admit';
        }
        if(action == 'reject') {
            if(!confirm('Are you sure you would like to reject admission for this client?')) {
                return;
            }
            form.elements['method'].value='select_client_for_reject';
			//form.elements['method'].value='reject_from_queue';
        }
	...
	function removeFromRemoteQueue(remoteReferralId) {
        ...
        form.elements['method'].value='remove_remote_queue';
        form.submit();
	}
</script>
