...
<CENTER>
        ...
        <table class="table table-striped  table-sm">
            <tr>
                ...
                <TH align="center" width="20%"><b><a
                        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=last_name&limit1=0&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>"><fmt:message key="admin.demographicmergerecord.lastName"/></a> </b></font></TH>
                <TH align="center" width="20%"><b><a
                        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=first_name&limit1=0&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>"><fmt:message key="admin.demographicmergerecord.firstName"/></a> </b></font></TH>
                <TH align="center" width="10%"><b><a
                        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=age&limit1=0&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>"><fmt:message key="admin.demographicmergerecord.age"/></a></b></font>
                </TH>
                <TH align="center" width="10%"><b><a
                        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=roster_status&limit1=0&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>"><fmt:message key="admin.demographicmergerecord.rosterStatus"/></a></b></font></TH>
                <TH align="center" width="10%"><b><a
                        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=sex&limit1=0&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>"><fmt:message key="admin.demographicmergerecord.sex"/></a></B></font>
                </TH>
                <TH align="center" width="10%"><b><a
                        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=date_of_birth&limit1=0&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>"><fmt:message key="admin.demographicmergerecord.dobFormat"/></a></B></Font>
                </TH>
            </tr>
            <%
            ...
            <tr>
                ...
                <td width="15%" align="center" height="25">
                    <caisi:isModuleLoad moduleName="TORONTO_RFQ" reverse="true">
                        <a href="javascript:popupWindow('<%= request.getContextPath() %>/demographic/DemographicEdit?demographic_no=<e:forUriComponent value='<%= head != null ? head : "" %>' />')"><carlos:encode value='<%= demographicNo %>' context="html"/>
                        </a>
    ...
    <%
        ...
        if (nLastPage >= 0) {
    %> <a
        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=<e:forUriComponent value='<%= request.getParameter("orderby") != null ? request.getParameter("orderby") : "" %>' />&limit1=<%=nLastPage%>&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>"><fmt:message key="admin.demographicmergerecord.lastPage"/></a> | <%
    }
    if (nItems == Integer.parseInt(strLimit)) {
%> <a
        href="${pageContext.request.contextPath}/admin/DemographicMergeRecord?keyword=<e:forUriComponent value='<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>' />&search_mode=<e:forUriComponent value='<%= request.getParameter("search_mode") != null ? request.getParameter("search_mode") : "" %>' />&orderby=<e:forUriComponent value='<%= request.getParameter("orderby") != null ? request.getParameter("orderby") : "" %>' />&limit1=<%=nNextPage%>&limit2=<carlos:encode value='<%= strLimit %>' context="uriComponent"/>">
