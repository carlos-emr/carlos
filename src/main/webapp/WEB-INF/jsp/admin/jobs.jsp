                    ...
                    function (xml) {
                        ...
                        if (xml.jobs) {
                            ...
                            for (var i = 0; i < arr.length; i++) {
                                ...
                                html += '<td>' + ((job.enabled == true) ? "<fmt:message key=\"admin.jobs.enabledStatus\"/> (<a onclick='updateJobStatus(" + job.id + ",false)'><fmt:message key=\"admin.jobs.disable\"/></a>)" : "<span color='red'><fmt:message key=\"admin.jobs.disabledStatus\"/></span> (<a onclick='updateJobStatus(" + job.id + ",true)'><fmt:message key=\"admin.jobs.enable\"/></a>)") + '</td>';
