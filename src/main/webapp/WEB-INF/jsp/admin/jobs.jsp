                    ...
                    function (xml) {
                        ...
                        if (xml.jobs) {
                            ...
                            for (var i = 0; i < arr.length; i++) {
                                ...
                                var html = '<tr>';
                                html += '<td><a href="javascript:void(0);" onclick="scheduleJob(' + job.id + ');" aria-label="<fmt:message key="admin.jobs.scheduleJob"/>"><i class="fa-solid fa-calendar ' + extraClass + '" aria-hidden="true"></i></a></td>';
