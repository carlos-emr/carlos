	...
	<a class="navbar-brand" href="javascript:void(0)">Flowsheets</a>
        ...
        %>
						...
						<tr>
							...
							<td><%=enabled%></td>
							<td>
								<a href="<%=request.getContextPath()%>/encounter/oscarMeasurements/adminFlowsheet/ViewEditFlowsheet.do?flowsheet=<%=flowSheet.getName()%>&displayName=<%=flowSheet.getDisplayName()%>">Edit</a>&nbsp;
								<%if(enabled) { %>
