...
--%>
<%--
  Page role: Renders `providerPrivilege.jsp` for the administration area.
...
<%@ page import="io.github.carlos_emr.carlos.commn.model.SecPrivilege" %>
<%@ page import="io.github.carlos_emr.carlos.commn.dao.SecPrivilegeDao" %>
<%@ page import="io.github.carlos_emr.carlos.commn.model.SecObjectName" %>
<%@ page import="io.github.carlos_emr.carlos.commn.dao.SecObjectNameDao" %>
<%@ page import="io.github.carlos_emr.carlos.commn.dao.SecObjectNameDaoImpl" %>
...
<%@ page import="io.github.carlos_emr.carlos.commn.model.SecObjPrivilege" %>
<%@ page import="io.github.carlos_emr.carlos.commn.model.SecObjPrivilegePrimaryKey" %>
<%@ page import="io.github.carlos_emr.carlos.commn.dao.SecObjPrivilegeDao" %>
