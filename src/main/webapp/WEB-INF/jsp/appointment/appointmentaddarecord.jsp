...
--%>
<%--
    View for AppointmentAddRecord2Action.
    Renders the result of an appointment creation.

    Request attributes (set by action):
        success          (Boolean) - true when appointment was persisted
        apptId           (int) - newly created appointment ID
        printReceipt     (Boolean) - true when print receipt popup should open
        waitingListName  (String, optional) - name of the waiting list entry to prompt removal
        waitingListId    (Integer, optional) - waiting list entry ID
        waitingListDemographicNo (String, optional) - demographic no for waiting list removal
