...
--%>
<%--
    View for AppointmentUpdateRecord2Action.
    Renders the result of an appointment update.

    Request attributes (set by action):
        success        (Boolean) - true when appointment was updated
        appointmentNo  (String) - appointment ID
