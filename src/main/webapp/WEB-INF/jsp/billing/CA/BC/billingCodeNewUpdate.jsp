...
<script LANGUAGE="JavaScript">
    <!--
    CodeAttach('<e:forJavaScriptBlock value='<%= param[0] %>' />', '<e:forJavaScriptBlock value='<%= param[1] %>' />', '<e:forJavaScriptBlock value='<%= param[2] %>' />', '<e:forJavaScriptBlock value='<%= diags[0] %>' />', '<e:forJavaScriptBlock value='<%= diags[1] %>' />', '<e:forJavaScriptBlock value='<%= diags[2] %>' />');
    -->
