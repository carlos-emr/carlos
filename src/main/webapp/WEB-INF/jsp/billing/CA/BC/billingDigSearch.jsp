...
<form name="codesearch" method=POST action="<%= request.getContextPath() %>/billing/CA/BC/ViewBillingDigSearch">
...
<form name="diagcode" id="diagcode" method="post"
      action="<%= request.getContextPath() %>/billing/CA/BC/ViewBillingDigUpdate">
