...
tr>
            ...
            <td width="5%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getBillFeeSchedule()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16" align="right"><carlos:encode value='<%= moneyFormat(result.getBillAmount()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16" align=right><carlos:encode value='<%= moneyFormat(result.getPaidAmount()) %>' context="html"/>
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getExp1()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getExp2()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getExp3()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getAjc1()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16"><carlos:encode value='<%= moneyFormat(result.getAja1()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getAjc2()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16"><carlos:encode value='<%= moneyFormat(result.getAja2()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getAjc3()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16"><carlos:encode value='<%= moneyFormat(result.getAja3()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getAjc4()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16"><carlos:encode value='<%= moneyFormat(result.getAja4()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getAjc5()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16"><carlos:encode value='<%= moneyFormat(result.getAja5()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getAjc6()) %>' context="html"/>&nbsp;
            </td>
            <td width="5%" height="16"><carlos:encode value='<%= moneyFormat(result.getAja6()) %>' context="html"/>&nbsp;
            </td>
            <td width="2%" height="16"><carlos:encode value='<%= StringUtils.noNull(result.getAjc7()) %>' context="html"/>&nbsp;
            </td>
