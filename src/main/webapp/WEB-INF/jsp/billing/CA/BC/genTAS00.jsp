...
tr>
            ...
            <td width="5%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getPractitionerNo()) %>' />&nbsp;
            </td>
            <td width="5%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getBillFeeSchedule()) %>' />&nbsp;
            </td>
            <td width="5%" height="16" align="right"><e:forHtmlContent value='<%= moneyFormat(result.getBillAmount()) %>' />&nbsp;
            </td>
            <td width="5%" height="16" align=right><e:forHtmlContent value='<%= moneyFormat(result.getPaidAmount()) %>' />
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getExp1()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getExp2()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getExp3()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getAjc1()) %>' />&nbsp;
            </td>
            <td width="5%" height="16"><e:forHtmlContent value='<%= moneyFormat(result.getAja1()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getAjc2()) %>' />&nbsp;
            </td>
            <td width="5%" height="16"><e:forHtmlContent value='<%= moneyFormat(result.getAja2()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getAjc3()) %>' />&nbsp;
            </td>
            <td width="5%" height="16"><e:forHtmlContent value='<%= moneyFormat(result.getAja3()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getAjc4()) %>' />&nbsp;
            </td>
            <td width="5%" height="16"><e:forHtmlContent value='<%= moneyFormat(result.getAja4()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getAjc5()) %>' />&nbsp;
            </td>
            <td width="5%" height="16"><e:forHtmlContent value='<%= moneyFormat(result.getAja5()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getAjc6()) %>' />&nbsp;
            </td>
            <td width="5%" height="16"><e:forHtmlContent value='<%= moneyFormat(result.getAja6()) %>' />&nbsp;
            </td>
            <td width="2%" height="16"><e:forHtmlContent value='<%= StringUtils.noNull(result.getAjc7()) %>' />&nbsp;
            </td>
