...
<%
    ...
    if ("paid".equals(action)) {
        ...
        while (rs.next()) {
            if (!tempStr.equals("" + rs.getInt("billing_no"))) { // new billing no
                ...
                String strT = "<a href=# onClick='popupPage(700,720, \"" + request.getContextPath() + "/billing/CA/ON/ViewBillingOB2?billing_no="
    ...
    if ("unpaid".equals(action)) {
        ...
        while (rs.next()) {
            ...
            String tempStr = "<a href=# onClick='popupPage(700,720, \""+ request.getContextPath() + "/billing/CA/ON/ViewBillingOB2?billing_no="
