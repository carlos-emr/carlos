...
--%>
<%--
  Page role: Renders `billingONSaveWorkloadRedirect.jsp` for the Ontario billing workflow.
...
<script type="text/javascript">
    ...
    <c:choose>
        <c:when test="${not empty workloadUrlBack}">
            self.location.href = "<carlos:encode value='${workloadUrlBack}' context='javaScript'/>";
        </c:when>
        <c:otherwise>
            self.close();
        </c:otherwise>
