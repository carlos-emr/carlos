...
--%>
<%--
  Page role: Renders `genGroupReport.jsp` for the Ontario billing workflow.
...
<%-- Empty stub. ViewGenGroupReport2Action enforces _billing w + POST, validates
     ...
     write), then chains to ViewBillingOHIPreport. The 24 inline DAO scriptlets
     the JSP body used to perform now live in the service. --%>
