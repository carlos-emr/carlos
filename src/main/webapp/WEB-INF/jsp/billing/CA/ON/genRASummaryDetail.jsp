...
<%
    // Shares the GenRASummaryDataAssembler with genRASummary.jsp — the two
    // pages render the same model. Differences in the legacy code were
    // cosmetic only.
    ...
    if (raSummaryModel == null) {
        io.github.carlos_emr.carlos.utility.MiscUtils.getLogger().warn(
                "genRASummaryDetail.jsp reached without raSummaryModel — caller "
              + "should route through billing/CA/ON/ViewGenRASummaryDetail.");
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr bgcolor="#333333">
        <th align='CENTRE'>
            <form action="<%= request.getContextPath() %>/billing/CA/ON/ViewGenRASummaryDetail" method="post">
                ...
                <a href="<%= request.getContextPath() %>/billing/CA/ON/ViewGenRASummary?rano=<carlos:encode value="${raSummaryModel.raNo}" context="uriComponent"/>&proNo=">Summary</a>
            </form>
        </th>
    </tr>
</table>
