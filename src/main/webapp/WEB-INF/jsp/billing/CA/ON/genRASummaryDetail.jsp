...
--%>
<%--
  Page role: Renders `genRASummaryDetail.jsp` for the Ontario billing workflow.
    ...
    <tr bgcolor="#333333">
        <th align='CENTRE'>
            <form action="${pageContext.request.contextPath}/billing/CA/ON/ViewGenRASummaryDetail" method="post">
                ...
                <button type="submit" name="submit" value="Summary"
                        formaction="${pageContext.request.contextPath}/billing/CA/ON/ViewGenRASummary"
                        formmethod="post"
