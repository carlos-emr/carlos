    ...
    <table style="font:bold small-caps 10pt/12pt">
        <form name="navigationForm" method="get">
            ...
            <tr>
                <td>
                    <a href="javascript:void(0)"
                       onClick="popupPage('<%=bsurl%>/documentManager/ViewDocumentReport.do?function=demographic&doctype=lab&functionid=<%=bean.demographicNo%>&curUser=<%=bean.curProviderNo%>');return false;">documents</a><br>
                </td>
            </tr>
                        ...
                        <td>
                            <select name="selectCurrentForms" class="ControlSelect"
                                ...
                                <c:forEach var="labrst" items="${casemgmtLabsbeans}">
                                    ...
                                    <c:set var="mdvalue" value="${bsurl}/oscarMDS/ViewSegmentDisplay.do?providerNo=${bean.providerNo}&segmentID=${labrst.segmentID}&status=${labrst.reportStatus}" />
