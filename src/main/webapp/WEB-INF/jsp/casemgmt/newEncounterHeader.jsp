   ...
   <div id="left-column">
      ...
      <c:if test="<%=(demographic.getEmail() != null && !demographic.getEmail().isEmpty())%>">
         ...
         <div id="patient-next-appointment">
            <div class="label"><a href="${ctx}/demographic/DemographicApptHistory?demographic_no=<%=demoNo%>&amp;orderby=appointment_date&amp;dboperation=appt_history&amp;limit1=0&amp;limit2=25" title="View Appointment History" target="_blank">
