            ...
            <td bgcolor="white">
                <caisirole:SecurityAccess accessName="prescription Write" accessType="access"
                    ...
                    <a <%= styleColor%> target="_blank"
                                        href="<%= request.getContextPath() %>/rx/ViewStaticScript2?demographicNo=${carlos:forUriComponent(param.demographicNo)}&amp;regionalIdentifier=${carlos:forUriComponent(prescription.regionalIdentifier)}&amp;cn=${carlos:forUriComponent(prescription.customName)}">
