        ...
        <tr>
            <td align="left">
                ...
                <input type="button" name="submit" value="Print"
                       onclick="popupPage(700,800,'decision/antenatal/antenatalplannerprint.do?demographic_no=<%=Encode.forJavaScriptAttribute(demographic_no)%>&formId=<%=Encode.forJavaScriptAttribute(form_no)%>');return false;"/>
            </td>
            <td align="right">
