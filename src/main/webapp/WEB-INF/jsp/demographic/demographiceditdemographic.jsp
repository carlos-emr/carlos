...
<html>
    <head>
       ...
       adding a calendar a matter of 1 or 2 lines of code. -->
        ...
        <script>
            var i18n = {
                msgWrongDOB:                  '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.search.msgWrongDOB") %>' context="javaScriptBlock"/>',
                msgNameRequired:              '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgNameRequired") %>' context="javaScriptBlock"/>',
                msgWrongDate:                 '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgWrongDate") %>' context="javaScriptBlock"/>',
                msgWrongHIN:                  '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgWrongHIN") %>' context="javaScriptBlock"/>',
                msgBlankRoster:               '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgBlankRoster") %>' context="javaScriptBlock"/>',
                msgForbiddenRosterDate:       '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.search.msgForbiddenRosterDate") %>' context="javaScriptBlock"/>',
                msgLeaveBlank:                '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.search.msgLeaveBlank") %>' context="javaScriptBlock"/>',
                msgWrongRosterDate:           '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.search.msgWrongRosterDate") %>' context="javaScriptBlock"/>',
                msgWrongRosterEnrolledTo:     '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.search.msgWrongRosterEnrolledTo") %>' context="javaScriptBlock"/>',
                msgWrongRosterTerminationDate:'<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.search.msgWrongRosterTerminationDate") %>' context="javaScriptBlock"/>',
                msgNoTerminationReason:       '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgNoTerminationReason") %>' context="javaScriptBlock"/>',
                msgWrongPatientStatusDate:    '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.search.msgWrongPatientStatusDate") %>' context="javaScriptBlock"/>',
                msgWrongReferral:             '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgWrongReferral") %>' context="javaScriptBlock"/>',
                msgPromptStatus:              '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgPromptStatus") %>' context="javaScriptBlock"/>',
                msgInvalidEntry:              '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgInvalidEntry") %>' context="javaScriptBlock"/>',
                updateCBIReminder:            '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.updateCBIReminder") %>' context="javaScriptBlock"/>',
                btnCancel:                    '<carlos:encode value='<%= getOrDefault(oscarResources, "global.btnCancel") %>' context="javaScriptBlock"/>',
                btnBack:                      '<carlos:encode value='<%= getOrDefault(oscarResources, "global.btnBack") %>' context="javaScriptBlock"/>',
                msgConfirmClearConsent:       '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgConfirmClearConsent") %>' context="javaScriptBlock"/>',
                msgConfirmEnrolledToMRP:      '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgConfirmEnrolledToMRP") %>' context="javaScriptBlock"/>',
                msgConfirmClearEnrolledTo:    '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgConfirmClearEnrolledTo") %>' context="javaScriptBlock"/>',
                msgAjaxError:                 '<carlos:encode value='<%= getOrDefault(oscarResources, "demographic.demographiceditdemographic.msgAjaxError") %>' context="javaScriptBlock"/>'
            };
