...
<div class="container">
    ...
    <div id="searchResults" style="margin-bottom:10px;">
        ...
        <form method="post" name="addform" action="<%= request.getContextPath() %>/appointment/addappointment.do">
