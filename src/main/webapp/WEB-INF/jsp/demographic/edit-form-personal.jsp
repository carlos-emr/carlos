                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td align="left" nowrap>
                                                            ...
                                                            <input type="text" id="dob"
                                                                   ...
                                                                   pattern="\d{4}-\d{2}-\d{2}"
                                                                   autocomplete="off"
                                                                   value="<carlos:encode value='<%= dobDisplay %>' context="htmlAttribute"/>"
                                                            ...
                                                            <input type="hidden" name="year_of_birth"  id="year_of_birth"  value="<carlos:encode value='<%= StringUtils.defaultString(birthYear) %>' context="htmlAttribute"/>">
                                                            <input type="hidden" name="month_of_birth" id="month_of_birth" value="<carlos:encode value='<%= StringUtils.defaultString(birthMonth) %>' context="htmlAttribute"/>">
                                                            <input type="hidden" name="date_of_birth"  id="date_of_birth"  value="<carlos:encode value='<%= StringUtils.defaultString(birthDate) %>' context="htmlAttribute"/>">
