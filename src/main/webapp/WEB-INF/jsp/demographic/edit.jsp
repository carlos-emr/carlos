                    ...
                    <tr class="Header">
                        ...
                        <special:SpecialPlugin moduleName="inboxmnger" reverse="true">
                            <tr>
                                <td>
                                    <a href="javascript: function myFunction() {return false; }"
                                       onClick="popupPage(710,970,'<%= request.getContextPath() %>/documentManager/ViewDocumentReport?function=demographic&doctype=lab&functionid=<%=Encode.forUriComponent(String.valueOf(demographic.getDemographicNo()))%>')"><fmt:message key="demographic.demographiceditdemographic.msgDocuments"/></a></td>
                            </tr>
                            <%
