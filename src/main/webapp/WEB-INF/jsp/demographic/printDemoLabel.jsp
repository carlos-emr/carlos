...
<html>
    ...
    <iframe id="pdf" title="Patient Label"
            src="printDemoLabelAction?demographic_no=<carlos:encode value='<%= StringUtils.noNull(request.getParameter("demographic_no")) %>' context="uriComponent"/>&appointment_no=<carlos:encode value='<%= StringUtils.noNull(request.getParameter("appointment_no")) %>' context="uriComponent"/>"
