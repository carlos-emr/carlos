    ...
    <form method="post" action="../eform/attachDoc">
        ...
        <div class="section">
            ...
            <div class="list">
                ...
                <% } else { for (EDoc document : allDocuments) { %>
                <div class="item">
                    <label>
                        <input type="checkbox" name="docNo" value="<%= document.getDocId() %>" <%= attachedDocIds.contains(document.getDocId()) ? "checked" : "" %>>
        ...
        <div class="section">
            ...
            <div class="list">
                ...
                <% } else { for (AttachmentLabResultData lab : allLabsSortedByVersions) { %>
                <div class="item">
                    <label>
                        <input type="checkbox" name="labNo" value="<%= lab.getSegmentID() %>" <%= attachedLabIds.contains(lab.getSegmentID()) ? "checked" : "" %>>
                ...
                <% for (Map.Entry<String, String> version : lab.getLabVersionIds().entrySet()) { %>
                <div class="item" style="padding-left: 18px;">
                    <label>
                        <input type="checkbox" name="labNo" value="<%= version.getKey() %>" <%= attachedLabIds.contains(version.getKey()) ? "checked" : "" %>>
        ...
        <div class="section">
            ...
            <div class="list">
                ...
                <% } else { for (HashMap<String, ? extends Object> hrm : allHRMDocuments) { String id = String.valueOf(hrm.get("id")); %>
                <div class="item">
                    <label>
                        <input type="checkbox" name="hrmNo" value="<%= id %>" <%= attachedHrmIds.contains(id) ? "checked" : "" %>>
        ...
        <div class="section">
            ...
            <div class="list">
                ...
                <% } else { for (EFormData eForm : allEForms) { String eformId = String.valueOf(eForm.getId()); String displayName = eForm.getSubject() == null || eForm.getSubject().isEmpty() ? eForm.getFormName() : eForm.getSubject(); %>
                <div class="item">
                    <label>
                        <input type="checkbox" name="eFormNo" value="<%= eformId %>" <%= attachedEFormIds.contains(eformId) ? "checked" : "" %>>
        ...
        <div class="section">
            ...
            <div class="list">
                ...
                <% } else { for (EctFormData.PatientForm form : allForms) { %>
                <div class="item">
                    <label>
                        <input type="checkbox" name="formNo" value="<%= form.getFormId() %>" <%= attachedFormIds.contains(form.getFormId()) ? "checked" : "" %>>
