...
<html>
    ...
    <div class="card card-body bg-body-tertiary">
        ...
        <p>View: <a href="<%=request.getContextPath()%>/eform/efmmanageindependent"
        ...
        <table id="scrollNumber1" name="encounterTable" class="table table-sm table-striped">
            ...
            <tr bgcolor="<%=((i % 2) == 1)?"#F2F2F2":"white"%>">
                <td><a href="#"
                       ONCLICK="popupPage('<%=request.getContextPath()%>/eform/efmshowform_data?fdid=<%=curform.get("fdid")%>', '<%="FormP" + i%>'); return false;"
