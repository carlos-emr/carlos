...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadImage() {
            ...
            bg.src = ("<%=request.getContextPath()%>" + "/eform/displayImage?imagefile=" + encodeURIComponent(img.value));
            PageNum = PageNum + 1;
...
//    }
            ...
            if (document.getElementById('AddStamp2').checked) {
                ...
                textTop += "\tdocument.getElementById('Stamp').src = '<%=request.getContextPath()%>/eform/displayImage?imagefile=consult_sig_'+provNum+'.png';\n";
                textTop += "}\n";
                textTop += "function toggleMe(){\n"
                textTop += "\tif (document.getElementById(&quot;Stamp&quot;).src.indexOf(&quot;BNK.png&quot;)>0){\n"
                textTop += "\t\tSignForm2()\n"
                textTop += "\t} else {\n"
                textTop += "\t\tdocument.getElementById(&quot;Stamp&quot;).src = &quot;<%=request.getContextPath()%>/eform/displayImage?imagefile=BNK.png&quot;;\n"
                textTop += "\t}\n"
                textTop += "}\n"
                textTop += "&lt;/script&gt;\n\n";
            }
            ...
            if (document.getElementById('AddStamp').checked) {
                ...
                textTop += "&lt;script src=\"<%= request.getContextPath() %>/eform/displayImage?imagefile=stamps.js\"&gt;&lt;/script&gt;\n"
                textTop += "&lt;script type=&quot;text/javascript&quot;&gt;\n"
                ...
                textTop += "\t\t\tdocument.getElementById(&quot;Stamp&quot;).src = &quot;<%=request.getContextPath()%>/eform/displayImage?imagefile=&quot;+FileName;\n"
                textTop += "\t\t}\n"
                textTop += "\t}\n"
        ...
        function GetTextMiddle(P) {
            ...
            if (InputType == "Text") {
                ...
                m += y0
                m += "px;&quot;&gt;\n"
                m += "&lt;img id=&quot;Stamp&quot; src=&quot;<%=request.getContextPath()%>/eform/displayImage?imagefile=BNK.png&quot; width=&quot;"
                m += width
                m += "&quot; height=&quot;"
                m += height
                m += "&quot; onclick=&quot;toggleMe();&quot;&gt;\n&lt;/div&gt;\n"
...
//popup modified at this point PHC
        ...
        //this function used for injecting html in to Edit E-Form in efmformmanageredit w/ variable formHtml
        function injectHtml() {
