...
var EFORM_I18N = {
    alertTitle: '${carlos:forJavaScript(i18n_alertTitle)}',
    noMessage: '${carlos:forJavaScript(i18n_noMessage)}',
    buttonOk: '${carlos:forJavaScript(i18n_buttonOk)}',
    buttonCancel: '${carlos:forJavaScript(i18n_buttonCancel)}',
    buttonClose: '${carlos:forJavaScript(i18n_buttonClose)}',
    buttonDelete: '${carlos:forJavaScript(i18n_buttonDelete)}',
    buttonClear: '${carlos:forJavaScript(i18n_buttonClear)}',
    buttonAddPage: '${carlos:forJavaScript(i18n_buttonAddPage)}',
    buttonRemovePage: '${carlos:forJavaScript(i18n_buttonRemovePage)}',
    buttonSubmit: '${carlos:forJavaScript(i18n_buttonSubmit)}',
    buttonPrint: '${carlos:forJavaScript(i18n_buttonPrint)}',
    buttonPrintAndSubmit: '${carlos:forJavaScript(i18n_buttonPrintAndSubmit)}',
    buttonViewSource: '${carlos:forJavaScript(i18n_buttonViewSource)}',
    buttonDownload: '${carlos:forJavaScript(i18n_buttonDownload)}',
    buttonPrintPreview: '${carlos:forJavaScript(i18n_buttonPrintPreview)}',
    buttonLoadEForm: '${carlos:forJavaScript(i18n_buttonLoadEForm)}',
    buttonAttachFunction: '${carlos:forJavaScript(i18n_buttonAttachFunction)}',
    buttonAllNo: '${carlos:forJavaScript(i18n_buttonAllNo)}',
    buttonGroupYellowRadios: '${carlos:forJavaScript(i18n_buttonGroupYellowRadios)}',
    buttonResetYellowRadios: '${carlos:forJavaScript(i18n_buttonResetYellowRadios)}',
    buttonGroupNoRadios: '${carlos:forJavaScript(i18n_buttonGroupNoRadios)}',
    buttonGroupCompleted: '${carlos:forJavaScript(i18n_buttonGroupCompleted)}',
    buttonLinkOrangeBoxes: '${carlos:forJavaScript(i18n_buttonLinkOrangeBoxes)}',
    buttonResetOrangeBoxes: '${carlos:forJavaScript(i18n_buttonResetOrangeBoxes)}',
    labelSubject: '${carlos:forJavaScript(i18n_labelSubject)}',
    labelSelectEForm: '${carlos:forJavaScript(i18n_labelSelectEForm)}',
    labelSelectBgImage: '${carlos:forJavaScript(i18n_labelSelectBgImage)}',
    labelWidth: '${carlos:forJavaScript(i18n_labelWidth)}',
    labelHeight: '${carlos:forJavaScript(i18n_labelHeight)}',
    labelPageDimensions: '${carlos:forJavaScript(i18n_labelPageDimensions)}',
    labelCustomTitle: '${carlos:forJavaScript(i18n_labelCustomTitle)}',
    labelLinkTo: '${carlos:forJavaScript(i18n_labelLinkTo)}',
    labelTemplateSize: '${carlos:forJavaScript(i18n_labelTemplateSize)}',
    labelTemplateWidth: '${carlos:forJavaScript(i18n_labelTemplateWidth)}',
    labelTemplateHeight: '${carlos:forJavaScript(i18n_labelTemplateHeight)}',
    labelPreCheck: '${carlos:forJavaScript(i18n_labelPreCheck)}',
    labelAllNoFunction: '${carlos:forJavaScript(i18n_labelAllNoFunction)}',
    labelPreCheckByGender: '${carlos:forJavaScript(i18n_labelPreCheckByGender)}',
    labelCheckWhen: '${carlos:forJavaScript(i18n_labelCheckWhen)}',
    labelAddFunction: '${carlos:forJavaScript(i18n_labelAddFunction)}',
    labelAddSideBar: '${carlos:forJavaScript(i18n_labelAddSideBar)}',
    labelShowRulerMarks: '${carlos:forJavaScript(i18n_labelShowRulerMarks)}',
    labelEnableSnapGuides: '${carlos:forJavaScript(i18n_labelEnableSnapGuides)}',
    labelTextBorders: '${carlos:forJavaScript(i18n_labelTextBorders)}',
    labelXboxBorders: '${carlos:forJavaScript(i18n_labelXboxBorders)}',
    labelEformName: '${carlos:forJavaScript(i18n_labelEformName)}',
    labelIncludeFaxControls: '${carlos:forJavaScript(i18n_labelIncludeFaxControls)}',
    labelDefaultFaxNo: '${carlos:forJavaScript(i18n_labelDefaultFaxNo)}',
    labelIncludeSetTickler: '${carlos:forJavaScript(i18n_labelIncludeSetTickler)}',
    labelStandAloneTesting: '${carlos:forJavaScript(i18n_labelStandAloneTesting)}',
    labelTriggeringEvent: '${carlos:forJavaScript(i18n_labelTriggeringEvent)}',
    labelFunctionParams: '${carlos:forJavaScript(i18n_labelFunctionParams)}',
    headingLoadEForm: '${carlos:forJavaScript(i18n_headingLoadEForm)}',
    headingPageSetup: '${carlos:forJavaScript(i18n_headingPageSetup)}',
    headingFormBuilding: '${carlos:forJavaScript(i18n_headingFormBuilding)}',
    headingFormStylization: '${carlos:forJavaScript(i18n_headingFormStylization)}',
    headingFinalize: '${carlos:forJavaScript(i18n_headingFinalize)}',
    tabCheckbox: '${carlos:forJavaScript(i18n_tabCheckbox)}',
    tabTextBox: '${carlos:forJavaScript(i18n_tabTextBox)}',
    tabLabel: '${carlos:forJavaScript(i18n_tabLabel)}',
    tabShapes: '${carlos:forJavaScript(i18n_tabShapes)}',
    tabImages: '${carlos:forJavaScript(i18n_tabImages)}',
    tabSignature: '${carlos:forJavaScript(i18n_tabSignature)}',
    optPortrait: '${carlos:forJavaScript(i18n_optPortrait)}',
    optLandscape: '${carlos:forJavaScript(i18n_optLandscape)}',
    optCustom: '${carlos:forJavaScript(i18n_optCustom)}',
    optAlwaysVisible: '${carlos:forJavaScript(i18n_optAlwaysVisible)}',
    optInvisibleOnPrint: '${carlos:forJavaScript(i18n_optInvisibleOnPrint)}',
    optAlwaysInvisible: '${carlos:forJavaScript(i18n_optAlwaysInvisible)}',
    tooltipDragActivate: '${carlos:forJavaScript(i18n_tooltipDragActivate)}',
    tooltipXBoxActivate: '${carlos:forJavaScript(i18n_tooltipXBoxActivate)}',
    tooltipRadioBoxActivate: '${carlos:forJavaScript(i18n_tooltipRadioBoxActivate)}',
    tooltipButtonFrameActivate: '${carlos:forJavaScript(i18n_tooltipButtonFrameActivate)}',
    tooltipNotInUse: '${carlos:forJavaScript(i18n_tooltipNotInUse)}',
    dialogAttachNewFunction: '${carlos:forJavaScript(i18n_dialogAttachNewFunction)}',
    dialogFunctionParticularsPrefix: '${carlos:forJavaScript(i18n_dialogFunctionParticularsPrefix)}',
    dialogFunctionParticularsSuffix: '${carlos:forJavaScript(i18n_dialogFunctionParticularsSuffix)}',
    dialogConfirmPageRemoval: '${carlos:forJavaScript(i18n_dialogConfirmPageRemoval)}',
    dialogConfirmPageRemovalMsg: '${carlos:forJavaScript(i18n_dialogConfirmPageRemovalMsg)}',
    dialogSaveAsNewEform: '${carlos:forJavaScript(i18n_dialogSaveAsNewEform)}',
    dialogUpdateEform: '${carlos:forJavaScript(i18n_dialogUpdateEform)}',
    alertSaveSuccessful: '${carlos:forJavaScript(i18n_alertSaveSuccessful)}',
    alertSaveFailure: '${carlos:forJavaScript(i18n_alertSaveFailure)}',
    alertOnlyOneMasterBox: '${carlos:forJavaScript(i18n_alertOnlyOneMasterBox)}',
    alertSelectMasterCheckbox: '${carlos:forJavaScript(i18n_alertSelectMasterCheckbox)}',
    alertWouldSubmitEform: '${carlos:forJavaScript(i18n_alertWouldSubmitEform)}',
    alertActLikeCheckbox: '${carlos:forJavaScript(i18n_alertActLikeCheckbox)}',
    alertBrowserNotSupported: '${carlos:forJavaScript(i18n_alertBrowserNotSupported)}',
    confirmRadioboxGrouping: '${carlos:forJavaScript(i18n_confirmRadioboxGrouping)}',
    confirmUnsavedChanges: '${carlos:forJavaScript(i18n_confirmUnsavedChanges)}',
    helpAltResize: '${carlos:forJavaScript(i18n_helpAltResize)}',
    helpShiftAspectRatio: '${carlos:forJavaScript(i18n_helpShiftAspectRatio)}',
    helpCtrlCVCopy: '${carlos:forJavaScript(i18n_helpCtrlCVCopy)}',
    noteCustomScripts: '${carlos:forJavaScript(i18n_noteCustomScripts)}',
    textTextBox: '${carlos:forJavaScript(i18n_textTextBox)}',
	   ...
	   //myunique = prompt("Enter Unique Identifier","")  //2021-Jan-10 commented out May-01-2024
        ...
        function dbWindow(qq) {
            if (runStandaloneVersion) {
                var myDbWindow = window.open('Eform_dbtags', 'mywindow', 'width=800, height=800,  top=0, left=0')
                myDbWindow.moveTo(0, 0);
            } else {
                var myDbWindow = window.open('${carlos:forJavaScript(oscar_image_path)}Eform_dbtags', 'mywindow', 'width=800, height=800,  top=0, left=0')
                myDbWindow.moveTo(0, 0);
            }
            // Get the modal
        ...
        function getMeasures(measure) {
            ...
            var newURL = vPath + "encounter/oscarMeasurements/SetupDisplayMeasurementTypes";
            $.ajax({
                type: "GET",
                url: newURL,
                async: true,
	...
	*/
    ...
    <!-- functions to support signature stamps -->
        ...
        function sign(el){
			...
			if ( provNum.length > 0 ) {
				el.src = '../eform/displayImage?imagefile=consult_sig_'+provNum+'.png';
			}
        }
