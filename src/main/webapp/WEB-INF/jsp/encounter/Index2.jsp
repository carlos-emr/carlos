...
<caisi:isModuleLoad moduleName="caisi">
    <%
        ...
        session.setAttribute("casemgmt_bean_flag", "true");
        String hrefurl = request.getContextPath() + "/casemgmt/ViewForward.do?action=view&demographicNo=" + bean.demographicNo + "&providerNo=" + bean.providerNo + "&providerName=" + bean.userName;
        ...
        <div class="row g-0" style="min-height: calc(100vh - 42px);">
            ...
            <div class="col-auto" id="encounter-left-nav" style="width: 22%;">
                <div id="leftNavbar" style="height: 100%; width: 100%;">
                    <caisi:isModuleLoad moduleName="caisi">
                        <%
                            String hrefurl2 = request.getContextPath() + "/casemgmt/ViewForward.do?action=view&demographicNo=" + bean.demographicNo + "&providerNo=" + bean.providerNo + "&providerName=" + bean.userName;
                        %>
