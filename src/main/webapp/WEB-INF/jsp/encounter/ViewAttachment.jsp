...
<html>
    <head>
        ...
        <title><fmt:message key="encounter.ViewAttachment.title"/>
        </title>
    </head>
    ...
    <table class="MainTable" id="scrollNumber1"
           name="<fmt:message key="encounter.ViewAttachment.msgEncounterTable"/>">
        ...
        <tr>
            ...
            <td class="MainTableRightColumn">
                ...
                <div style="font-size: 8pt; margin-top: 15px;"><a
                        href="javascript:expandAll();"><fmt:message key="encounter.ViewAttachment.msgExpandAll"/></a> &nbsp;|&nbsp; <a
                        href="javascript:collapseAll();"><fmt:message key="encounter.ViewAttachment.msgColapseAll"/></a></div>
