        ...
        <script type="text/javascript">
            ...
            function calculate() {
                ...
                document.second.prediction.value =
                    "*****************************************\n"
                    + "*<fmt:message key="encounter.calculators.OsteoporoticFracture.msgAverage"/>      \n"
                    + "*<fmt:message key="encounter.calculators.OsteoporoticFracture.msgOsteoporoticFracture"/>                  \n"
                    + "*****************************************\n"
                    + "* <fmt:message key="encounter.calculators.OsteoporoticFracture.msg10YearProb"/>:         " + retval + " %  \n"
                    + "* <fmt:message key="encounter.calculators.OsteoporoticFracture.msgOverall"/>: " + total + " %  \n"
                    + "*****************************************\n";
...
//	alert(QueryString('age'));
    ...
    <table class="MainTable" id="scrollNumber1" name="encounterTable">
        <tr class="MainTableTopRow">
            <td class="MainTableTopRowLeftColumn"><fmt:message key="encounter.calculators.OsteoporoticFracture.msgCalculators"/>
            </td>
                    ...
                    <tr>
                        <td>
                            <form name="calCorArDi">
                                <table>
                                    <tr>
                                        <td><fmt:message key="encounter.calculators.OsteoporoticFracture.msgFemale"/>:
                                        </td>
                                        <td><input type="radio" name="sex" value="F" checked
                                                   onClick="switchData();"/></td>
                                    </tr>
                                    <tr>
                                        <td><fmt:message key="encounter.calculators.OsteoporoticFracture.msgMale"/>:
                                        </td>
                                        <td><input type="radio" name="sex" value="M"
                                                   onClick="switchData();"/></td>
                                    </tr>
                                    <tr>
                                        <td><fmt:message key="encounter.calculators.OsteoporoticFracture.msgAge"/>:
                                        </td>
                                        <td><input type="text" name="age" size="4"/></td>
                                    </tr>
                                    <tr>
                                        <td><fmt:message key="encounter.calculators.OsteoporoticFracture.msgTScore"/>:
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="button"
                                                               value="<fmt:message key="encounter.calculators.OsteoporoticFracture.btnCalculate"/>"
                                                               onClick="calculate();"/></td>
                                    </tr>
                                    <!--<tr>
										<td><input type="text" name="<fmt:message key="encounter.calculators.OsteoporoticFracture.btnTotalVal"/>" visible="false"/></td>
									</tr>-->
                                </table>
                            </form>
                        ...
                        <td align="center" valign="top">
                            <table class="outline">
                                <tr>
                                    <td><fmt:message key="encounter.calculators.OsteoporoticFracture.msgCompare"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center"><fmt:message key="encounter.calculators.OsteoporoticFracture.msgProbability"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <table class="grid" width="100%" align="center" cellspacing="0">
                                            <tr>
                                                <td rowspan=2 class="gridTitles"><fmt:message key="encounter.calculators.OsteoporoticFracture.msgAge"/></td>
                                                <td class="gridTitlesWOBottom"><fmt:message key="encounter.calculators.OsteoporoticFracture.msgOverall"/></td>
                                                <td colspan=5 class="gridTitlesWOBottom"><fmt:message key="encounter.calculators.OsteoporoticFracture.msgTScore"/></td>

                                            </tr>
                                            <tr>
                                                <td align="center" class="gridTitles"><fmt:message key="encounter.calculators.OsteoporoticFracture.msgAvg"/></td>
