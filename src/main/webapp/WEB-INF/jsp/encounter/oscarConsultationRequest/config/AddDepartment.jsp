...
<%
    ...
    String transactionType = new String(oscarR.getString("encounter.oscarConsultationRequest.config.AddDepartment.addOperation"));
    String id = null;
    int whichType = 1;
    if (request.getAttribute("upd") != null) {
        transactionType = new String(oscarR.getString("encounter.oscarConsultationRequest.config.AddDepartment.updateOperation"));
        whichType = 2;
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="alert alert-success">
                    <fmt:message key="encounter.oscarConsultationRequest.config.AddDepartment.msgDepartmentAdded">
