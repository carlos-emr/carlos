        ...
        <script>
            function checkServiceName() {
                ...
                if (service.value.trim() == "") {
                    alert("<fmt:message key="encounter.oscarConsultationRequest.config.AddService.serviceNameEmpty"/>");
                    service.focus();
                    return false;
                } else return true;
            }
    ...
    <div class="container-fluid">
        <div class="page-header-bar">
            <h5 class="page-header-title">
                <fmt:message key="encounter.oscarConsultationRequest.config.AddService.title"/>
            </h5>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="alert alert-success">
                    <fmt:message key="encounter.oscarConsultationRequest.config.AddService.msgServiceAdded">
                ...
                <form action="${pageContext.request.contextPath}/encounter/AddService.do" method="post" onsubmit="return checkServiceName();">
                    ...
                    <input type="submit" class="btn btn-primary"
                           value="<fmt:message key="encounter.oscarConsultationRequest.config.AddService.btnAddService"/>"/>
                </form>
            </div>
        </div>
    </div>
