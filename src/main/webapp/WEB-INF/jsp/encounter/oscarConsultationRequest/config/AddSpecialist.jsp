...
<security:oscarSec roleName="<%=roleName$%>" objectName="_admin,_admin.consult" rights="w" reverse="<%=true%>">
    <%authed = false; %>
    <%response.sendRedirect(request.getContextPath() + "/error/SecurityError.do?type=_admin&type=_admin.consult");%>
</security:oscarSec>
<%
    if (!authed) {
        return;
...
<%
    ...
    String transactionType = new String(oscarR.getString("encounter.oscarConsultationRequest.config.AddSpecialist.addOperation"));
    String specId = null;
    int whichType = 1;
    if (request.getAttribute("upd") != null) {
        transactionType = new String(oscarR.getString("encounter.oscarConsultationRequest.config.AddSpecialist.updateOperation"));
        whichType = 2;
...
<html>
    <head>
        ...
        <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.unavailable"   var="cpsoMsgUnavailable"/>
        <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.noResults"     var="cpsoMsgNoResults"/>
        <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.tooManyResults" var="cpsoMsgTooMany"/>
        <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.phoneLabel"    var="cpsoMsgPhone"/>
        <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.faxLabel"      var="cpsoMsgFax"/>
        <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.cpsoLabel"     var="cpsoMsgCpso"/>
        <script>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="alert alert-success">
                    <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.msgSpecialistAdded">
                ...
                <form action="${pageContext.request.contextPath}/encounter/AddSpecialist.do" method="post">
                    ...
                    <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.lastNamePlaceholder"  var="cpsoAttrLNPlaceholder"/>
                    <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.firstNamePlaceholder" var="cpsoAttrFNPlaceholder"/>
                    <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.ariaSearching"        var="cpsoAttrAriaSearching"/>
                    <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.ariaResults"          var="cpsoAttrAriaResults"/>
                    <div class="card mb-3" style="border: 1px solid var(--carlos-primary, #337ab7);">
                        <div class="card-header text-white py-2" style="background-color: var(--carlos-primary, #337ab7);">
                            <strong><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.title"/></strong>
                            <small class="ms-2"><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.cpsoSearch.subtitle"/></small>
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="salutation" id="salutation" class="form-select">
                                ...
                                <option value="Dr." ${EctConAddSpecialistForm.salutation == 'Dr.' ? 'selected' : ''}><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.msgDr"/></option>
                                <option value="Mr." ${EctConAddSpecialistForm.salutation == 'Mr.' ? 'selected' : ''}><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.msgMr"/></option>
                                <option value="Mrs." ${EctConAddSpecialistForm.salutation == 'Mrs.' ? 'selected' : ''}><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.msgMrs"/></option>
                                <option value="Miss" ${EctConAddSpecialistForm.salutation == 'Miss' ? 'selected' : ''}><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.msgMiss"/></option>
                                <option value="Ms." ${EctConAddSpecialistForm.salutation == 'Ms.' ? 'selected' : ''}><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.msgMs"/></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <label for="specType" class="form-label"><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.specialistType"/></label>
                        ...
                        <div class="col-md-6">
                            <label for="referralNo" class="form-label"><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.referralNo"/></label>
                            <% if (request.getAttribute("refnoinuse") != null) { %>
                            <div class="text-danger mb-1"><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.referralNoInUse"/></div>
                            <% } else if (request.getAttribute("refnoinvalid") != null) { %>
                            <div class="text-danger mb-1">
                                <fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.referralNoInvalid">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <label for="institution" class="form-label"><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.institution"/></label>
                        ...
                        <div class="col-md-6">
                            <label for="department" class="form-label"><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.department"/></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="eformId" class="form-label"><fmt:message key="encounter.oscarConsultationRequest.config.AddSpecialist.eform"/></label>
