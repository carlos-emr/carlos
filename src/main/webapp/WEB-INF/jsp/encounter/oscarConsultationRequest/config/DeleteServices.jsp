    ...
    <div class="container-fluid">
        <div class="page-header-bar">
            <h5 class="page-header-title">
                <fmt:message key="encounter.oscarConsultationRequest.config.DeleteServices.title"/>
            </h5>
        </div>
                    ...
                    <table class="table table-sm table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.DeleteServices.service"/></th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
