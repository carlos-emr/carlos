    ...
    <div class="container-fluid">
        <div class="page-header-bar">
            <h5 class="page-header-title">
                <fmt:message key="encounter.oscarConsultationRequest.config.DisplayService.title"/>
            </h5>
        </div>
...
<% } %>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <p>
                    <fmt:message key="encounter.oscarConsultationRequest.config.DisplayService.msgCheckOff">
                    ...
                    <table class="table table-sm table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.DisplayService.specialist"/></th>
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.DisplayService.address"/></th>
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.DisplayService.phone"/></th>
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.DisplayService.fax"/></th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
