    ...
    <div class="container-fluid">
        <div class="page-header-bar">
            <h5 class="page-header-title">
                <fmt:message key="encounter.oscarConsultationRequest.config.EditSpecialists.title"/>
            </h5>
        </div>
                    ...
                    <table class="table table-sm table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.EditSpecialists.specialist"/></th>
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.EditSpecialists.address"/></th>
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.EditSpecialists.phone"/></th>
                                <th><fmt:message key="encounter.oscarConsultationRequest.config.EditSpecialists.fax"/></th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
