    ...
    <div class="container-fluid">
        <div class="page-header-bar">
            <h5 class="page-header-title">
                <fmt:message key="encounter.oscarConsultationRequest.config.EnableRequestResponse.title"/>
            </h5>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="alert alert-success">
                    <fmt:message key="encounter.oscarConsultationRequest.config.EnableRequestResponse.msgUpdated"/>
                </div>
                <% } %>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="reqEnabled">
                                <fmt:message key="encounter.oscarConsultationRequest.config.EnableRequestResponse.enableRequest"/>
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox"
                            ...
                            <label class="form-check-label" for="respEnabled">
                                <fmt:message key="encounter.oscarConsultationRequest.config.EnableRequestResponse.enableResponse"/>
                            </label>
                        </div>
                    </div>
                    <input type="submit" class="btn btn-primary"
                           value="<fmt:message key="encounter.oscarConsultationRequest.config.EnableRequestResponse.btnUpdate"/>"/>
                </form>
            </div>
        </div>
    </div>
