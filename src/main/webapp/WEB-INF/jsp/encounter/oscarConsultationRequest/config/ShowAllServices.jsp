    ...
    <div class="container-fluid">
        <div class="page-header-bar">
            <h5 class="page-header-title">
                <fmt:message key="encounter.oscarConsultationRequest.config.ShowAllServices.title"/>
            </h5>
        </div>
...
<% } %>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h6 class="mb-3">
                    <fmt:message key="encounter.oscarConsultationRequest.config.ShowAllServices.services"/>
                </h6>
