...
<% } %>
    <form action="${pageContext.request.contextPath}/encounter/oscarMeasurements/DeleteMeasurementStyleSheet" method="post">
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr class="data">
                                        <td width="300">${carlos:forHtml(styleSheet.styleSheetName)}</td>
                                        <td width="10">
