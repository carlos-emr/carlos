...
<html>
    <head>
        ...
        <title><fmt:message key="encounter.Measurements.msgEditMeasurementGroup"/></title>
...
<% } %>
    <form action="${pageContext.request.contextPath}/encounter/oscarMeasurements/EditMeasurementGroup" method="post">
            ...
            <tr class="MainTableTopRow">
                ...
                <td class="MainTableTopRowRightColumn">
                    <table class="TopStatusBar">
                        <tr>
                            <td><fmt:message key="encounter.Measurements.msgEditMeasurementGroup"/></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table border=0 cellspacing=4 width=800>
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <th align="left"><fmt:message key="encounter.oscarMeasurements.MeasurementGroup.allTypes"/>
                                        </th>

                                        <th align="left"><carlos:encode value='<%= groupName %>' context="html"/></th>
                                    </tr>
                                    <tr>
