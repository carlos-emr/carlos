...
<html>
    ...
    <head>
        <title>
            <fmt:message key="encounter.Index.oldMeasurements"/>
        </title>
        ...
        function popupPage(vheight, vwidth, varpage) { //open a new popup window
            ...
            if (popup != null) {
                if (popup.opener == null) {
                    popup.opener = self;
                    alert("<fmt:message key="encounter.Index.popupPageAlert"/>");
                }
            }
        }
    </script>
        ...
        <table>
            <tr>
                <td>
                    <table>
                        <tr>
                            <th colspan='3'><fmt:message key="encounter.oscarMeasurements.oldmesurementindex"/></th>
                        </tr>
                        <tr>
