    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr valign="top">
            <td align="center">
                ...
                <label for="p1_birthRemarksr1"><fmt:message key="encounter.formRourke2009.formPremature"/></label>&nbsp;
                ...
                <label for="p1_birthRemarksr2"><fmt:message key="encounter.formRourke2009.formHighRisk"/></label>&nbsp;<br>
                ...
                <label for="p1_birthRemarksr3"><fmt:message key="encounter.formRourke2009.formNoConcerns"/></label>&nbsp;
            </td>
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    ...
    <tr align="center" id="growthAp1">
        <td class="column" rowspan="2">
            <a>
                <fmt:message key="encounter.formRourke2020_1.btnGrowth"/><br/>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formCrying"/>**</a>
                    </td>
            ...
            <table id="dt12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_noParentsConcerns2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2020.formNoparentConcerns"/>**</td>
                </tr>
                <tr align="center">
            ...
            <table id="pt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_skin1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formDrySkin"/></a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <i><fmt:message key="encounter.formRourke2020.formIntectPalate"/>**</i>
                        </a>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_tongueMobility1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formTongueMobility"/>**</a></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_neckTorticollis1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formNeckTorticollis"/>**</a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_femoralPulses1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2020.formFemoralPulses"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_genitalia1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2020.formGenitalia"/></td>
                </tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_patencyOfAnus1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2020.formSpine"/>**/<fmt:message key="encounter.formRourke2020.formPatencyOfAnus"/>**
                    </td>
                </tr>
                <tr>
            ...
            <table id="pt12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_skin2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formDrySkin"/></a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_spine2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2020.formSpine"/>**</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <i><fmt:message key="encounter.formRourke2020.formHearingInquiry"/>**</i>
                        </a>
                    </td>
                </tr>
                <tr>
            ...
            <table id="immt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_newbornScreening1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><b><fmt:message key="encounter.formRourke2020.formImmunizationNewbornScreening"/></b></td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formImmunizationHemoglobinopathyScreen"/></a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formImmunizationNewbornHearingScreening"/></a></b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formImmunizationHepatitisVaccine1"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
            ...
            <table id="immt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formImmunizationHepatitisVaccine2"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
    ...
    <tr>
        ...
        <td align="center">
            <% if (formId > 0) { %> <a name="length" href="#"
                                       onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2020&__title=Baby+Head+Circumference&__cfgfile=<%=growthCharts[0]%>&demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>','<%= "growth1" + demoNo %>');return false;">
