    ...
    <tr>
        ...
        <td align="center" nowrap="true" width="100%">
            <% if (formId > 0) { %> <a name="length" href="#"
                                       onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2020&__title=Baby+Growth+Graph1&__cfgfile=<%=growthCharts[0]%>&demographic_no=<e:forUriComponent value='<%= String.valueOf(demoNo) %>' />&formId=<e:forUriComponent value='<%= String.valueOf(formId) %>' />&provNo=<e:forUriComponent value='<%= String.valueOf(provNo) %>' />','<%= "growth1" + demoNo %>');return false;">
            ...
            <table id="dt23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_NoPersistentClosed6mOk"
                        ...
                        <e:forHtmlAttribute value='<%= props.getProperty("p2_NoPersistentClosed6mOk", "") %>' />></td>
                    <td valign="top"><input type="radio" id="p2_NoPersistentClosed6mOkConcerns"
                                            name="p2_NoPersistentClosed6mOkConcerns"
                                            onclick="onCheck(this,'p2_NoPersistentClosed6m')"
                        <e:forHtmlAttribute value='<%= props.getProperty("p2_NoPersistentClosed6mOkConcerns", "") %>' />></td>
                    <td valign="top"><input type="radio" id="p2_NoPersistentClosed6mNotDiscussed"
                                            name="p2_NoPersistentClosed6mNotDiscussed"
                                            onclick="onCheck(this,'p2_NoPersistentClosed6m')"
                        <e:forHtmlAttribute value='<%= props.getProperty("p2_NoPersistentClosed6mNotDiscussed", "") %>' />></td>
