...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    ...
    <tr id="growthAp3" align="center">
        <td class="column" rowspan="2">
            <a><fmt:message key="encounter.formRourke2020_1.btnGrowth"/></a><br>
            ...
            <table id="ntp31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formIronFruitsAndVegetables"/>
                    </a></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_introCowMilk9m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2020.formCowsMilkProducts"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_cup9m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2020.formEncourageChangeToCup"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_eatsVarietyOfTextures9m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2020.formEatsVarietyOfTexture"/></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formNoHoney"/>*
                    </a></td>
                </tr>
                <tr>
    ...
    <tr>
        ...
        <td><a href="javascript:showNotes()"
               onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
               onMouseOut="hideLayer()">
            <fmt:message key="encounter.formRourke2020.formNoBottlesInBed"/>
        </a></td>
    </tr>
    <tr>
        <rourke:discussionRadioSelect sectionName="p3_cup12m" formProperties="<%=props%>"
                                      showNotDiscussedOption="<%=true%>"/>
        <td><fmt:message key="encounter.formRourke2020.formPromoteOpenCup"/></td>
    </tr>
    <tr>
    ...
    <tr>
        <rourke:discussionRadioSelect sectionName="p3_eatsVarietyOfTextures12m" formProperties="<%=props%>"
                                      showNotDiscussedOption="<%=true%>"/>
        <td><fmt:message key="encounter.formRourke2020.formEatsFamilyFoodTextures"/>*</td>
    </tr>
    <tr>
...
<td colspan="3">
    <table id="ntp33" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="padding-right: 5pt" valign="top" onclick="selectAllOkRadioButtons(this)">
                <div class="checkmark-img-wrapper"><img height="15" width="20" src="${pageContext.request.contextPath}/form/graphics/Checkmark_L.gif"></div>
            </td>
            <td class="edcol" valign="top">X</td>
            <td class="edcol" valign="top"><fmt:message key="encounter.formRourke2009.formNo"/></td>
            <td class="edcol" valign="top" colspan="2"><fmt:message key="encounter.formRourke2009.formNotDiscussed"/></td>
        ...
        <table id="edt3" style="font-size: 9pt; height: 466px;" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td valign="top">
                    <b><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                          onMouseOut="hideLayer()" href="javascript:showNotes()">
                        <fmt:message key="encounter.formRourke2020.formSafeSleep"/>*
                    </a></b>
                </td>
            ...
            <tr>
                ...
                <td valign="top">
                    <b><a href="javascript:showNotes()"
                          onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                          onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formHealthySleep"/>**
                    </a></b>
                </td>
                ...
                <td valign="top">
                    <b><a href="javascript:showNotes()"
                          onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                          onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formNightWaking"/>**
                    </a></b>
                </td>
            ...
            <tr>
                ...
                <td valign="top">
                    <b><a href="javascript:showNotes()"
                          onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                          onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formParenting"/>**
                    </a></b>
                </td>
                ...
                <td valign="top">
                    <i><a href="javascript:showNotes()"
                          onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                          onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formChildCare"/>
                    </a></i>
                </td>
            </tr>
            <tr>
                ...
                <td valign="top">
                    <b><a href="javascript:showNotes()"
                          onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                          onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formParentFatigueDepression"/>**
                    </a></b>
                </td>
            ...
            <tr>
                ...
                <td valign="top">
                    <a href="javascript:showNotes()"
                       onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                       onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formFootwear"/>*
                    </a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="5" valign="top">
                    <a href="javascript:showNotes()"
                       onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                       onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formDental"/>*
                    </a>
                </td>
            </tr>
            <tr>
        ...
        <table id="dt31" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="padding-right: 5pt" valign="top" onclick="selectAllOkRadioButtons(this)">
                    <div class="checkmark-img-wrapper"><img height="15"
                                                            width="20" src="${pageContext.request.contextPath}/form/graphics/Checkmark_L.gif"></div>
                </td>
                <td class="edcol" valign="top">X</td>
                <td class="edcol" valign="top" colspan="2"><fmt:message key="encounter.formRourke2009.formNotDiscussed"/></td>
            </tr>
            ...
            <tr>
                <rourke:discussionRadioSelect sectionName="p3_UseBothHand9m" formProperties="<%=props%>"
                                              showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                <td valign="top"><fmt:message key="encounter.formRourke2020.formUseBothHand"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <rourke:discussionRadioSelect sectionName="p3_thumb" formProperties="<%=props%>"
                                              showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                <td valign="top"><fmt:message key="encounter.formRourke2020.formThumbAndFingersGrasp"/></td>
            </tr>
            <tr>
        ...
        <table id="dt32" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <rourke:discussionRadioSelect sectionName="p3_shuffles" formProperties="<%=props%>"
                                              showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                <td valign="top"><fmt:message key="encounter.formRourke2020.formCrawls"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <rourke:discussionRadioSelect sectionName="p3_hasPincerGrasp" formProperties="<%=props%>"
                                              showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                <td valign="top"><fmt:message key="encounter.formRourke2020.formHasPincerGrasp"/></td>
            </tr>
            <tr>
    ...
    <td colspan="9" valign="top">
        <table id="immt31" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
            ...
            <td colspan="3"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                <fmt:message key="encounter.formRourke2020.formBloodLead"/>*
            </a></i></td>
</tr>
<tr>
...
<tr>
    ...
    <td colspan="7"><b><a href="javascript:showNotes()"
                          onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                          onMouseOut="hideLayer()">
        <fmt:message key="encounter.formRourke2020.form9Or12MonthsHbvAntibodies"/>***
    </a></b></td>
</tr>
<tr>
