...
<table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
    <tr>
        ...
        <td align="center" nowrap="true" width="100%">
            <% if (formId > 0) { %>
            <a name="length" href="#"
               onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2020&__title=Baby+Growth+Graph1&__cfgfile=<%=growthCharts[0]%>&demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>','<%= "growth1" + demoNo %>');return false;">
                <fmt:message key="encounter.formRourke1.btnGraphLenghtWeight"/>
            </a><br>
            <a name="headCirc" href="#"
               onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2020&__title=Baby+Head+Circumference&__cfgfile=<%=growthCharts[1]%>&demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>','<%= "growth2" + demoNo %>');return false;">
...
<div id="patientInfop4">
    ...
    <% if (!((FrmRourke2020Record) rec).isFemale(loggedInInfo, demoNo)) { %>(<fmt:message key="encounter.formRourke1.msgMale"/>)
            ...
            <table id="ntp41" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              ...
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formBreastfeedingVitaminD"/>
                    </a></b></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formHomogenizedMilk"/>
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formAvoidJuiceAndBeverages"/>*
                    </a></b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_noBottle18m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2020.formNoBottle"/></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formInquireVegetarianDiets"/>*
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formIndependentSelfFeeding"/>*
                    </a></td>
                </tr>
                <tr>
            ...
            <table id="ntp42" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formLowerFatDiet"/>*
                    </a></i></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formMilk"/>
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formCanadasFoodGuide"/>*</a>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" style="vertical-align:bottom;">
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formCanadasFoodGuide"/>*
                        </a>
                    </td>
                </tr>
                <tr>
            ...
            <table id="edt41" style="font-size: 8pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="encounter.formRourke2020.formCarBoosterSeat"/>*
                        </a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="encounter.formRourke2006_1.formBathSafety"/>*/<fmt:message key="encounter.formRourke2020.formBurns"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formFallsAndFurniture"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formWeanFromPacifier"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    <td valign="top" colspan="4"><fmt:message key="encounter.formRourke2020.formBehaviourAndFamily"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formParentFatigueStressDepression"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" valign="top"><fmt:message key="encounter.formRourke2020.formEnvironmentalHealth"/> &amp; <fmt:message key="encounter.formRourke2006_1.formOtherIssues"/></td>
                </tr>
                <tr>
            ...
            <table id="edt42" style="font-size: 8pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="encounter.formRourke2020.forBikeHelmets"/>*
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formFirearmSafety"/>*
                        </a></b>
                    </td>
                    <rourke:discussionRadioSelect sectionName="p4_injuryMatches24m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2020.forMatches"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_1.formSmokeSafety"/>*/<fmt:message key="encounter.formRourke2020.formBurns"/>*/
                            <fmt:message key="encounter.formRourke2020.forMatches"/>
                        </a>
                    </td>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formWaterSafety"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formFallsFurnitureAndTrampolines"/>*
                        </a></i>
                    </td>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formNoPacifiers"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    <td valign="top" colspan="12"><fmt:message key="encounter.formRourke2020.formBehaviourAndFamily"/></td>
                </tr>
                <tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.forChildCareAndSchoolReadiness"/>**</a></i>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="5" valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formDentalCleaningFluoride"/>*</a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2020.formAltMed"/>*
                        </a></i>
                    </td>
    ...
    <tr id="developmentp4">
        ...
        <td colspan="3" align="center">
            <table id="dt41" cellpadding="0" cellspacing="0" width="300px" height="100%">
                <tr>
                    <td colspan="4">
                        <fmt:message key="encounter.formRourke2020_4.msgNippissing"/>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_says20words18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2020.formSays15Words"/></td>
                </tr>
                <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                            ...
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_listenMusic36m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2020.formListensMusic"/></td>
                            </tr>
                            <tr>
            ...
            <table id="pt41" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formAnteriorFontanelleClosed"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_tonsilSize18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formTonsilSize"/>**
                    </a></b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_teeth18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formTeethRisk"/>**
                    </a></td>
                </tr>
                <tr>
            ...
            <table id="pt42" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_bloodPressure24m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formBloodPressureIfAtRisk"/>**
                    </a></i></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_eyes24m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.EyesVisualAcuity"/>**
                    </a></b></td>
                </tr>
                <tr>
            ...
            <table id="immt41" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="2"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formAnemiaScreening"/>**</a></i>
                    </td>
                    ...
                    <td colspan="3"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2020.formBloodLead"/>*</a></i>
                    </td>
                </tr>
                <tr>
