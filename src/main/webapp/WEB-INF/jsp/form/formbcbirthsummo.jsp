...
// Declaring valid date character, minimum year and maximum year
    ...
    <form action="${pageContext.request.contextPath}/form/formname" method="post">
            ...
            <tr>
                <td width="50%" valign="top">
                    ...
                    <table class="headline" width="100%" border="0" cellspacing="0"
                           cellpadding="0">
                        <tr>
                            <th><%=bView ? "<font color='yellow'>" : ""%><fmt:message key='form.bcbirthsummo.viewPage'/><%=bView ? "</font>" : ""%>
                                ...
                                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td colspan="3"><fmt:message key='form.bcbirthsummo.gestAge'/><input type="text" name="gestAge"
                                                                          ...
                                                                          @oscar.formDB/>
                                            <fmt:message key='form.bcbirthsummo.weeksShort'/> <input type="text" name="gestWks" size="5" maxlength="5"
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="45%" nowrap><span class="small9"> <input
                                    ...
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.spontaneous'/>&nbsp;&nbsp; <input
                                    type="checkbox" name="labAugmented1"
                                    <%= props.getProperty("labAugmented1", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.augmented'/>&nbsp;&nbsp; <input
                                    type="checkbox" name="labArm1"
                                    <%= props.getProperty("labArm1", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.arm'/>&nbsp;&nbsp; <input type="checkbox"
                                                                                  name="labOxytocin1"
                            ...
                            <td nowrap><span class="small9"> <input type="checkbox"
                                    ...
                                    <%= props.getProperty("labOtherChk1", "") %> @oscar.formDB
                                                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.other'/> </span></td>
                            ...
                            <td nowrap><span class="small9"> &nbsp;<fmt:message key='form.bcbirthsummo.indication'/></td>
                        ...
                        <tr>
                            <td nowrap><span class="small8"> <input type="checkbox"
                                    ...
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.induced'/>&nbsp;&nbsp; <input
                                    type="checkbox"
                                    name="labArm2"
                                    <%= props.getProperty("labArm2", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.armColon'/>&nbsp;&nbsp; <input type="checkbox"
                                                                                   name="labFoley2"
                                    <%= props.getProperty("labFoley2", "") %> @oscar.formDB
                                                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.foley'/>&nbsp;&nbsp; <input
                                    type="checkbox"
                                    name="labProstaglandin2"
                                    <%= props.getProperty("labProstaglandin2", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.prostaglandin'/>&nbsp;&nbsp; <input
                                    type="checkbox" name="labOxytocin2"
                                    <%= props.getProperty("labOxytocin2", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.oxytocin'/>&nbsp;&nbsp; </span></td>
                            <td nowrap><input type="checkbox" name="labOtherChk2"
                                    <%= props.getProperty("labOtherChk2", "") %> @oscar.formDB
                                              dbType="tinyint(1)"/> <span class="small9"> <fmt:message key='form.bcbirthsummo.other'/> </span></td>
            ...
            <tr>
                <td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><span class="small9"> <B><fmt:message key='form.bcbirthsummo.membraneRupture'/></B> <input
                                    ...
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.obvious'/>&nbsp;&nbsp; <input type="checkbox"
                                                                                      name="labMemRupQuer"
                                    <%= props.getProperty("labMemRupQuer", "") %> @oscar.formDB
                                                                                      dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.queried'/>&nbsp;&nbsp; <input
                                    type="checkbox"
                                    name="labMemRupConf"
                                    <%= props.getProperty("labMemRupConf", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.confirmed'/>&nbsp;&nbsp; </span></td>
                        </tr>
                        <tr>
                            <td><span class="small9"> <B><fmt:message key='form.bcbirthsummo.amnioticFluid'/></B> <input
                                    type="checkbox" name="labAmnFluClear"
                                    <%= props.getProperty("labAmnFluClear", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.clear'/>&nbsp;&nbsp; <input type="checkbox"
                                                                                    name="labAmnFluBloody"
                                    <%= props.getProperty("labAmnFluBloody", "") %> @oscar.formDB
                                                                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.bloody'/>&nbsp;&nbsp; <input
                                    type="checkbox"
                                    name="labAmnFluMeco"
                                    <%= props.getProperty("labAmnFluMeco", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.meconium'/>&nbsp;&nbsp; <fmt:message key='form.bcbirthsummo.timeMeconiumNoted'/><input
                                    type="text" name="labAmnFluTimeMeco" size="10" maxlength="10"
                                    value="<%= props.getProperty("labAmnFluTimeMeco", "") %>"
                                    @oscar.formDB/> <fmt:message key='form.bcbirthsummo.hoursShort'/> </span></td>
                        </tr>
                    </table>
            ...
            <tr>
                <td>
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><span class="small9"> <B><fmt:message key='form.bcbirthsummo.fetalSurveillance'/></B> <input
                                    type="checkbox" name="labInterAusc"
                                    <%= props.getProperty("labInterAusc", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.intermittentAuscultation'/>&nbsp;&nbsp; <input
                                    type="checkbox" name="labExtEfm"
                                    <%= props.getProperty("labExtEfm", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.externalEfm'/>&nbsp;&nbsp; <input
                                    type="checkbox" name="labFetalEcg"
                                    <%= props.getProperty("labFetalEcg", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.fetalEcg'/>&nbsp;&nbsp; <input
                                    type="checkbox" name="labIupc"
                                    <%= props.getProperty("labIupc", "") %> @oscar.formDB
                                    dbType="tinyint(1)"/> IUPC <br>
					<B><fmt:message key='form.bcbirthsummo.fetalBloodSampling'/></B> <fmt:message key='form.bcbirthsummo.noOfTimes'/><input type="text"
                                                                     name="labFetalBldNo" size="5" maxlength="5"
                                                                     value="<%= props.getProperty("labFetalBldNo", "") %>"
                                                                     @oscar.formDB/> <fmt:message key='form.bcbirthsummo.lowestPh'/><input type="text"
                                                                                                       name="labFetalBldPh"
                                                                                                       size="10"
                                                                                                       maxlength="10"
                                        ...
                                        @oscar.formDB/> </span></td>
                            <td width="30%"><B><fmt:message key='form.bcbirthsummo.intrapartumAntibiotics'/></B><br>
                                <input type="checkbox" name="labIntAntibioN"
                                        <%= props.getProperty("labIntAntibioN", "") %> @oscar.formDB
                                       dbType="tinyint(1)"/> <fmt:message key='global.no'/>&nbsp;&nbsp; <input type="checkbox"
                                                                                    name="labIntAntibioY"
                                        <%= props.getProperty("labIntAntibioY", "") %> @oscar.formDB
                                                                                    dbType="tinyint(1)"/> <fmt:message key='global.yes'/> <I>(<fmt:message key='form.bcbirthsummo.specify'/>)</I>:
                                <input type="text"
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            <tr>
                <td width="45%" valign="top">
                    ...
                    <table class="small8" width="100%" border="0" cellspacing="0"
                        ...
                        <tr>
                            <td colspan="4"><B>
                                <div class="small10"><fmt:message key='form.bcbirthsummo.sectionDelivery'/></div>
                            </B></td>
                        </tr>
                        <tr>
                            <td colspan="4" nowrap><input type="checkbox" name="delSvd"
                                ...
                                <fmt:message key='form.bcbirthsummo.fetalPositionInLabour'/>
                                <input
                                        type="text" name="delFetalPosLab" size="30" maxlength="60"
                                        value="<%= props.getProperty("delFetalPosLab", "") %>"
                                        @oscar.formDB/> <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key='form.bcbirthsummo.fetalPositionAtDelivery'/>&nbsp;&nbsp;&nbsp; <input type="text"
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="delPrim"
                                    <%= props.getProperty("delPrim", "") %> @oscar.formDB
                                       dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.primary'/>
                            </td>
                            <td><input type="checkbox" name="delElect"
                                    <%= props.getProperty("delElect", "") %> @oscar.formDB
                                       dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.elective'/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td><input type="checkbox" name="delRepeat"
                                    <%= props.getProperty("delRepeat", "") %> @oscar.formDB
                                       dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.repeat'/>
                            </td>
                            <td><input type="checkbox" name="delEmergy"
                                    <%= props.getProperty("delEmergy", "") %> @oscar.formDB
                                       dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.emergency'/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2"><input type="checkbox" name="delLowTranInc"
                                    <%= props.getProperty("delLowTranInc", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.lowTransverseIncision'/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2"><input type="checkbox" name="delOther"
                                    <%= props.getProperty("delOther", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.other'/> (<I><fmt:message key='form.bcbirthsummo.specify'/></I>) <input type="text"
                                                                                                       name="delOtherSpec"
                                                                                                       size="20"
                                                                                                       maxlength="60"
                        ...
                        <tr>
                            <td colspan="4" valign="top"><input type="checkbox"
                                    ...
                                    <%= props.getProperty("delOtherPres", "") %> @oscar.formDB
                                                                dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.otherPresentation'/> (<I><fmt:message key='form.bcbirthsummo.specify'/></I>)
                                <input
                        ...
                        <tr>
                            <td colspan="2" width="55%" valign="top">
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                       cellpadding="0">
                                    <tr>
                                        <td colspan="3"><B><fmt:message key='form.bcbirthsummo.analgesiaAnesthesia'/></B></td>
                                    </tr>
                                    <tr>
                                        <td width="33%"><input type="checkbox" name="delAnaNone"
                                                <%= props.getProperty("delAnaNone", "") %> @oscar.formDB
                                                               dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.none'/>
                                        </td>
                                        <td width="33%"><input type="checkbox"
                                                               name="delAnaNarcotics"
                                                <%= props.getProperty("delAnaNarcotics", "") %> @oscar.formDB
                                                               dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.narcotics'/>
                                        </td>
                            ...
                            <td>
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                       cellpadding="0">
                                    <tr>
                                        <td><B><fmt:message key='form.bcbirthsummo.oxytocinPostpartum'/></B></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="delOxyIV"
                                                <%= props.getProperty("delOxyIV", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.iv'/> <input type="checkbox" name="delOxyIM"
                                                <%= props.getProperty("delOxyIM", "") %> @oscar.formDB
                                                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.imDoses'/>
                                            <input type="text"
                                    ...
                                    <tr>
                                        <td><fmt:message key='form.bcbirthsummo.signature'/> <input type="text" name="delOxySign"
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                       cellpadding="0">
                                    <tr>
                                        <td colspan="4"><B><fmt:message key='form.bcbirthsummo.placentaAndCord'/></B></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="delPlaSpont"
                                                ...
                                                dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.assisted'/>
                                        </td>
                                        <td align="right"><fmt:message key='form.bcbirthsummo.complete'/></td>
                                        <td><input type="checkbox" name="delPlaCompN"
                                                <%= props.getProperty("delPlaCompN", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='global.no'/>
                                        </td>
                                        <td><input type="checkbox" name="delPlaCompY"
                                                <%= props.getProperty("delPlaCompY", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='global.yes'/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><input type="checkbox" name="delPlaManOper"
                                                <%= props.getProperty("delPlaManOper", "") %> @oscar.formDB
                                                               dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.manualOperativeRemoval'/>
                                        </td>
                                        <td align="right"><fmt:message key='form.bcbirthsummo.cordVessels'/></td>
                                    ...
                                    <tr>
                                        <td colspan="2"><fmt:message key='form.bcbirthsummo.abnormalities'/></td>
                                        <td align="right"><fmt:message key='form.bcbirthsummo.cordGasesSent'/></td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="text" name="delPlaAbnormal"
                                                               ...
                                                               @oscar.formDB/></td>
                                        <td align="right"><fmt:message key='form.bcbirthsummo.placentaSentToPathology'/></td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="checkbox" name="delPerIntact"
                                                <%= props.getProperty("delPerIntact", "") %> @oscar.formDB
                                                               dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.intact'/><br>
                                            <input type="checkbox" name="delPerLaceration"
                                                    <%= props.getProperty("delPerLaceration", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.laceration'/><br>
                                            ...
                                            <input type="checkbox" name="delPerCerTear"
                                                   ...
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.cervicalTear'/><br>
                                            <input type="checkbox" name="delPerOthTrau"
                                                    <%= props.getProperty("delPerOthTrau", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.otherTrauma'/> <input type="text"
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="delPerEpisio"
                                                <%= props.getProperty("delPerEpisio", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.episiotomy'/>
                                        </td>
                                        <td><input type="checkbox" name="delPerMidline"
                                                <%= props.getProperty("delPerMidline", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.midline'/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><input type="checkbox" name="delPerMedio"
                                                <%= props.getProperty("delPerMedio", "") %> @oscar.formDB
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.mediolateral'/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><fmt:message key='form.bcbirthsummo.suturedBy'/> <input type="text"
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="delEstBld1"
                                            ...
                                            <fmt:message key='form.bcbirthsummo.bloodTransfusion'/><BR>
                                            <input type="checkbox" name="delEstBldN"
                                                   ...
                                                   dbType="tinyint(1)"/> <fmt:message key='global.no'/> <input type="checkbox"
                                                    ...
                                                    <%= props.getProperty("delEstBldY", "") %> @oscar.formDB
                                                                                   dbType="tinyint(1)"/> <fmt:message key='global.yes'/> &nbsp;&nbsp;
                                            <fmt:message key='form.bcbirthsummo.noOfUnits'/> <input
                                            ...
                                            <input type="checkbox" name="delEstBldOther"
                                                   ...
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.other'/> (<fmt:message key='form.bcbirthsummo.specify'/>): <input type="text"
            ...
            <tr>
                <td colspan="2">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="2"><B><fmt:message key='form.bcbirthsummo.indicationForOperativeDelivery'/></B></td>
                        </tr>
                        <tr>
                            <td width="50%"><fmt:message key='form.bcbirthsummo.principal'/> <input type="text"
                                                             name="delIndPrinc" style="width: 100%" size="60"
                                                             maxlength="80"
                                                             value="<%= props.getProperty("delIndPrinc", "") %>"
                                                             @oscar.formDB/>
                            </td>
                            <td><fmt:message key='form.bcbirthsummo.other'/> <input type="text" name="delIndOther"
            ...
            <tr>
                <td width="50%" valign="top">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="2"><B>
                                <div class="small10"><fmt:message key='form.bcbirthsummo.sectionBirthAndNewborn'/></div>
                            </B></td>
                        </tr>
                        <tr>
                            <td width="60%" valign="top">
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                       cellpadding="2">
                                    <tr>
                                        <th colspan="3"><fmt:message key='form.bcbirthsummo.timeSummary'/></th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="right"><fmt:message key='form.bcbirthsummo.firstStageStarted'/></td>
                                    ...
                                    <tr>
                                        <td align="right"><fmt:message key='form.bcbirthsummo.secondStageStarted'/></td>
                            ...
                            <td align="center">
                                ...
                                <table class="small8" width="70%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td width="33%"></td>
                                        <th><fmt:message key='form.bcbirthsummo.hoursShort'/></th>
                                    ...
                                    <tr>
                                        <td align="right" colspan="2" rowspan="2"><fmt:message key='form.bcbirthsummo.durationOfRupturedMembranes'/></td>
                                        <td><fmt:message key='form.bcbirthsummo.hoursShort'/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td width="20%" rowspan="2" nowrap><input type="checkbox"
                                            ...
                                            <input type="checkbox" name="birAmbiguous"
                                                   ...
                                                   dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.ambiguous'/>
                                        </td>
                                        <td width="33%" colspan="3"><fmt:message key='form.bcbirthsummo.apgar'/> <I>(<fmt:message key='form.bcbirthsummo.seeCriteriaOnNewbornRecord'/>)</I></td>
                                        <td width="10%" rowspan="2" nowrap><fmt:message key='form.bcbirthsummo.weightGrams'/><BR>
                                            <input type="text" name="birWeight" style="width: 100%" size="5"
                                                   ...
                                                   @oscar.formDB/></td>
                                        <td align="center" rowspan="2"><B><fmt:message key='form.bcbirthsummo.stillbirth'/></B>
                                            (dd/mm/yyyy)<br>
                                            <fmt:message key='form.bcbirthsummo.lastFhr'/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="birFHR_cal"> <input
                ...
                <td valign="top">
                    ...
                    <table class="small8" width="100%" border="0" cellspacing="0"
                           cellpadding="2">
                        <tr>
                            <td width="10%"><fmt:message key='form.bcbirthsummo.deliveredBy'/><br>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="birDelMD"
                                    <%= props.getProperty("birDelMD", "") %> @oscar.formDB
                                       dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.md'/>&nbsp;&nbsp; <input type="checkbox"
                                                                                    name="birDelRM"
                                    <%= props.getProperty("birDelRM", "") %> @oscar.formDB
                                                                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.rm'/>&nbsp;&nbsp;
                                <input type="checkbox"
                                       name="birDelRN"
                                        <%= props.getProperty("birDelRN", "") %> @oscar.formDB
                                       dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.rn'/>&nbsp;&nbsp; <input type="checkbox"
                                                                                    name="birDelOther"
                                        <%= props.getProperty("birDelOther", "") %> @oscar.formDB
                                                                                    dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.other'/> <I>(<fmt:message key='form.bcbirthsummo.specify'/>):</I>
                                <input type="text"
                ...
                <td><fmt:message key='form.bcbirthsummo.placeOfBirth'/> <input type="checkbox" name="comLabPlaHosp"
                    ...
                    &nbsp;&nbsp; <input type="checkbox"
                            ...
                            <%= props.getProperty("comLabPlaTran", "") %> @oscar.formDB
                                        dbType="tinyint(1)"/> <fmt:message key='form.bcbirthsummo.transferInLabour'/>
                </td>
            </tr>
            <tr>
                ...
                <td><input type="checkbox" name="conPedia"
                        ...
                        @oscar.formDB/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                             id="dischargeDateTime_cal"> | PP LOS <input type="text"
                                                                                         ...
                                                                                         @oscar.formDB/> <fmt:message key='form.bcbirthsummo.hoursShort'/>
                </td>
        ...
        <table class="small8" width="100%" border="1" cellspacing="0"
               cellpadding="0">
            <tr>
                <td><fmt:message key='form.bcbirthsummo.footer'/><br>
