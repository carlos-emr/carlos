...
// Declaring valid date character, minimum year and maximum year
    ...
    <body bgproperties="fixed" topmargin="0" leftmargin="1" rightmargin="1"
        ...
        <table class="Head" class="hidePrint">
            ...
            <a href="javascript: popupPage('form/formbcnewbornpg2.do?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">Part2 <font size=-2>(pg.1)</font></a> |
            <a href="javascript: popupPage('form/formbcnewbornpg3.do?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">Part2 <font size=-2>(pg.2)</font></a>
            &nbsp;--></td>
                <td align="right"><b>Edit:</b>Part1 | <a
                        href="form/formbcnewbornpg2.do?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">Part2
                    <font size=-2>(pg.1)</font></a> | <a
                        href="form/formbcnewbornpg3.do?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">Part2
