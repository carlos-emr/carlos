...
// Declaring valid date character, minimum year and maximum year
    ...
    <input type="hidden" name="commonField" value="ar2_"/>
        ...
        <table class="Head" class="hidePrint">
            ...
            <a href="javascript: popupPage('form/formbcnewbornpg2.do?demographic_no=<%=demoNo%>&formId=<%=formId%>&view=1');">Part2 <font size=-2>(pg.1)</font></a> |
            &nbsp;--></td>
                <td align="right"><b>Edit:</b> <a
                        href="form/formbcnewbornpg1.do?demographic_no=<%=demoNo%>&formId=<%=formId%>">Part1</a>
                    | <a
                            href="form/formbcnewbornpg2.do?demographic_no=<%=demoNo%>&formId=<%=formId%>">Part2
