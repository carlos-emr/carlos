...
<html>
    ...
    <script type="text/javascript" language="Javascript">
        ...
        function reset() {
            ...
            document.forms[0].action = "/<e:forJavaScript value='<%= project_home %>' />/form/formname";
        }
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p2_soundsOk"
                                    ...
                                    <e:forHtmlAttribute value='<%= props.getProperty("p2_soundsOk", "") %>' />></td>
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p2_headUpOk"
                                    ...
                                    <e:forHtmlAttribute value='<%= props.getProperty("p2_headUpOk", "") %>' />></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p2_graspOk"
                                    ...
                                    <e:forHtmlAttribute value='<%= props.getProperty("p2_graspOk", "") %>' />></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p2_looksOk"
                                    ...
                                    <e:forHtmlAttribute value='<%= props.getProperty("p2_looksOk", "") %>' />></td>
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p2_babblesOk"
                                    ...
                                    <e:forHtmlAttribute value='<%= props.getProperty("p2_babblesOk", "") %>' />></td>
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p2_handToMouthOk"
                                    ...
                                    <e:forHtmlAttribute value='<%= props.getProperty("p2_handToMouthOk", "") %>' />></td>
