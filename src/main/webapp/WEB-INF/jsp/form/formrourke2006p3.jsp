...
<html>
    <head>
        ...
        <title><fmt:message key="form.rourke.title2006Page3"/></title>
    ...
    <form action="${pageContext.request.contextPath}/form/formname" method="post">
        ...
        <table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
            <tr>
                ...
                <td nowrap="true"><a
                        ...
                        href="form/formrourke2006p2?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><fmt:message key='encounter.formRourke2006.Pg2'/></a>&nbsp;|&nbsp; <a><fmt:message key='encounter.formRourke2006.Pg3'/></a>&nbsp;|&nbsp; <a
                        href="form/formrourke2006p4?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><fmt:message key='encounter.formRourke2006.Pg4'/></a></td>
            </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="1">
            ...
            <tr align="center">
                ...
                <td><fmt:message key='encounter.formRourke2006_3.formHdCirc12m'/></td>
                <td><fmt:message key='encounter.formRourke1.formHt'/></td>
                <td><fmt:message key='encounter.formRourke1.formWt'/></td>
                <td><fmt:message key='encounter.formRourke2006_3.formHdCirc'/></td>
            </tr>
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><i><fmt:message key='encounter.formRourke2006_3.msgFormulaFeeding'/></i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="javascript:showNotes()"
                                      onMouseOver="popLayer('<fmt:message key='encounter.formRourke2006.footnote1'/>')"
                                      onMouseOut="hideLayer()"><fmt:message key='encounter.formRourke1.btnBreastFeeding'/>*</a></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_homoMilk12m"
                        ...
                        <tr>
                            ...
                            <td><fmt:message key='encounter.formRourke2006_3.formEncourageCup'/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_appetite12m"
                    ...
                    <table style="font-size: 8pt;" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td colspan="4" valign="top"><b><a
                                    ...
                                    onMouseOver="popLayer('<fmt:message key='encounter.formRourke2006.footnote1'/>')"
                                    onMouseOut="hideLayer()"><fmt:message key='encounter.formRourke2006_3.formCarSeat'/></a>*</b></td>
                        ...
                        <tr>
                            <td colspan="3" valign="top"><fmt:message key='encounter.formRourke2006_3.formChildProof'/>
                        ...
                        <tr>
                            ...
                            <td colspan="4" valign="top"><fmt:message key='encounter.formRourke2006_3.formFootwear'/></td>
                        </tr>
                        <tr>
                            <td colspan="3" valign="top"><fmt:message key='encounter.formRourke2006_3.formEnvHealth'/></td>
                ...
                <td colspan="3" valign="top" align="center">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formhiddenToy'/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formSounds'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formMakeSounds'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formStands'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formThumb&Index'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formPickedUp'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                ...
                <td colspan="3" valign="top" align="center">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formSimpleReq'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formChatters'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formCrawls'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><fmt:message key='encounter.formRourke2006_3.formShowEmotions'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><fmt:message key='encounter.formRourke2006_3.formSays2words'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td><fmt:message key='encounter.formRourke2006_3.formReaches'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td><fmt:message key='encounter.formRourke2006_3.formTieShoes'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td><fmt:message key='encounter.formRourke2006_3.formStacks2Blocks'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td><fmt:message key='encounter.formRourke2006_3.formHowToReact'/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
