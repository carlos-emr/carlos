...
<head>
    ...
    <script type="text/javascript">
        ...
        function onPrintAll() {
            ...
            document.forms["frmP1"].action = "<%= request.getContextPath() %>/form/formname?__title=Rourke+Baby+Report&__cfgfile=rourke2017printCfgPg1&__cfgfile=rourke2017printCfgPg2&__cfgfile=rourke2017printCfgPg3&__cfgfile=rourke2017printCfgPg4&__template=rourke2017";
