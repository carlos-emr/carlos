...
<div id="patientInfop1" style="overflow:auto;">
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr valign="top">
            <td align="center">
                <fmt:message key="encounter.formRourke2009.formBirhtRemarks"/><br>
                ...
                <fmt:message key="encounter.formRourke2009.formPremature"/>&nbsp;
                ...
                <fmt:message key="encounter.formRourke2009.formHighRisk"/>&nbsp;<br>
                ...
                <fmt:message key="encounter.formRourke2009.formNoConcerns"/>&nbsp;
            </td>
            <td width="65%" nowrap align="center">
                <p>
                    ...
                    Age: <input type="text" id="currentAge" size="10" maxlength="10" readonly="true"
                                ondblclick="calcAge();">
                    <% if (!((FrmRourke2017Record) rec).isFemale(loggedInInfo, demoNo)) { %>
                    (<fmt:message key="encounter.formRourke1.msgMale"/>) <input type="hidden" name="c_male"
                                                                                      value="x">
                    <% } else { %>
                    (<fmt:message key="encounter.formRourke1.msgFemale"/>) <input type="hidden" name="c_female"
                                                                                        value="x">
                    <% } %>
                ...
                <p>
                    ...
                    &nbsp;&nbsp; <a href="javascript:void(0)"
                                    onclick="displayDemographicMeasurements('c_birthWeight', 'WT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>', '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')"><fmt:message key="encounter.formRourke1.msgBirthWt"/>:</a>
                    ...
                    &nbsp;&nbsp; <a href="javascript:void(0)"
                                    onclick="displayDemographicMeasurements('c_dischargeWeight', 'WT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>', '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')"><fmt:message key="encounter.formRourke1.msgDischargeWt"/>:</a>
        ...
        <tr>
            ...
            <td style="padding:10px;" align="center">
                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tr>
                        <td align="center">
                            <fmt:message key="encounter.formRourke2009.formRiksFactors"/>

                            <br>
                            <input type="checkbox" class="chk"
                                   name="p1_2ndhandsmoke" <%=props.getProperty("p1_2ndhandsmoke", "")%>>
                            <fmt:message key="encounter.formRourke2009.form2ndHandSmoke"/>
                            <p>
                                <fmt:message key="encounter.formRourke2009.formSubstanceabuse"/><br>
                                <input type="checkbox" class="chk"
                                       name="p1_alcohol" <%=props.getProperty("p1_alcohol", "")%>>
                                <fmt:message key="encounter.formRourke2009.formAlcohol"/><br>
                                <input type="checkbox" class="chk"
                                       name="p1_drugs" <%=props.getProperty("p1_drugs", "")%>>
                                <fmt:message key="encounter.formRourke2009.formDrugs"/>
                            </p>
                        </td>
                        <td nowrap align="center">
                            <fmt:message key="encounter.formRourke2009.formAPGAR"/><br>
                            <fmt:message key="encounter.formRourke2009.form1min"/>
                            <select name="c_APGAR1min">
                                <option <%= props.getProperty("c_APGAR1min", "").equals("") || props.getProperty("c_APGAR1min", "").equals("-1") ? "selected='selected'" : ""%>
                                        value="-1">
                                    <fmt:message key="encounter.formRourke2009.formNotSet"/>
                                </option>
                            ...
                            <fmt:message key="encounter.formRourke2009.form5min"/>
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    ...
    <tr align="center" id="growthAp1">
        <td class="column" rowspan="2">
            <a>
                <fmt:message key="encounter.formRourke1.btnGrowth"/>*<br/>
                ...
                <tr>
                    ...
                    <td><b>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formVitaminD200"/>*
                        </a>
                    </b></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_1.msgFormulaFeeding"/>*
                        </a>
                    </td>
                </tr>
                <tr>
            ...
            <table id="ntp12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_breastFeeding2w" formProperties="<%=props%>"
                                                  showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
                    <td><b>
                        <a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
            ...
            <table id="ntp13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2009_1.msgFormulaFeeding"/>
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_supplementationSolids1m" formProperties="<%=props%>"
                                                  showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke1.formSupplementationSolids"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="encounter.formRourke1.formMotorizedvehicles"/>/<fmt:message key="encounter.formRourke1.formCarSeat"/>
                        </a>*</b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_1.formPacifierUse"/>*
                        </a>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formCrying"/>**</a>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formNightWaking"/>**</a></b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top" colspan="5">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formHighRiskOrHomeVisit"/>**
                        </a></b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2009_1.formCough"/>*
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_1.formAltMed"/>*
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <rourke:discussionRadioSelect sectionName="p1_tmpControl" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_1.formTempCtrl"/></td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formTummyTime"/>*
                        </a></b>
                    </td>
                </tr>
                <tr>
            ...
            <table id="dt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_sucks1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke1.formSucksWell"/></td>
                </tr>
                <tr align="center">
            ...
            <table id="dt12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_noParentsConcerns2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2017.formNoparentConcerns"/></td>
                </tr>
                <tr align="center">
            ...
            <table id="dt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_calms1m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2009_1.formCalmes"/></td>
                </tr>
                <tr>
            ...
            <table id="pt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke1.formFontanelles"/>**</a>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_skin1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formDrySkin"/></a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formRedReflex"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <i><fmt:message key="encounter.formRourke2006_1.formEarDrums"/>**</i>
                        </a>
                    </td>
                </tr>
                <tr>
            ...
            <table id="pt12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_fontanelles2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke1.formFontanelles"/>**</a></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_skin2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formDrySkin"/></a></td>
                </tr>
                <tr>
            ...
            <table id="pt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_1.formCornealReflex"/>**</a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <i><fmt:message key="encounter.formRourke2017.formHearingInquiry"/>**</i>
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_heartAbdomen1m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2017.formHeartAbdomen"/></td>
                </tr>
                <tr>
    ...
    <tr id="immunizationp1">
            ...
            <table id="immt11" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="text-align: center" colspan="4">
                        <b><fmt:message key="encounter.formRourke2006_1.msgImmunizationColTitle"/></b>
                    </td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_newbornScreening1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><b><fmt:message key="encounter.formRourke2017.formImmunizationNewbornScreening"/></b></td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formImmunizationHemoglobinopathyScreen"/></a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formImmunizationNewbornHearingScreening"/></a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-left: 4px;"><fmt:message key="encounter.formRourke2017.formImmunizationIfHepatitis"/>:
                    </td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formImmunizationHepatitisVaccine1"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
        ...
        <td colspan="3">
            <table id="immt12" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="text-align: center"><b><fmt:message key="encounter.formRourke2006_1.msgImmunizationColTitle"/></b></td>
                </tr>
                <tr>
                    <td style="vertical-align:bottom;">
            ...
            <table id="immt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formImmunizationHepatitisVaccine2"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
...
<table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
    <tr>
        <td nowrap="true"><input type="submit" value="<fmt:message key="encounter.formRourke1.btnSave"/>"
                                 onclick="javascript:return onSave();"/>
            <input type="submit" value="<fmt:message key="encounter.formRourke1.btnSaveExit"/>"
                   onclick="javascript:return onSaveExit();"/>
            <input type="submit" value="<fmt:message key="encounter.formRourke1.btnExit"/>"
