    ...
    <tr>
        ...
        <td align="center" nowrap="true" width="100%">
            <% if (formId > 0) { %> <a name="length" href="#"
                                       onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2017&__title=Baby+Growth+Graph1&__cfgfile=<%=growthCharts[0]%>&demographic_no=<e:forUriComponent value='<%= String.valueOf(demoNo) %>' />&formId=<e:forUriComponent value='<%= String.valueOf(formId) %>' />&provNo=<e:forUriComponent value='<%= String.valueOf(provNo) %>' />','<%= "growth1" + demoNo %>');return false;">
            <fmt:message key="encounter.formRourke1.btnGraphLenghtWeight"/></a><br>
            <a name="headCirc" href="#"
               onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2017&__title=Baby+Head+Circumference&__cfgfile=<%=growthCharts[1]%>&demographic_no=<e:forUriComponent value='<%= String.valueOf(demoNo) %>' />&formId=<e:forUriComponent value='<%= String.valueOf(formId) %>' />&provNo=<e:forUriComponent value='<%= String.valueOf(provNo) %>' />','<%= "growth2" + demoNo %>');return false;">
...
<div id="patientInfop2">
    ...
    <input type="text" id="c_birthDate2" size="10" maxlength="10" value="<e:forHtmlAttribute value='<%= props.getProperty("c_birthDate", "") %>' />"
           readonly="true">
    &nbsp;&nbsp;
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    ...
    <tr align="center" id="growthAp2">
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p2_ht2m', 'HT', '<e:forJavaScriptAttribute value='<%= String.valueOf(demographic.getDemographicNo()) %>' />',
        ...
        <td><a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p2_wt2m', 'WT', '<e:forJavaScriptAttribute value='<%= String.valueOf(demographic.getDemographicNo()) %>' />',
                       '<e:forJavaScriptAttribute value='<%= demographic.getFormattedDob() %>' />', '<e:forJavaScriptAttribute value='<%= appointmentNo %>' />')">
        ...
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p2_ht4m', 'HT', '<e:forJavaScriptAttribute value='<%= String.valueOf(demographic.getDemographicNo()) %>' />',
                       '<e:forJavaScriptAttribute value='<%= demographic.getFormattedDob() %>' />', '<e:forJavaScriptAttribute value='<%= appointmentNo %>' />')">
                <fmt:message key="encounter.formRourke1.formHt"/>
            </a>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p2_wt4m', 'WT', '<e:forJavaScriptAttribute value='<%= String.valueOf(demographic.getDemographicNo()) %>' />',
                       '<e:forJavaScriptAttribute value='<%= demographic.getFormattedDob() %>' />', '<e:forJavaScriptAttribute value='<%= appointmentNo %>' />')">
                <fmt:message key="encounter.formRourke1.formWt"/>
            </a>
        </td>
        ...
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p2_ht6m', 'HT', '<e:forJavaScriptAttribute value='<%= String.valueOf(demographic.getDemographicNo()) %>' />',
                       '<e:forJavaScriptAttribute value='<%= demographic.getFormattedDob() %>' />', '<e:forJavaScriptAttribute value='<%= appointmentNo %>' />')">
                <fmt:message key="encounter.formRourke1.formHt"/>
            </a>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p2_wt6m', 'WT', '<e:forJavaScriptAttribute value='<%= String.valueOf(demographic.getDemographicNo()) %>' />',
                       '<e:forJavaScriptAttribute value='<%= demographic.getFormattedDob() %>' />', '<e:forJavaScriptAttribute value='<%= appointmentNo %>' />')">
    ...
    <tr align="center">
        <td colspan="4"><textarea id="p2_pConcern2m"
                                  ...
                                  maxlength="400"><e:forHtmlContent value='<%= props.getProperty("p2_pConcern2m", "") %>' /></textarea>
        </td>
        <td colspan="4"><textarea id="p2_pConcern4m"
                                  name="p2_pConcern4m" class="wide limit-rows" cols="10" rows="5"
                                  maxlength="400"><e:forHtmlContent value='<%= props.getProperty("p2_pConcern4m", "") %>' /></textarea>
        </td>
        <td colspan="4"><textarea id="p2_pConcern6m"
                                  name="p2_pConcern6m" class="wide limit-rows" cols="10" rows="5"
                                  maxlength="400"><e:forHtmlContent value='<%= props.getProperty("p2_pConcern6m", "") %>' /></textarea>
        </td>
    </tr>
                ...
                <tr>
                    ...
                    <td><b>
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()" onclick="popPage('<e:forJavaScriptAttribute value='<%= StringUtils.noNull(resource) %>' />n_breastFeeding');return false">
            ...
            <table id="ntp23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr align="center" style="vertical-align:bottom;">
                    <td colspan="5"><textarea id="p2_nutrition6m" name="p2_nutrition6m" class="wide" rows="5"
                                              cols="25"><e:forHtmlContent value='<%= props.getProperty("p2_nutrition6m", "") %>' /></textarea></td>
                </tr>
            </table>
        </td>
    </tr>
                            ...
                            <tr>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p2_education2m" name="p2_education2m" style="width: 100%"
                                              rows="5"><e:forHtmlContent value='<%= props.getProperty("p2_education2m", "") %>' /></textarea>
                                </td>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p2_education4m" name="p2_education4m" style="width: 100%"
                                              rows="5"><e:forHtmlContent value='<%= props.getProperty("p2_education4m", "") %>' /></textarea>
                                </td>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p2_education6m" name="p2_education6m" style="width: 100%"
                                              rows="5"><e:forHtmlContent value='<%= props.getProperty("p2_education6m", "") %>' /></textarea>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr id="problemsPlansp2">
        <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems2m" name="p2_problems2m" rows="5"
                                                                 ...
                                                                 maxlength="400"><e:forHtmlContent value='<%= props.getProperty("p2_problems2m", "") %>' /></textarea>
        </td>
        <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems4m" name="p2_problems4m" rows="5"
                                                                 cols="25" class="wide limit-rows"
                                                                 maxlength="400"><e:forHtmlContent value='<%= props.getProperty("p2_problems4m", "") %>' /></textarea>
        </td>
        <td colspan="4">
            <table id="prbt23" cellpadding="0" cellspacing="0" width="100%">
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems6m" name="p2_problems6m"
                                                                             ...
                                                                             maxlength="400"><e:forHtmlContent value='<%= props.getProperty("p2_problems6m", "") %>' /></textarea>
                    </td>
                </tr>
            </table>
        </td>
