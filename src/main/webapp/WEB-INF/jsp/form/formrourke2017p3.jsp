...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr class="titleBar">
        <th><fmt:message key="encounter.formRourke2006_3.msgRourkeBabyRecord"/></th>
    </tr>
</table>
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    <tr align="center">
        ...
        <td colspan="3" class="row"><a><fmt:message key="encounter.formRourke2006_3.msg9mos"/></a></td>
        <td colspan="3" class="row"><a><fmt:message key="encounter.formRourke2006_3.msg12mos"/></a></td>
        <td colspan="3" class="row"><a><fmt:message key="encounter.formRourke2006_3.msg15mos"/></a></td>
    </tr>
    <tr align="center">
    ...
    <tr id="growthAp3" align="center">
        <td class="column" rowspan="2">
            <a><fmt:message key="encounter.formRourke1.btnGrowth"/>*</a><br>
            <fmt:message key="encounter.formRourke2009_1.btnGrowthmsg"/>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p3_ht9m', 'HT', '<carlos:encode value='<%= String.valueOf(demographic.getDemographicNo()) %>' context="javaScriptAttribute"/>',
        ...
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p3_wt9m', 'WT', '<carlos:encode value='<%= String.valueOf(demographic.getDemographicNo()) %>' context="javaScriptAttribute"/>',
                       '<carlos:encode value='<%= demographic.getFormattedDob() %>' context="javaScriptAttribute"/>', '<carlos:encode value='<%= appointmentNo %>' context="javaScriptAttribute"/>')">
        ...
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p3_ht12m', 'HT', '<carlos:encode value='<%= String.valueOf(demographic.getDemographicNo()) %>' context="javaScriptAttribute"/>',
                       '<carlos:encode value='<%= demographic.getFormattedDob() %>' context="javaScriptAttribute"/>', '<carlos:encode value='<%= appointmentNo %>' context="javaScriptAttribute"/>')">
                <fmt:message key="encounter.formRourke1.formHt"/>
            </a>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p3_wt12m', 'WT', '<carlos:encode value='<%= String.valueOf(demographic.getDemographicNo()) %>' context="javaScriptAttribute"/>',
                       '<carlos:encode value='<%= demographic.getFormattedDob() %>' context="javaScriptAttribute"/>', '<carlos:encode value='<%= appointmentNo %>' context="javaScriptAttribute"/>')">
        ...
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p3_ht15m', 'HT', '<carlos:encode value='<%= String.valueOf(demographic.getDemographicNo()) %>' context="javaScriptAttribute"/>',
                       '<carlos:encode value='<%= demographic.getFormattedDob() %>' context="javaScriptAttribute"/>', '<carlos:encode value='<%= appointmentNo %>' context="javaScriptAttribute"/>')">
                <fmt:message key="encounter.formRourke1.formHt"/>
            </a>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p3_wt15m', 'WT', '<carlos:encode value='<%= String.valueOf(demographic.getDemographicNo()) %>' context="javaScriptAttribute"/>',
                       '<carlos:encode value='<%= demographic.getFormattedDob() %>' context="javaScriptAttribute"/>', '<carlos:encode value='<%= appointmentNo %>' context="javaScriptAttribute"/>')">
                <fmt:message key="encounter.formRourke1.formWt"/>
            </a>
        </td>
            ...
            <table id="ntp31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2009_3.msgFormulaFeeding"/></a></i></td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formIronFruitsAndVegetables"/>
                    </a></b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_introCowMilk9m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2017.formCowsMilkProducts"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_cup9m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2017.formEncourageChangeToCup"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_eatsVarietyOfTextures9m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2017.formEatsVarietyOfTexture"/></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formNoHoney"/>*
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formSweetenedLiquids"/>*</a></b>
                    </td>
                </tr>
                <tr>
            ...
            <table id="ntp32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_cup12m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2017.formPromoteOpenCup"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_eatsVarietyOfTextures12m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2017.formEatsFamilyFoodTextures"/>*</td>
                </tr>
                <tr>
    ...
    <tr id="educationp3">
        ...
        <td colspan="9" valign="top">
            <table id="edt3" style="font-size: 9pt; height: 466px;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top" colspan="20"><fmt:message key="encounter.formRourke2006_1.formInjuryPrev"/></td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                     src="graphics/Checkmark_L.gif"></td>
                ...
                <tr>
                    ...
                    <rourke:discussionRadioSelect sectionName="p3_electric" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top">
                        <i><fmt:message key="encounter.formRourke2017.formElectricPlugs"/></i>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formBehaviourCrying"/>**</a>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formHealthySleep"/>**
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formNightWaking"/>**
                        </a></b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formParenting"/>**
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formChildCare"/>
                        </a></i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formParentFatigueDepression"/>**
                        </a></b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formFootwear"/>*
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="5" valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formDental"/>*
                        </a>
                    </td>
                </tr>
                <tr>
            ...
            <table id="dt31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_hiddenToy" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formhiddenToy"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_sounds" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formSounds"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_responds2people" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formResponds2people"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_makeSounds" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formMakeSounds"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_sits" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_3.formSits"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_stands" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formStands"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_thumb" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2017.formThumbAndFingersGrasp"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_playGames" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formplayGames"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_attention9m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formAttention"/></td>
                </tr>
                <tr>
            ...
            <table id="dt32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_responds2name" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_3.formResponds"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_simpleRequests" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formSimpleReq"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_consonant" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formConsonant"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_says3words" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formsays3words"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_shuffles" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2017.formCrawls"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_pull2stand" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_3.formPulltoStand"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_hasPincerGrasp" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2017.formHasPincerGrasp"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_showDistress" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formShowDistress"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_followGaze" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_3.formfollowGaze"/></td>
                </tr>
                <tr>
            ...
            <table id="dt33" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_says5words" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2009_3.formSays5words"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_walksSideways" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2009_3.formwalksSideways"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_showsFearStrangers" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2009_3.formshowsFearStrangers"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_crawlsStairs" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2006_3.formCrawlsStairs"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_squats" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2006_3.formSquats"/></td>
                </tr>
                <tr>
            ...
            <table id="pt31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formAnteriorFontanelle"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_hips9m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formHipsLimitedHipAdbn"/>**
                    </a></td>
                </tr>
                <tr>
            ...
            <table id="immt31" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="3"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formBloodLead"/>*
                    </a></i></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_HbvAntibodies" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td colspan="7"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.form9Or12MonthsHbvAntibodies"/>***
                    </a></b></td>
                </tr>
                <tr>
