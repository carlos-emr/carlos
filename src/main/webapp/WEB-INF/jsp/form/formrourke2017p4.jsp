...
<table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
    <tr>
        <td nowrap="true">
            <input type="button" value="<fmt:message key="encounter.formRourke1.btnSave"/>"
                   onclick="javascript:onSave(); return false;"/>
            <input type="button" value="<fmt:message key="encounter.formRourke1.btnSaveExit"/>"
                   onclick="javascript:onSaveExit(); return false;"/>
            <input type="button" value="<fmt:message key="encounter.formRourke1.btnExit"/>"
        ...
        <td align="center" nowrap="true" width="100%">
            <% if (formId > 0) { %>
            <a name="length" href="#"
               onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2017&__title=Baby+Growth+Graph1&__cfgfile=<%=growthCharts[0]%>&demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>','<%= "growth1" + demoNo %>');return false;">
                <fmt:message key="encounter.formRourke1.btnGraphLenghtWeight"/>
            </a><br>
            <a name="headCirc" href="#"
               onclick="onGraph('<%=request.getContextPath()%>/form/formname?submit=graph&form_class=Rourke2017&__title=Baby+Head+Circumference&__cfgfile=<%=growthCharts[1]%>&demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>','<%= "growth2" + demoNo %>');return false;">
                <fmt:message key="encounter.formRourke1.btnGraphHead"/>
            </a> <% } else { %>
            &nbsp; <% } %>
        </td>
    </tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr class="titleBar">
        <th><fmt:message key="encounter.formRourke2006_4.msgRourkeBabyRecord"/></th>
    </tr>
</table>
<div id="patientInfop4">
    ...
    <% if (!((FrmRourke2017Record) rec).isFemale(loggedInInfo, demoNo)) { %>(<fmt:message key="encounter.formRourke1.msgMale"/>)
    <% } else { %>(<fmt:message key="encounter.formRourke1.msgFemale"/>)
    <% } %>
</div>
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    <tr align="center">
        <td colspan="3" class="row"><a><fmt:message key="encounter.formRourke2006_4.msg18mos"/></a></td>
        <td colspan="4" class="row"><a><fmt:message key="encounter.formRourke2006_4.msg2yrs"/></a></td>
        <td colspan="3" class="row"><a><fmt:message key="encounter.formRourke2006_4.msg4yrs"/></a></td>
    ...
    <tr align="center" id="growthAp4">
        ...
        <td>
            <fmt:message key="encounter.formRourke2006_3.formHdCirc"/>
        </td>
        <td>
            <a href="javascript:void(0)"
        ...
        <td>
            <fmt:message key="encounter.formRourke1.formBmi"/>
        </td>
        <td>
            <a href="javascript:void(0)"
        ...
        <td class="column" rowspan="2">
            <a><fmt:message key="encounter.formRourke1.btnGrowth"/>*<br><fmt:message key="encounter.formRourke2009_1.btnGrowthmsg"/></a>
        </td>
    </tr>
    ...
    <tr align="center">
        ...
        <td class="column"><a><fmt:message key="encounter.formRourke2017.msgParentConcerns"/></a></td>
    </tr>
            ...
            <table id="ntp41" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              ...
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formBreastfeedingVitaminD"/>
                    </a></b></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formHomogenizedMilk"/>
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formSweetenedLiquids"/>*
                    </a></b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_noBottle18m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="encounter.formRourke2017.formNoBottle"/></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formInquireVegetarianDiets"/>*
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formIndependentSelfFeeding"/>*
                    </a></td>
                </tr>
                <tr>
            ...
            <table id="ntp42" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formLowerFatDiet"/>*
                    </a></i></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formMilk"/>
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formCanadasFoodGuide"/>*</a>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" style="vertical-align:bottom;">
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formCanadasFoodGuide"/>*
                        </a>
                    </td>
                </tr>
                <tr>
    ...
    <tr id="educationp4">
        <td colspan="3">
            <table id="edt41" style="font-size: 8pt;" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td valign="top" colspan="4"><fmt:message key="encounter.formRourke2006_1.formInjuryPrev"/></td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                     src="graphics/Checkmark_L.gif"></td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="encounter.formRourke2017.formCarBoosterSeat"/>*
                        </a></b>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_bathSafety18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top">
                        <i><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="encounter.formRourke2006_1.formBathSafety"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formFallsAndFurniture"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formWeanFromPacifier"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    <td valign="top" colspan="4"><fmt:message key="encounter.formRourke2017.formBehaviourAndFamily"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_parentChild18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formParentChild"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              ...
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2009_4.formDiscipline"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formHealthySleep"/>**</a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_4.formHighRisk"/>**</a></b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formParentFatigueStressDepression"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_socializing18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formSocPeerPlay"/></td>
                </tr>
                <tr>
                    ...
                    <td colspan="5" valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formHealthyActiveLiving"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="5" valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formMakingEndsMeetInquiry"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" valign="top"><fmt:message key="encounter.formRourke2017.formEnvironmentalHealth"/> &amp; <fmt:message key="encounter.formRourke2006_1.formOtherIssues"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke1.formSecondHandSmoke"/>*
                        </a></b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2009_4.formDentalCleaning"/>*</a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_4.formToiletLearning"/>**
                        </a>
                    </td>
                </tr>
                <tr>
        ...
        <td colspan="7">
            <table id="edt42" style="font-size: 8pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top" colspan="12"><fmt:message key="encounter.formRourke2006_1.formInjuryPrev"/></td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                     src="graphics/Checkmark_L.gif"></td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="encounter.formRourke2017.forBikeHelmets"/>*
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formFirearmSafety"/>*
                        </a></b>
                    </td>
                    <rourke:discussionRadioSelect sectionName="p4_injuryMatches24m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2017.forMatches"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formWaterSafety"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formFallsFurnitureAndTrampolines"/>*
                        </a></i>
                    </td>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formNoPacifiers"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    <td valign="top" colspan="12"><fmt:message key="encounter.formRourke2017.formBehaviourAndFamily"/></td>
                </tr>
                <tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.forChildCareAndSchoolReadiness"/>**</a></i>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_socializing24m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formSocializing"/></td>
                ...
                <tr>
                    <td colspan="12" valign="top">
                        <fmt:message key="encounter.formRourke2017.formEnvironmentalHealth"/> &amp; <fmt:message key="encounter.formRourke2006_1.formOtherIssues"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formNoOtcColdMed"/>*
                        </a></b>
                    </td>
                    ...
                    <td colspan="5" valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formDentalCleaningFluoride"/>*</a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2017.formAltMed"/>*
                        </a></i>
                    </td>
    ...
    <tr id="developmentp4">
        <td colspan="3" align="center">
            <table id="dt41" cellpadding="0" cellspacing="0" width="300px" height="100%">
                <tr>
                    <td colspan="4">
                        <fmt:message key="encounter.formRourke2009_4.msgNippissing"/>
                ...
                <tr>
                    <td colspan="4"><fmt:message key="encounter.formRourke2006_4.formSocialEmotion"/>**</td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                     src="graphics/Checkmark_L.gif"></td>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_manageable18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formManageable"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_otherChildren18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formOtherChildren"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_soothability18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formSoothability"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_comfort18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formComfort"/></td>
                </tr>
                <tr>
                    <td colspan="4"><fmt:message key="encounter.formRourke2006_4.formCommSkills"/>**</td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_points2body18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formPoints"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_getAttn18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formGetAttn"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_recsName18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formRecsName"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_points2want18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formPoints2want"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_looks4toy18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formLooks4toy"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_initSpeech18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formInitSpeech"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_says20words18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2017.formSays15Words"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_4consonants18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.form4consonants"/></td>
                </tr>
                <tr>
                    <td colspan="4"><fmt:message key="encounter.formRourke2006_4.formMotorSkills"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_walksbackAlone18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2009_4.formWalksAlone"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_feedsSelf18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formFeedsSelf"/></td>
                </tr>
                <tr>
                    <td colspan="4"><fmt:message key="encounter.formRourke2006_4.formAdaptiv"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_removesHat18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formRemovesHat"/></td>
                </tr>
                <tr>
            ...
            <table cellpadding="0" cellspacing="2" border="1" width="100%" height="100%">
                <tr>
                    <td>
                        <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                            <tr>
                                <td colspan="4"><fmt:message key="encounter.formRourke2006_4.form2yrs"/>**</td>
                            </tr>
                            <tr>
                                <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                                 src="graphics/Checkmark_L.gif"></td>
                            ...
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_2wSentence24m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.form2wordSentence"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_one2stepdirections24m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formone2stepDirections"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_walksbackward24m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formwalksbackward"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_runse24m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formTriestoRun"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_smallContainer24m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formSmallContainer"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_pretendsPlay24m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formpretendsPlay"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_newSkills24m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formNewSkills"/></td>
                            </tr>
                            <tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" height="100%">
                            <tr>
                                <td colspan="4"><fmt:message key="encounter.formRourke2006_4.form4yrs"/></td>
                            </tr>
                            <tr>
                                <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                                 src="graphics/Checkmark_L.gif"></td>
                            ...
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_3directions48m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.form3Directions"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_asksQuestions48m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formAsksQuestions"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_upDownStairs48m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formupDownStairs"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_undoesZippers48m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formundoesZippers"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_tries2comfort48m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formTries2comfort"/></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td>
                        <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                            <tr>
                                <td colspan="4"><fmt:message key="encounter.formRourke2006_4.form3yrs"/></td>
                            </tr>
                            <tr>
                                <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                                 src="graphics/Checkmark_L.gif"></td>
                            ...
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_2directions36m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.form2Directions"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_5ormoreWords36m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.form5ormoreWords"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_walksUpStairs36m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formwalksUpStairs"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_twistsLids36m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formTwistsLids"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_sharesSometime36m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formSharesSometimes"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_playMakeBelieve36m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formplayMakeBelieve"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_turnsPages36m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formTurnsPages"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_listenMusic36m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2017.formListensMusic"/></td>
                            </tr>
                            <tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                            <tr>
                                <td colspan="4"><fmt:message key="encounter.formRourke2006_4.form5yrs"/></td>
                            </tr>
                            <tr>
                                <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                                 src="graphics/Checkmark_L.gif"></td>
                            ...
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_countsOutloud60m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formCountsOutloud"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_speaksClearly60m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formSpeaksClearly"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_throwsCatches60m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2006_4.formThrowsCatches"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_hops1foot60m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formHops1Foot"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_dressesUndresses60m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formdressesUndresses"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_obeysAdult60m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formobeysAdult"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_retellsStory60m"
                                                              formProperties="<%=props%>" showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formretellsStory"/></td>
                            </tr>
                            <tr>
                                <rourke:discussionRadioSelect sectionName="p4_separates60m" formProperties="<%=props%>"
                                                              showNoOption="<%=false%>"
                                                              showNotDiscussedOption="<%=true%>"/>
                                <td valign="top"><fmt:message key="encounter.formRourke2009_4.formSeparates"/></td>
                            </tr>
                            <tr>
            ...
            <table id="pt41" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formAnteriorFontanelleClosed"/>**
                    </a></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke1.formRedReflex"/>**
                    </a></b></td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="encounter.formRourke2006_1.formCornealReflex"/>/<fmt:message key="encounter.formRourke2017.formCoverUncoverTest"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_hearing18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="encounter.formRourke2006_4.formHearingInquiry"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_tonsilSize18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formTonsilSize"/>**
                    </a></b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_teeth18m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formTeeth"/>**
                    </a></td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
            ...
            <table id="pt42" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formBloodPressureIfAtRisk"/>**
                    </a></i></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_eyes24m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.EyesVisualAcuity"/>**
                    </a></b></td>
                </tr>
                <tr>
    ...
    <tr id="immunizationp4">
        <td colspan="10" valign="top">
            <table id="immt41" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="9" style="text-align: center"><b><fmt:message key="encounter.formRourke2006_1.msgImmunizationColTitle"/></b></td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                                                                     src="graphics/Checkmark_L.gif"></td>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p4_hemoglobin" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td colspan="2"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formImmunizationHemoglobin"/>**</a></i>
                    </td>
                    <rourke:discussionRadioSelect sectionName="p4_BloodLead" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td colspan="3"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="encounter.formRourke2017.formBloodLead"/>*</a></i>
                    </td>
                </tr>
                <tr>
