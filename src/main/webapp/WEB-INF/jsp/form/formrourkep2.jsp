    ...
    <form action="${pageContext.request.contextPath}/form/formname" method="post">
        ...
        <table cellspacing="0" cellpadding="0" class="Header" class="hidePrint">
            <tr>
                ...
                <td nowrap="true"><a
                        href="form/formrourkep1?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:message key="encounter.formRourke2.btnpage1"/></a>&nbsp;|&nbsp; <a><fmt:message key="encounter.formRourke2.msgPage2"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourkep3?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:message key="encounter.formRourke2.btnPage3"/></a></td>
            </tr>
        </table>
