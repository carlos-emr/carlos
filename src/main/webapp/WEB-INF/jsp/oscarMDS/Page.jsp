...
<script type="text/javascript">
    function submitLabel(lblval) {
        var labForm = document.forms['labLabelForm'];
        var ackForm = document.forms['acknowledgeForm'];
        if (labForm && labForm.label && ackForm && ackForm.label) {
            ...
            <div id="listViewDocs" style="height:550px; overflow:scroll;" onscroll="handleScroll(this)">
                ...
                <table id="summaryView" class="tablesorter">
                    ...
                    <div id="document_<%=segmentID%>">
                        <jsp:include page="/documentManager/ViewShowDocument" flush="true">
                    ...
                    <jsp:include page="/lab/CA/ALL/ViewLabDisplayAjax" flush="true">
                        <jsp:param name="segmentID" value="<%=segmentID%>"/>
                        <jsp:param name="demoName" value="<%=demoName%>"/>
                        <jsp:param name="providerNo" value="<%=providerNo%>"/>
                        <jsp:param name="searchProviderNo" value="<%=searchProviderNo%>"/>
                    ...
                    <tr id="labdoc_<%=segmentID%>" bgcolor="<%=bgcolor%>" <%if (result.isDocument()) {%>
                        ...
                        <td>
                            ...
                            <%
                                ...
                                url.append("/documentManager/ViewShowDocument?inWindow=true&segmentID=");
                        ...
                        <td class="lab-label">
                            <%= org.owasp.encoder.Encode.forHtml(result.getLabel()) %>
                        </td>
                        <td>
                        ...
                        <%--                                </td>--%>
                        <td>
                            <%= org.owasp.encoder.Encode.forHtml(result.getRequestingClient()) %>
                        </td>
                        <td>
                            <%= org.owasp.encoder.Encode.forHtml(result.isDocument() ? result.description == null ? "" : result.description : result.getDisciplineDisplayString()) %>
                        </td>
                        <td>
                            <%= org.owasp.encoder.Encode.forHtml(result.getReportStatus()) %>
                        </td>
                        <td>
