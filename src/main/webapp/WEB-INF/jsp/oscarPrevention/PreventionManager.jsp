...
//TODO the rest of this code should be moved into an Action Class and handled by the PreventionManager
        io.github.carlos_emr.carlos.managers.PreventionManager preventionManager = SpringUtils.getBean(io.github.carlos_emr.carlos.managers.PreventionManager.class);
    ...
    <table width="530" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                ...
                <form name="masterForm" action="<%=request.getContextPath()%>/oscarPrevention/ViewPreventionManager.do?formAction=update" method="post">
        ...
        <tr>
            <td>
                ...
                <form name="prevForm" action="<%=request.getContextPath()%>/oscarPrevention/ViewPreventionManager.do?formAction=custom" method="post">
                    <table bgcolor="#666666" cellspacing="0" cellpadding="0" border="0" width="530">
                        <td>
