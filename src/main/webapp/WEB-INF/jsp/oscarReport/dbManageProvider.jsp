...
--%>
<%--
    dbManageProvider.jsp (WEB-INF view)

    View fragment for DbManageProvider2Action.
    Refreshes the opener window and closes the popup after provider list update.
...
<center>
    <table border="0" cellspacing="0" cellpadding="0" width="90%">
        <tr bgcolor="#486ebd">
            <th align="CENTER"><font face="Helvetica" color="#FFFFFF">ADD A Provider List</font></th>
        </tr>
    </table>
    <%
