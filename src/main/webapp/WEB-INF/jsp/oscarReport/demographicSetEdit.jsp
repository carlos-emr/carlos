...
--%>
<%--
  Page role: Renders `demographicSetEdit.jsp` for the reporting workflow.
                ...
                <div class="col-md-12">
                   ...
                   String setName = (String) request.getAttribute("setname");%>
                    <div><form action="${pageContext.request.contextPath}/report/SetEligibility" method="post">
                        ...
                        <!--<a href="#delete-set-confirm" role="button" class="btn btn-alert" data-bs-toggle="modal"><fmt:message key="eform.groups.delGroup"/></a>-->
                    </form></div>
                    <script>
