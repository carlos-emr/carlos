...
<html>
    ...
    %>
    <pre><font face="Arial, Helvetica, sans-serif" size="2"> <fmt:message key="oscarReport.oscarReportAgeSex.msgDate"/>: <%=curYear%>-<%=curMonth%>-<%=curDay%> <fmt:message key="oscarReport.oscarReportAgeSex.msgUnit"/>: <%=clinic%> <fmt:message key="oscarReport.oscarReportAgeSex.msgPhysician"/>: <%=Encode.forHtml(providerview)%></font></pre>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#CCCCFF">
            <td>
