...
--%>
<%--
  Page role: Renders `homePage.jsp` for the reporting workflow.
...
<%@ page import="java.util.*,io.github.carlos_emr.carlos.report.reportByTemplate.*,io.github.carlos_emr.carlos.managers.RBTGroupManager" %>
