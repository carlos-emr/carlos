    ...
    <table width="530" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                ...
                <form name="masterForm" action="<%=request.getContextPath()%>/prevention/ViewPreventionManager?formAction=update" method="post">
        ...
        <tr>
            <td>
                ...
                <form name="prevForm" action="<%=request.getContextPath()%>/prevention/ViewPreventionManager?formAction=custom" method="post">
                    <table bgcolor="#666666" cellspacing="0" cellpadding="0" border="0" width="530">
                        <td>
