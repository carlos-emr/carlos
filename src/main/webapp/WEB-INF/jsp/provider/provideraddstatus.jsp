...
<%
    ...
    if (rowsAffected == 1) {//add_record
        ...
        String displaypage = "<%= request.getContextPath() %>/provider/providercontrol.do?year=" + request.getParameter("year") + "&month=" + request.getParameter("month") + "&day=" + request.getParameter("day") + "&view=" + strView + "&displaymode=day&dboperation=searchappointmentday" + "&viewall=" + strViewAll + "&x=" + request.getParameter("x") + "&y=" + request.getParameter("y");
