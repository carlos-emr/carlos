...
<html>
    <head>
        ...
        <title><fmt:message key="report.reportFormDemoConfig.title"/></title>
            ...
            <tr bgcolor="<%="#EEEEFF"%>">
                ...
                <td align="center" width="20%" nowrap valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
                            <td colspan="2"><fmt:message key="report.reportFormDemoConfig.label.fields"/> | <fmt:message key="report.reportFormDemoConfig.label.selected"/> <br>
                                <br>
