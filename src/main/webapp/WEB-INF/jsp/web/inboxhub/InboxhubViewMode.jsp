...
<div id="inboxViewItems" class="inbox-view-items pe-1">
    ...
    <c:forEach var="labResult" items="${labDocs}" varStatus="loopStatus">
        <div class="document-card card mb-1 shadow-sm" id="labdoc_${carlos:forHtmlAttribute(labResult.segmentID)}" data-lab-type="${carlos:forHtmlAttribute(labResult.labType)}" style="height: 100%;">
            <div class="card-body">
