...
<%
    java.util.ResourceBundle docDescResources =
    ...
    <script type="text/javascript">
        ...
        function adddocDescription() {
            if (document.docDescriptionForm.docDescription.value.length > 0 && document.docDescriptionForm.docDescriptionShortcut.value.length > 0) {
                ...
                alert("<%= Encode.forJavaScript(docDescResources.getString("provider.setDocumentDescriptionTemplate.DescriptionCannotBeEmpty")) %>");
            }
        }
...
<form method="post" name="docDescriptionForm" action="displayDocumentDescriptionTemplate.jsp">
    ...
    <fmt:message key="provider.setDocumentDescriptionTemplate.Add" var="btnAdd"/>
    <fmt:message key="provider.setDocumentDescriptionTemplate.Update" var="btnUpdate"/>
    <fmt:message key="provider.setDocumentDescriptionTemplate.Delete" var="btnDelete"/>
    <table style="visibility:hidden" id="tblDesc">
        ...
        <tr>
            <td colspan="2"><input type="button"
                ...
                <input type="button" value="${btnUpdate}"
