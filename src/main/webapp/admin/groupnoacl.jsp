...
<%@ page import="io.github.carlos_emr.carlos.commn.model.MyGroupAccessRestriction" %>
<%
        ...
        <table width="100%" BGCOLOR="#486ebd">
            <tr>
                <TD align="center">
                    ...
                    <INPUT TYPE="BUTTON" VALUE="<fmt:setBundle basename="oscarResources"/><fmt:message key="global.btnClose"/>" onClick="(window.top || window).close();">
                </TD>
            </tr>
        </TABLE>
