...
<html lang="${pageContext.request.locale.language}">
    ...
    <table id="tblResults" style="width:100%" class="table table-hover table-striped table-sm">
        ...
        <tr>
            ...
            <td><% if (provider.getStatus() != null && "1".equals(provider.getStatus())) { %><fmt:message key="admin.provider.formStatusActive"/><% } else if (provider.getStatus() != null) { %><fmt:message key="admin.provider.formStatusInactive"/><% } %>
            </td>
        </tr>
        <%
                }
