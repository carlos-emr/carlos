    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <fmt:message key="admin.providertemplate.btnEdit" var="btnEdit"/>
                <fmt:message key="admin.providertemplate.btnDelete" var="btnDelete"/>
                <fmt:message key="admin.providertemplate.btnSave" var="btnSave"/>
                <fmt:message key="admin.providertemplate.btnExit" var="btnExit"/>
                <div class="card card-body bg-body-tertiary">
                    <form name="edittemplate" method="post" action="providertemplate.jsp" class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        <fmt:message key="admin.providertemplate.labelSelectTemplate"/><br>
                        <select name="name">
                            <%
                        ...
                        <input type="button" value="${btnEdit}"
                ...
                <div class="card card-body bg-body-tertiary">
                    <form name="template" method="post" action="providertemplate.jsp">
                        ...
                        <input type="button" value="${btnSave}"
                        ...
                        <input type="button" name="Button" id="exit-btn"
                               value="${btnExit}" class="btn btn-secondary"
