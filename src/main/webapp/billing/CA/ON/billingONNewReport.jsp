    ...
    <form name="serviceform" method="post" action="billingONReport.jsp">
        ...
        <div class="d-flex flex-wrap align-items-center gap-2" style="margin-bottom:10px;">
            <label class="form-check form-check-inline">
                <input type="radio" name="reportAction" value="unbilled" class="form-check-input" <%="unbilled".equals(action)? "checked" : "" %>> Unbilled
            </label>
            <label class="form-check form-check-inline">
                <input type="radio" name="reportAction" value="billed" class="form-check-input" <%="billed".equals(action)? "checked" : "" %>> Billed
            </label>
        ...
        <a href="#" onClick="popupPage(700,720,'<%= request.getContextPath() %>/oscarReport/manageProvider.jsp?action=billingreport'); return false;" class="btn btn-sm btn-outline-secondary">Manage Provider List</a>
    </form>
