    ...
    <div id="<%=noteIdAttribute%>"
        ...
        <div id="n<%=globalNoteId%>" class="note-contents">
            ...
            <%
                ...
                if (rx != null) {
                    String url = "popupPage(700,800,'" + hash + "', '" + request.getContextPath() + "/rx/StaticScript2.jsp?demographicNo=" + Encode.forUriComponent(String.valueOf(rx.getDemographicNo())) + "&regionalIdentifier=" + Encode.forUriComponent(StringUtils.noNull(rx.getRegionalIdentifier())) + "&cn=" + Encode.forUriComponent(StringUtils.noNull(rx.getCustomName())) + "');";
            %>
