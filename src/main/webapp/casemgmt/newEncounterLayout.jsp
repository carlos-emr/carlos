...
<html>
    <head>
        ...
        <script type="text/javascript" src="${e:forHtmlAttribute(ctx)}/casemgmt/newEncounterLayout.js.jsp?v=<%= System.currentTimeMillis() %>"></script>
                    ...
                    <td>
                        <security:oscarSec roleName="<%=roleName%>"
                            ...
                            <img style="cursor: pointer;"
                                 ...
                                 src='${e:forHtmlAttribute(ctx)}/encounter/graphics/printer.png'>&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.cpp.title"/>
                        </security:oscarSec>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><img style="cursor: pointer;"
                             ...
                             src='${e:forHtmlAttribute(ctx)}/encounter/graphics/printer.png'>&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Rx.title"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><img style="cursor: pointer;"
                             ...
                             src='${e:forHtmlAttribute(ctx)}/encounter/graphics/printer.png'>&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Labs.title"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><img style="cursor: pointer;"
                             ...
                             src='${e:forHtmlAttribute(ctx)}/encounter/graphics/printer.png'>&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Preventions.title"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><img style="cursor: pointer;"
                             ...
                             src='${e:forHtmlAttribute(ctx)}/encounter/graphics/printer.png'>&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Allergies.title"/></td>
                </tr>
                <!--  extension point -->
                <tr id="printDateRow">
