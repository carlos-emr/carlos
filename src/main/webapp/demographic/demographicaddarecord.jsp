...
<html>
    ...
    <div class="container">
        ...
        <form method="post" name="addappt">
            ...
            %>
            <script language="JavaScript">
                document.addappt.action = "<%= request.getContextPath() %>/appointment/addappointment.jsp?user_id=<%=Encode.forJavaScript(request.getParameter("creator") != null ? request.getParameter("creator") : "")%>&provider_no=<%=Encode.forJavaScript(provider_no2 != null ? provider_no2 : "")%>&bFirstDisp=<%=Encode.forJavaScript(bFirstDisp2 != null ? bFirstDisp2 : "")%>&appointment_date=<%=Encode.forJavaScript(request.getParameter("appointment_date") != null ? request.getParameter("appointment_date") : "")%>&year=<%=Encode.forJavaScript(year2 != null ? year2 : "")%>&month=<%=Encode.forJavaScript(month2 != null ? month2 : "")%>&day=<%=Encode.forJavaScript(day2 != null ? day2 : "")%>&start_time=<%=Encode.forJavaScript(start_time2 != null ? start_time2 : "")%>&end_time=<%=Encode.forJavaScript(end_time2 != null ? end_time2 : "")%>&duration=<%=Encode.forJavaScript(duration2 != null ? duration2 : "")%>&name=<%=URLEncoder.encode(bufName.toString(), StandardCharsets.UTF_8)%>&chart_no=<%=URLEncoder.encode(bufChart.toString(), StandardCharsets.UTF_8)%>&bFirstDisp=false&demographic_no=<%=Encode.forJavaScript(dem != null ? dem : "")%>&messageID=<%=Encode.forJavaScript(request.getParameter("messageId") != null ? request.getParameter("messageId") : "")%>&doctor_no=<%=Encode.forJavaScript(bufDoctorNo.toString())%>&notes=<%=Encode.forJavaScript(request.getParameter("notes") != null ? request.getParameter("notes") : "")%>&reason=<%=Encode.forJavaScript(request.getParameter("reason") != null ? request.getParameter("reason") : "")%>&location=<%=Encode.forJavaScript(request.getParameter("location") != null ? request.getParameter("location") : "")%>&resources=<%=Encode.forJavaScript(request.getParameter("resources") != null ? request.getParameter("resources") : "")%>&type=<%=Encode.forJavaScript(request.getParameter("type") != null ? request.getParameter("type") : "")%>&style=<%=Encode.forJavaScript(request.getParameter("style") != null ? request.getParameter("style") : "")%>&billing=<%=Encode.forJavaScript(request.getParameter("billing") != null ? request.getParameter("billing") : "")%>&status=<%=Encode.forJavaScript(request.getParameter("status") != null ? request.getParameter("status") : "")%>&createdatetime=<%=Encode.forJavaScript(request.getParameter("createdatetime") != null ? request.getParameter("createdatetime") : "")%>&creator=<%=Encode.forJavaScript(request.getParameter("creator") != null ? request.getParameter("creator") : "")%>&remarks=<%=Encode.forJavaScript(request.getParameter("remarks") != null ? request.getParameter("remarks") : "")%>";
