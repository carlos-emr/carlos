...
<html>
    ...
    <div class="container">
        ...
        <form method="post" name="addappt">
            ...
            %>
            <script language="JavaScript">
                <%-- URL parameters are encoded with forUriComponent(), which percent-encodes all
                     JS-unsafe characters (quotes, backslashes, etc.), making additional JS encoding
                     redundant and would cause double-encoding of the percent signs. --%>
