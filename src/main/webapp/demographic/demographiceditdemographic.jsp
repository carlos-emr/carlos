                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="javascript: function myFunction() {return false; }"
                                       onClick="popupPage(500,800,'<%= request.getContextPath() %>/billing/CA/ON/billingONHistory.jsp?demographic_no=<%=URLEncoder.encode(String.valueOf(demographic.getDemographicNo()), StandardCharsets.UTF_8)%>&last_name=<%=URLEncoder.encode(demographic.getLastName(), StandardCharsets.UTF_8)%>&first_name=<%=URLEncoder.encode(demographic.getFirstName(), StandardCharsets.UTF_8)%>&orderby=appointment_date&displaymode=appt_history&dboperation=appt_history&limit1=0&limit2=10')">
