...
<html>
    ...
    <object id="pdf" type="application/pdf"
            data="printDemoLabelAction.do?demographic_no=<%= Encode.forUriComponent(request.getParameter("demographic_no")) %>&appointment_no=<%= Encode.forUriComponent(request.getParameter("appointment_no")) %>"
