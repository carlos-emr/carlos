        ...
        <div class="well span6">
            ...
            <table class="table table-condensed table-striped">
                ...
                <tr rel="popover" data-html="true" data-title="<%=curForm.get("formName")%>"
                    data-content="<strong><fmt:message key="eform.uploadhtml.btnSubject"/>:</strong><br> <%=curForm.get("formSubject")%> <br> <small><fmt:message key="eform.uploadhtml.btnFile"/>: <%=curForm.get("formFileName")%></small>"
