...
<%
    ...
    eForm.addHeadJavascript(request.getContextPath()+"/library/bootstrap/5.3.3/js/bootstrap.bundle.js");
    ...
    eForm.addCSS(request.getContextPath()+"/library/bootstrap/5.3.3/css/bootstrap.css", "all");
