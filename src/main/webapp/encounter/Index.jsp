    ...
    <head>
        ...
        <script type="text/javascript" language=javascript>
            ...
            function closeEncounterWindow() {
                return window.confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.closeEncounterWindowConfirm"/>");
            }

            //function saveAndCloseEncounterWindow() {
            //    var x = window.confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.confirmExit"/>");
            //    if(x) {window.close();}
            //}
            //get another encounter from the select list
            function onSplit() {
                document.forms['encForm'].btnPressed.value = 'Split Chart';
                var ret = confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.confirmSplit"/>");
                return ret;
            }
            ...
            function popUpMeasurements(vheight, vwidth, varpage) { //open a new popup window
                if (varpage != 'null') {
                    ...
                    measurementWindows = window.open(page, "<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.popupPageWindow"/>", windowprops);
                    if (measurementWindows != null) {
                        if (measurementWindows.opener == null) {
                            measurementWindows.opener = self;
                            alert("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.popupPageAlert"/>");
                        }
                    }
                }
            }
            ...
            function popUpInsertTemplate(vheight, vwidth, varpage) { //open a new popup window
                //var x = window.confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.insertTemplateConfirm"/>");
                //if(x) {
                if (varpage != 'null') {
            ...
            function popupStart1(vheight, vwidth, varpage) {
                var page = varpage;
                windowprops = "height=" + vheight + ",width=" + vwidth + ",location=no,scrollbars=yes,menubars=no,toolbars=no,resizable=yes,screenX=0,screenY=0,top=0,left=0";
                var popup = window.open(varpage, "<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.title"/>", windowprops);
            }
            ...
            function onUnbilled(url) {
                if (confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.onUnbilledConfirm"/>")) {
            ...
            function popupSearchPage(vheight, vwidth, varpage) { //open a new popup window
                ...
                var popup = window.open(page, "<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.popupSearchPageWindow"/>", windowprop);
            }
...
////
            ...
            function popupPageK(page) {
                windowprops = "height=700,width=1024,location=no,"
                    + "scrollbars=yes,menubars=no,toolbars=no,resizable=yes,top=0,left=0";
                var popup = window.open(page, "<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.popupPageKWindow"/>", windowprops);
                popup.focus();
            }
            ...
            //function sign(){
            //        document.encForm.enTextarea.value =document.encForm.enTextarea.value +"\n[<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.signed"/> <%=dateConvert.DateToString(bean.currentDate)%> <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.by"/> <%=bean.userName%>]";
            //}
        ...
        <script type="text/javascript" language=javascript>
            ...
            function AjaxSubmitFailure(request) {
                alert("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.concurrencyError.errorMsg"/>");
            }
...
<% } %>
    ...
    <table border="0" cellpadding="0" cellspacing="0"
           ...
           name="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.encounterTable"/>">
        <tr>
            <td class="hidePrint" bgcolor="#003399"
                style="border-right: 2px solid #A9A9A9; height: 34px;">
                <div class="Title">&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.msgEncounter"/></div>
            </td>
            ...
            <td bgcolor="#003399"
                ...
                <table name="tileTable"
                    ...
                    <form name="appointmentListForm"
                          action="./encounter/IncomingEncounter.do"><caisi:isModuleLoad
                            moduleName="caisi">
            ...
            <td
                ...
                <table class="LeftTable">
                    <form name="leftColumnForm"><caisi:isModuleLoad
                        ...
                        <tr class="Header">
                            <td style="font-weight: bold"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.msgForms"/></td>
                        </tr>
                        <tr>
                            <td><select name="selectCurrentForms"
                                ...
                                <option value="null" selected>-<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.currentForms"/>- <%
                        ...
                        <tr>
                            <td><select name="selectForm"
                                        ...
                                        onMouseOver="javascript:window.status='
                                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.createForm"/> <%=patientName%>.'; return true;">
                                <option value="null" selected>-<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.addForm"/>- <%
                        for(int j=0; j<forms.length; j++) {
                            EctFormData.Form frm = forms[j];
                            if (!frm.isHidden()) {
                        %>
                        ...
                        <tr>
                            <td><a href=#
                                ...
                                -<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.msgOldForms"/>-</a></td>
                        </tr>
    ...
    <table class="LeftTable">
        <form name="insertTemplateForm"><caisi:isModuleLoad
            ...
            <tr class="Header">
                <td style="font-weight: bold"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.encounterTemplate"/></td>
            </tr>
            <tr>
                <td><select name="templateSelect" class="ControlSelect"
                    ...
                    <option value="null" selected>-<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.insertTemplate"/>- <%
    ...
    <table class="LeftTable">
        <tr class="Header">
            <td style="font-weight: bold" colspan="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.measurements"/></td>
        </tr>
        <tr>
            <td>
                <%
                ...
                <form name="measurementGroupForm">
                    ...
                    <option value="null" selected>-<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.SelectGroup"/>- <%
        ...
        <tr>
            <td><a href=#
                   onClick="popupPage(600,1000,'<rewrite:reWrite
                           jspPage="oscarMeasurements/SetupHistoryIndex.do"/>'); return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.oldMeasurements"/></a></td>
        </tr>
        </form>
    </table>
    <table class="LeftTable">
        ...
        <tr>
            <td><a href="#"
                   ...
                   title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.resource"/>"
                   onmouseover="window.status='<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.viewResource"/>';return true"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.resource"/></a><br>
                <a href="#"
                   onClick="popupPage(710,970,'<%= request.getContextPath() %>/documentManager/documentReport.jsp?function=demographic&doctype=lab&functionid=<%=bean.demographicNo%>&curUser=<%=bean.curProviderNo%>');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.msgDocuments"/></a><br>
                <a href="#"
                ...
                <a href="javascript: function myFunction() {return false; }"
                   onClick="popupPage(150,200,'calculators.jsp?sex=<%=bean.patientSex%>&age=<%=pAge%>'); return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.calculators"/></a><br>
    ...
    <table class="LeftTable">
        <form name="ksearch"><caisi:isModuleLoad moduleName="caisi">
            ...
            <tr>
                <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.searchFor"/><%= request.getParameter("userName")%>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.using"/></td>
            </tr>
            <tr>
                <td><select class="ControlSelect" name="channel">
                    <option
                        ...
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.oscarSearch"/></option>
            ...
            <tr>
                <td><input type="button" name="button"
                           ...
                           value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.btnGo"/>"
                                ...
                                <td>
                                    <div
                                        ...
                                        <a onMouseOver="javascript:window.status='Minimize'; return true;"
                                           ...
                                           title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.tooltipClose"/>">
                                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.x"/></a> | <a
                                            onMouseOver="javascript:window.status='Small Size'; return true;"
                                            href="javascript:rowOneSmall();"
                                            title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.tooltipSmall"/>">
                                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.s"/></a> | <a
                                            onMouseOver="javascript:window.status='Medium Size'; return true;"
                                            href="javascript:rowOneNormal();"
                                            title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.tooltipNormal"/>">
                                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.n"/></a> | <a
                                            onMouseOver="javascript:window.status='Large Size'; return true;"
                                            href="javascript:rowOneLarge();"
                                            title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.tooltipLarge"/>">
                                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.l"/></a> | <a
                                            onMouseOver="javascript:window.status='Full Size'; return true;"
                                            href="javascript:rowOneFull();"
                                            title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.tooltipFull"/>">
                                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.f"/></a> | <a
                                            onMouseOver="javascript:window.status='Full Size'; return true;"
                                            href="javascript:reset();"
                                            title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.tooltipReset"/>">
                                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.r"/></a></div>
                                </td>
                            </tr>
                            <tr width="100%">
                            ...
                            <tr>
                                <td>
                                    <div class="RowTop">
                                        ...
                                        %> <% } else { %> <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.msgConcerns"/>: <% } %>
                                    </div>
                                    <input type="hidden" name="ocInput"/></td>

                                <td>
                                    <div class="RowTop"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.msgReminders"/>:
                                    </div>
                                </td>
                                <td>
                                    <div
                                        ...
                                        <tr>
                                            <td width='75%'>
                                                <div class="RowTop"><a href=#
                                                    ...
                                                    <!--http://localhost:8084/oscar/encounter/echarthistoryprint.jsp?echartid=7491&demographic_no=10090-->
                                                    <a href="javascript: function myFunction() {return false; }"
                                ...
                                <td nowrap>
                                    <div
                                        ...
                                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.n"/></a> | <a
                                            ...
                                            title="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.tooltipMedium"/>">
                                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.m"/></a> | <a
                                            onMouseOver="javascript:window.status='Large Size'; return true;"
                        ...
                        <table border=0 bgcolor="#CCCCFF" width=100%>
                            <tr id="saveFeedbackRow" nowrap>
                                ...
                                <td style="text-align: right" nowrap><span
                                        id="saveFeedbackText" style="display: none"> <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.saveFeedbackText"/> </span>
                                    ...
                                    <security:oscarSec roleName="<%=roleName$%>" objectName="_eChart"
                                        ...
                                        <input type="button" style="height: 20px"
                                               value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.btnSave"/>"
                                               class="ControlPushButton"
                                               onclick="document.forms['encForm'].btnPressed.value='Save'; document.forms['encForm'].submit();">
                                        <input type="button" style="height: 20px"
                                               value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.btnSignSave"/>"
                                               class="ControlPushButton"
                                        ...
                                        <oscar:oscarPropertiesCheck property="billregion" value="BC">
                                            <input type="button" style="height: 20px"
                                                   value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.btnSignSaveBill"/>"
                                                   class="ControlPushButton"
                                        ...
                                        <security:oscarSec roleName="<%=roleName$%>"
                                            ...
                                            <input type="button" style="height: 20px"
                                                   value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.btnSign"/>"
                                                   class="ControlPushButton"
