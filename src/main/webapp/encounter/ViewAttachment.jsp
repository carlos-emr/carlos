...
<html>
    <head>
        ...
        <title><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.title"/>
        </title>
    </head>
    ...
    <table class="MainTable" id="scrollNumber1"
           name="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgEncounterTable"/>">
        <tr class="MainTableTopRow">
            ...
            <td class="MainTableTopRowRightColumn">
                <table class="TopStatusBar">
                    <tr>
                        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgViewAtt"/></td>
                        <td></td>
        ...
        <tr>
            ...
            <td class="MainTableRightColumn">
                ...
                <table cellspacing="1" valign="top">
                    <tr>
                        <td bgcolor="#DDDDFF"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgFrom"/>:
                        </td>
                        <td bgcolor="#CCCCFF"><%= sentBy%> <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgAt"/> <%=remoteName%>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#DDDDFF"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgSubject"/>:
                        </td>
                    ...
                    <tr>
                        <td bgcolor="#DDDDFF"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgDate"/>:
                        </td>
                ...
                <div style="font-size: 8pt; margin-top: 15px;"><a
                        href="javascript:expandAll();"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgExpandAll"/></a> &nbsp;|&nbsp; <a
                        href="javascript:collapseAll();"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.ViewAttachment.msgColapseAll"/></a></div>
