                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" id="attachDocumentPanelBtn"
                                               ...
                                               data-poload="${ ctx }/previewDocs.do?method=fetchConsultDocuments&amp;demographicNo=<%=Encode.forHtmlAttribute(demo)%>&amp;requestId=<%=Encode.forHtmlAttribute(requestId)%>">
                                                Manage Attachments
                                            </a>
                                ...
                                <div class="card mb-2">
                                    <div class="card-header p-2 fw-semibold" style="font-size:0.85rem;">
                                        ...
                                        <a href="javascript:void(0);"
                                           onClick="popupAttach(600,900,'<%=request.getContextPath()%>/demographic/DemographicEdit.do?demographic_no=<%=Encode.forJavaScript(demo)%>')"><%=Encode.forHtml(thisForm.getPatientName())%></a>
                                    </div>
                                    <div class="card-body p-2">
                                    ...
                                    <oscar:oscarPropertiesCheck value="true"
                                        ...
                                        <tr>
                                            ...
                                            <td class="consult-form-label" style="font-size:11px;">
                                                <a href="javascript:void(0);"
                                                   onclick="popupPage(500,700,'${ctx}/demographic/Contact.do?method=manageContactList&contactList=HCT&view=detached&demographic_no=<%=Encode.forJavaScript(demo)%>' ); return false;">
