...
<html>
    <head>
        ...
        <title><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Measurements.msgAddMeasurementGroup"/></title>
            ...
            <tr class="MainTableTopRow">
                ...
                <td class="MainTableTopRowRightColumn">
                    <table class="TopStatusBar">
                        <tr>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Measurements.msgAddMeasurementGroup"/></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table border=0 cellspacing=4 width=800>
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <th align="left" class="td.tite"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.oscarMeasurements.MeasurementGroup.allTypes"/>
                                        </th>
