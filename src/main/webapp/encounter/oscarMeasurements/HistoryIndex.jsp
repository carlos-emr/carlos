...
<% } %>
    ...
    <div style="display:inline-block; text-align:center">
        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.oscarMeasurements.oldmesurementindex"/>

        <table>
            <tr>
                <th align="left" class="Header" width="20"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.oscarMeasurements.displayHistory.headingType"/>
                </th>
                <th align="left" class="Header" width="200"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.oscarMeasurements.typedescription"/></th>
            ...
            <c:if test="${not empty measurementsData}">
                <c:forEach var="data" items="${measurementsData.measurementsDataVector}" varStatus="ctr">
                    <tr class="data">
                        ...
                        <td width="50"><a href="#"
                                          name='<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.oldMeasurements"/>'
