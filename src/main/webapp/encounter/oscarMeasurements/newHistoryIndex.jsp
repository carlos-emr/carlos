...
<html>
    ...
    <head>
        <title>
            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.oldMeasurements"/>
        </title>
        ...
        <table>
            <tr>
                <td>
                    <table>
                        <tr>
                            <th colspan='3'><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.oscarMeasurements.oldmesurementindex"/></th>
                        </tr>
                        <tr>
                            <th align="left" class="Header" style="color:white" width="20">
                                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.oscarMeasurements.displayHistory.headingType"/>
                            </th>
                        ...
                        <c:forEach items="${sessionScope.measurementsTypes}" var="pair" varStatus="rowCounter">
                            ...
                            <tr class="data" style='<c:out value="${rowStyle}"/>'>
                                ...
                                <td><a href="#" name='<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.Index.oldMeasurements"/>'
