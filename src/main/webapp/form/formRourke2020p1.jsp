...
<input type="hidden" name="ID" value="<%= Encode.forHtmlAttribute(props.getProperty("ID", "0")) %>"/>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr valign="top">
            <td align="center">
                ...
                <label for="p1_birthRemarksr1"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.formPremature"/></label>&nbsp;
            ...
            <td width="65%" nowrap align="center">
                <p>
                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgName"/>: <input type="text" name="c_pName"
                    ...
                    Age: <input type="text" id="currentAge" size="10" maxlength="10" readonly="true"
                                ondblclick="calcAge();">
                    <% if (!((FrmRourke2020Record) rec).isFemale(loggedInInfo, demoNo)) { %>
                    (<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgMale"/>) <input type="hidden" name="c_male"
                                                                                      value="x">
                    <% } else { %>
                    (<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgFemale"/>) <input type="hidden" name="c_female"
                                                                                        value="x">
                    <% } %>
                    &nbsp;&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.formFSA"/>
                    <input type="text" name="c_fsa" size="3" maxlength="3"
                           value="<%= Encode.forHtmlAttribute(props.getProperty("c_fsa", "")) %>">
                </p>
                <p>
                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgStartOfPregnancy"/>:
                    <input type="text" id="c_startOfGestation" name="c_startOfGestation" size="6" maxlength="7"
                           value="<%= Encode.forHtmlAttribute(props.getProperty("c_startOfGestation", "")) %>">
                    <img src="<%= request.getContextPath() %>/images/cal.gif" id="c_startOfGestation_cal">
                    &nbsp;&nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgLenght"/>:
                    <input type="text" ondblclick="htEnglish2Metric(this);" name="c_length" size="6" maxlength="6"
                           value="<%= Encode.forHtmlAttribute(props.getProperty("c_length", "")) %>"/>
                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgLenghtUnit"/> &nbsp;&nbsp;
                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgHeadCirc"/>:
                    ...
                    &nbsp;&nbsp; <a href="javascript:void(0)"
                                    onclick="displayDemographicMeasurements('c_birthWeight', 'WT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>', '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgBirthWt"/>:</a>
                    <input type="text" ondblclick="wtEnglish2Metric(this);" name="c_birthWeight" id="c_birthWeight"
                           size="6" maxlength="7" value="<%= Encode.forHtmlAttribute(props.getProperty("c_birthWeight", "")) %>"/>
                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgBirthWtUnit"/>
                    &nbsp;&nbsp; <a href="javascript:void(0)"
                                    onclick="displayDemographicMeasurements('c_dischargeWeight', 'WT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>', '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgDischargeWt"/>:</a>
                    <input type="text" ondblclick="wtEnglish2Metric(this);" name="c_dischargeWeight"
                           id="c_dischargeWeight" size="6" maxlength="7"
                           value="<%= Encode.forHtmlAttribute(props.getProperty("c_dischargeWeight", "")) %>">
                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgDischargeWtUnit"/>
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td style="padding:10px;" align="center">
                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tr>
                        <td align="center">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.formRiksFactors"/>
                        ...
                        <td nowrap align="center">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.formAPGAR"/><br>
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.form1min"/>
                            <select name="c_APGAR1min">
                                <option <%= props.getProperty("c_APGAR1min", "").equals("") || props.getProperty("c_APGAR1min", "").equals("-1") ? "selected='selected'" : ""%>
                                        value="-1">
                                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.formNotSet"/>
                                </option>
                            ...
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.form5min"/>
                        ...
                        <td align="center">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.formFamHistory"/><br>
                            <textarea id="c_famHistory" name="c_famHistory" rows="5"
                                      cols="17"><%=Encode.forHtml(props.getProperty("c_famHistory", ""))%></textarea>
                        </td>
                    </tr>
                </table>
            </td>
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    ...
    <tr align="center" id="growthAp1">
        <td class="column" rowspan="2">
            <a>
                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020_1.btnGrowth"/><br/>
                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_1.btnGrowthmsg"/>
            </a>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p1_ht1w', 'HT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>',
        ...
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p1_wt1w', 'WT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>',
                       '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')">
                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formWt"/>
            </a>
        </td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formHdCirc"/></td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p1_ht2w', 'HT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>',
                       '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')">
                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formHt"/>
            </a>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p1_wt2w', 'WT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>',
                       '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')">
                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formWt"/>
            </a>
        </td>
        ...
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p1_ht1m', 'HT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>',
                       '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')">
                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formHt"/>
            </a>
        </td>
        <td>
            <a href="javascript:void(0)"
               onclick="displayDemographicMeasurements('p1_wt1m', 'WT', '<%=Encode.forJavaScriptAttribute(String.valueOf(demographic.getDemographicNo()))%>',
                       '<%=Encode.forJavaScriptAttribute(demographic.getFormattedDob())%>', '<%= Encode.forJavaScriptAttribute(appointmentNo) %>')">
                <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formWt"/>
            </a>
        </td>
    ...
    <tr align="center">
        ...
        <td colspan="3"><textarea id="p1_pConcern1w" name="p1_pConcern1w" class="wide limit-rows" cols="10" rows="5"
                                  maxlength="400"><%=Encode.forHtml(props.getProperty("p1_pConcern1w", ""))%></textarea></td>
        <td colspan="3"><textarea id="p1_pConcern2w" name="p1_pConcern2w" class="wide limit-rows" cols="10" rows="5"
                                  maxlength="400"><%=Encode.forHtml(props.getProperty("p1_pConcern2w", ""))%></textarea></td>
        <td colspan="3"><textarea id="p1_pConcern1m" name="p1_pConcern1m" class="wide limit-rows" cols="10" rows="5"
                                  maxlength="400"><%=Encode.forHtml(props.getProperty("p1_pConcern1m", ""))%></textarea></td>
    </tr>
            ...
            <table id="ntp11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formVitaminD200"/>*
                        </a>
                    </b></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.msgFormulaFeeding"/>*
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_supplementationWater1w" formProperties="<%=props%>"
                                                  showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formSupplementationWater"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_supplementationOtherFluids1w"
                                                  formProperties="<%=props%>" showNoOption="<%=true%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formSupplementationOtherFluids"/></td>
                </tr>
                ...
                <tr style="vertical-align: bottom;">
                    <td style="vertical-align: bottom;" colspan="5">
                        <textarea id="p1_pNutrution1w" name="p1_pNutrition1w" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(props.getProperty("p1_pNutrition1w", ""))%></textarea>
                    </td>
                </tr>
            </table>
            ...
            <table id="ntp12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_breastFeeding2w" formProperties="<%=props%>"
                                                  showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
                    <td><b>
                        <a onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5">
                        <textarea id="p1_pNutrution2w" name="p1_pNutrition2w" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(props.getProperty("p1_pNutrition2w", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="ntp13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_1.msgFormulaFeeding"/>
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_supplementationSolids1m" formProperties="<%=props%>"
                                                  showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formSupplementationSolids"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5">
                        <textarea id="p1_pNutrution1m" name="p1_pNutrition1m" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(props.getProperty("p1_pNutrition1m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="educationp1">
        <td class="column">
            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgEducational"/><br/>
        ...
        <td colspan="9">
            <table id="edt1" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top" colspan="16"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formInjuryPrev"/></td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top" onclick="selectAllOkRadioButtons(this)">
                        <div class="checkmark-img-wrapper"><img height="15" width="20" src="graphics/Checkmark_L.gif">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020_1.formMotorizedvehicles"/>/<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020_1.formCarSeat"/>
                        </a>*</b>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formFireArm"/>*
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formHotWater"/>/<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formBathSafety"/>*
                        </a></i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formPacifierUse"/>*
                        </a>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_1.formSleepPos"/>/<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formCribSafety"/>*
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.formFalls"/>*
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="top" colspan="16"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formBehaviour"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formCrying"/>**</a>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formNightWaking"/>**</a></b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formBonding"/>**</a></b>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formParentFatigue"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top" colspan="5">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formHighRiskOrHomeVisit"/>**
                        </a></b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_1.formCough"/>*
                        </a></b>
                    </td>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formAltMed"/>*
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <rourke:discussionRadioSelect sectionName="p1_tmpControl" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formTempCtrl"/></td>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formFever"/>*
                        </a>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formTummyTime"/>*
                        </a></b>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p1_education1w" name="p1_education1w" style="width: 100%"
                                              rows="5"><%=Encode.forHtml(props.getProperty("p1_education1w", ""))%></textarea>
                                </td>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p1_education2w" name="p1_education2w" style="width: 100%"
                                              rows="5"><%=Encode.forHtml(props.getProperty("p1_education2w", ""))%></textarea>
                                </td>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p1_education1m" name="p1_education1m" style="width: 100%"
                                              rows="5"><%=Encode.forHtml(props.getProperty("p1_education1m", ""))%></textarea>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr id="developmentp1">
        <td class="column">
            <a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.msgDevelopment"/>**</a><br>
            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.msgDevelopmentDesc"/><br/>
            <img height="15" width="20" src="graphics/Checkmark_Lwhite.gif">
            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.msgDevelopmentLegend"/>
        </td>
            ...
            <table id="dt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_sucks1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formSucksWell"/></td>
                </tr>
                <tr align="center">
            ...
            <table id="dt12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_noParentsConcerns2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formNoparentConcerns"/>**</td>
                </tr>
                <tr align="center">
            ...
            <table id="dt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_calms1m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_1.formCalmes"/></td>
                </tr>
                <tr>
            ...
            <table id="pt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formFontanelles"/>**</a>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_skin1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formDrySkin"/></a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formRedReflex"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formEarDrums"/>**</i>
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formIntectPalate"/>**</i>
                        </a>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_tongueMobility1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formTongueMobility"/>**</a></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_neckTorticollis1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formNeckTorticollis"/>**</a></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_heartLungs1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formHeart"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_femoralPulses1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formFemoralPulses"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_umbilicus1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formUmbilicus"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_hips1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formHips"/>**
                    </a></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_genitalia1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formGenitalia"/></td>
                </tr>

                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_maleUrinary1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formMaleUrinaryStream"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_patencyOfAnus1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formSpine"/>**/<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formPatencyOfAnus"/>**
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_muscleTone1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formMuscleTone"/>**
                    </a></td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
                        <textarea id="p1_pPhysical1w" name="p1_pPhysical1w" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(props.getProperty("p1_pPhysical1w", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_fontanelles2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formFontanelles"/>**</a></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_skin2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formDrySkin"/></a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_spine2w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formSpine"/>**</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p1_pPhysical2w"
                                  ...
                                  rows="5"><%=Encode.forHtml(props.getProperty("p1_pPhysical2w", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formHearingInquiry"/>**</i>
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_heartAbdomen1m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formHeartAbdomen"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
                        <textarea id="p1_pPhysical1m" name="p1_pPhysical1m" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(props.getProperty("p1_pPhysical1m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="problemsPlansp1">
        ...
        <td colspan="3" style="vertical-align:bottom;">
            <textarea id="p1_problems1w" name="p1_problems1w" rows="5" cols="25" class="wide limit-rows"
                      maxlength="400"><%=Encode.forHtml(props.getProperty("p1_problems1w", ""))%></textarea>
        </td>
        <td colspan="3" style="vertical-align:bottom;">
            <textarea id="p1_problems2w" name="p1_problems2w" rows="5" cols="25" class="wide limit-rows"
                      maxlength="400"><%=Encode.forHtml(props.getProperty("p1_problems2w", ""))%></textarea>
        </td>
        <td colspan="3" style="vertical-align:bottom;">
            <textarea id="p1_problems1m" name="p1_problems1m" rows="5" cols="25" class="wide limit-rows"
                      maxlength="400"><%=Encode.forHtml(props.getProperty("p1_problems1m", ""))%></textarea>
        </td>
    </tr>
            ...
            <table id="immt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_newbornScreening1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formImmunizationNewbornScreening"/></b></td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formImmunizationHemoglobinopathyScreen"/></a></b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formImmunizationNewbornHearingScreening"/></a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-left: 4px;"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formImmunizationIfHepatitis"/>:
                    </td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formImmunizationHepatitisVaccine1"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
                ...
                <tr>
                    <td style="vertical-align:bottom;">
                        <textarea id="p1_immunization2w" name="p1_immunization2w" rows="5" cols="25"
                                  class="wide"><%=Encode.forHtml(props.getProperty("p1_immunization2w", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="immt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formImmunizationHepatitisVaccine2"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
...
<table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
    <tr>
        <td nowrap="true"><input type="submit" value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.btnSave"/>"
                                 onclick="javascript:return onSave();"/>
            <input type="submit" value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.btnSaveExit"/>"
                   onclick="javascript:return onSaveExit();"/>
            <input type="submit" value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.btnExit"/>"
