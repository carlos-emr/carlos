            ...
            <td width="65%" nowrap align="center">
                ...
                <p>
                    ...
                    &nbsp;&nbsp; <a href="javascript:void(0)"
                                    onclick="displayDemographicMeasurements('c_birthWeight', 'WT', '<%=demographic.getDemographicNo()%>', '<%=demographic.getFormattedDob()%>', '<%= Encode.forJavaScript(appointmentNo) %>')"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgBirthWt"/>:</a>
                    ...
                    &nbsp;&nbsp; <a href="javascript:void(0)"
                                    onclick="displayDemographicMeasurements('c_dischargeWeight', 'WT', '<%=demographic.getDemographicNo()%>', '<%=demographic.getFormattedDob()%>', '<%= Encode.forJavaScript(appointmentNo) %>')"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgDischargeWt"/>:</a>
