...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr class="titleBar">
        <th><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.msgRourkeBabyRecord"/></th>
    </tr>
</table>
<div id="patientInfop2">
    ...
    <input type="text" id="c_birthDate2" size="10" maxlength="10" value="<%= Encode.forHtmlAttribute(props.getProperty("c_birthDate", "")) %>"
           readonly="true">
    &nbsp;&nbsp;
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    <tr align="center">
        ...
        <td colspan="4" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.msg2mos"/></a></td>
        <td colspan="4" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.msg4mos"/></a></td>
        <td colspan="4" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.msg6mos"/></a></td>
    </tr>
    <tr align="center">
        ...
        <td colspan="4">
            ...
            <input readonly type="text" id="p2_date2m"
                   ...
                   value="<%=Encode.forHtmlAttribute(props.getProperty("p2_date2m", ""))%>"/>
        ...
        <td colspan="4">
            ...
            <input readonly type="text" id="p2_date4m"
                   ...
                   value="<%=Encode.forHtmlAttribute(props.getProperty("p2_date4m", ""))%>"/>
        ...
        <td colspan="4">
            ...
            <input readonly type="text" id="p2_date6m"
                   ...
                   value="<%=Encode.forHtmlAttribute(props.getProperty("p2_date6m", ""))%>"/>
    ...
    <tr align="center" id="growthBp2">
        ...
        <td><input type="text" class="wide"
                   ...
                   maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_ht2m", "")) %>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p2_wt2m" id="p2_wt2m" size="4"
                   maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_wt2m", "")) %>"></td>
        <td colspan="2"><input type="text" class="wide"
                               ondblclick="htEnglish2Metric(this);" name="p2_hc2m" size="4"
                               maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_hc2m", "")) %>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p2_ht4m" id="p2_ht4m" size="4"
                   maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_ht4m", "")) %>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p2_wt4m" id="p2_wt4m" size="4"
                   maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_wt4m", "")) %>"></td>
        <td colspan="2"><input type="text" class="wide"
                               ondblclick="htEnglish2Metric(this);" name="p2_hc4m" size="4"
                               maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_hc4m", "")) %>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p2_ht6m" id="p2_ht6m" size="4"
                   maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_ht6m", "")) %>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p2_wt6m" id="p2_wt6m" size="4"
                   maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_wt6m", "")) %>"></td>
        <td colspan="2"><input type="text" class="wide"
                               ondblclick="htEnglish2Metric(this);" name="p2_hc6m" size="4"
                               maxlength="5" value="<%= Encode.forHtmlAttribute(props.getProperty("p2_hc6m", "")) %>"></td>
    </tr>
    <tr align="center">
        ...
        <td colspan="4"><textarea id="p2_pConcern2m"
                                  ...
                                  maxlength="400"><%=Encode.forHtml(props.getProperty("p2_pConcern2m", ""))%></textarea>
        </td>
        <td colspan="4"><textarea id="p2_pConcern4m"
                                  name="p2_pConcern4m" class="wide limit-rows" cols="10" rows="5"
                                  maxlength="400"><%=Encode.forHtml(props.getProperty("p2_pConcern4m", ""))%></textarea>
        </td>
        <td colspan="4"><textarea id="p2_pConcern6m"
                                  name="p2_pConcern6m" class="wide limit-rows" cols="10" rows="5"
                                  maxlength="400"><%=Encode.forHtml(props.getProperty("p2_pConcern6m", ""))%></textarea>
        </td>
    </tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_2.msgFormulaFeeding2m"/></i>
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5">
                        <textarea id="p2_nutrition2m" name="p2_nutrition2m" class="wide" rows="5"
                                  cols="25"><%=Encode.forHtml(props.getProperty("p2_nutrition2m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="ntp22" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_2.msgFormulaFeeding4m"/></i>
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formFutureIntroductionSolids"/>*</a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5"><textarea id="p2_nutrition4m"
                                                                              ...
                                                                              rows="5"
                                                                              cols="25"><%=Encode.forHtml(props.getProperty("p2_nutrition4m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="ntp23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_2.msgFormulaFeedingLong6m"/>*</a></i>
                    </td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_iron6m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formIronContainingFoods"/></b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_allergenic6m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formAllergenicFoods"/>*</b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_vegFruit6m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formFruitsVegetablesAndMilk"/></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_avoidJuiceAndBeverages6m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formAvoidJuiceAndBeverages"/>*</td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()" href="javascript:showNotes()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formNoHoney"/>*</a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.msgChoking"/>*
                    </a></td>
                </tr>
                <tr>
                ...
                <tr align="center" style="vertical-align:bottom;">
                    <td colspan="5"><textarea id="p2_nutrition6m" name="p2_nutrition6m" class="wide" rows="5"
                                              cols="25"><%=Encode.forHtml(props.getProperty("p2_nutrition6m", ""))%></textarea></td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.formPacifierUse"/>*
                        </a></i>
                    </td>
                    <rourke:discussionRadioSelect sectionName="p2_electric" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top">
                        <i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formElectricPlugs"/></i>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formBehaviourCrying"/>**</a>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote2"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formChildCare"/></a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_2.formAltMed"/>*
                        </a></i>
                    </td>
                    ...
                    <rourke:discussionRadioSelect sectionName="p2_tmpControl" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formTempCtrl"/></i></td>
                ...
                <tr>
                    ...
                    <td colspan="5" valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020_2.formTeething"/>*
                        </a>
                    </td>
                            ...
                            <tr>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p2_education2m" name="p2_education2m" style="width: 100%"
                                              rows="5"><%=Encode.forHtml(props.getProperty("p2_education2m", ""))%></textarea>
                                </td>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p2_education4m" name="p2_education4m" style="width: 100%"
                                              rows="5"><%=Encode.forHtml(props.getProperty("p2_education4m", ""))%></textarea>
                                </td>
                                <td style="vertical-align:bottom;">
                                    <textarea id="p2_education6m" name="p2_education6m" style="width: 100%"
                                              rows="5"><%=Encode.forHtml(props.getProperty("p2_education6m", ""))%></textarea>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table id="dt21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_development2m"
                                                                             ...
                                                                             class="wide"><%=Encode.forHtml(props.getProperty("p2_development2m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="dt22" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_development4m"
                                                                             ...
                                                                             class="wide"><%=Encode.forHtml(props.getProperty("p2_development4m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="dt23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_development6m"
                                                                             ...
                                                                             class="wide"><%=Encode.forHtml(props.getProperty("p2_development6m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formFontanelles"/>**
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formHearingInquiry"/>**
                    </a></i></td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formNeckTorticollis"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_skin2m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formDrySkin"/>
                    </a></td>
                </tr>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p2_physical2m"
                                  ...
                                  class="wide"><%=Encode.forHtml(props.getProperty("p2_physical2m", ""))%></textarea>
            ...
            <table id="pt22" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_fontanelles4m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formAnteriorFontanelle"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_hips4m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formHipsLimitedHipAdbn"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_bruising4m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formBruising"/>**
                    </a></td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p2_physical4m"
                                  ...
                                  class="wide"><%=Encode.forHtml(props.getProperty("p2_physical4m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_TeethRiskAssesment6m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formTeethRiskAssesment"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_muscleTone6m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formMuscleTone"/>**/<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020_2.formHeadLag"/>
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p2_physical6m"
                                  ...
                                  class="wide"><%=Encode.forHtml(props.getProperty("p2_physical6m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="problemsPlansp2">
        ...
        <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems2m" name="p2_problems2m" rows="5"
                                                                 ...
                                                                 maxlength="400"><%=Encode.forHtml(props.getProperty("p2_problems2m", ""))%></textarea>
        </td>
        <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems4m" name="p2_problems4m" rows="5"
                                                                 cols="25" class="wide limit-rows"
                                                                 maxlength="400"><%=Encode.forHtml(props.getProperty("p2_problems4m", ""))%></textarea>
        </td>
        <td colspan="4">
            <table id="prbt23" cellpadding="0" cellspacing="0" width="100%">
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems6m" name="p2_problems6m"
                                                                             ...
                                                                             maxlength="400"><%=Encode.forHtml(props.getProperty("p2_problems6m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="immt23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_AnemiaScreening6m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formAnemiaScreening"/>**
                    </a></i></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_tb6m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.formTB"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2020.formImmunizationHepatitisVaccine3"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
                        <textarea id="p2_immunization6m" name="p2_immunization6m" rows="5" cols="25"
                                  class="wide"><%=Encode.forHtml(props.getProperty("p2_immunization6m", ""))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        ...
        <td colspan="4"><input type="text" class="wide"
                               ...
                               value="<%= Encode.forHtmlAttribute(props.getProperty("p2_signature2m", "")) %>"/></td>
        <td colspan="4"><input type="text" class="wide" maxlength="42"
                               style="width: 100%" name="p2_signature4m"
                               value="<%= Encode.forHtmlAttribute(props.getProperty("p2_signature4m", "")) %>"/></td>
        <td colspan="4"><input type="text" class="wide"
                               style="width: 100%" name="p2_signature6m"
                               value="<%= Encode.forHtmlAttribute(props.getProperty("p2_signature6m", "")) %>"/></td>
    </tr>
...
<p style="font-size: 8pt;"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.footer"/><br/>
</p>
