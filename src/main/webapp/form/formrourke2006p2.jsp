    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
            <tr>
                ...
                <td nowrap="true"><a
                        href="form/formrourke2006p1.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:message key="encounter.formRourke2006.Pg1"/></a>&nbsp;|&nbsp; <a><fmt:message key="encounter.formRourke2006.Pg2"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourke2006p3.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:message key="encounter.formRourke2006.Pg3"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourke2006p4.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:message key="encounter.formRourke2006.Pg4"/></a></td>
            </tr>
        </table>
