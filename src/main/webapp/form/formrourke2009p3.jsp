...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    ...
    <tr id="growthAp3" align="center">
        <td class="column" rowspan="2"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.btnGrowth"/>*</a><br>
        ...
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formHt"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formWt12m"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formHdCirc"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formHt"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formWt"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formHdCirc"/></td>
        ...
        <td colspan="3">
            <table id="ntp31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><i><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_3.msgFormulaFeeding"/></i></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.msgCereal"/></td>
                </tr>
                <tr>
                    ...
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.msgIntroCowMilk"/></td>
                </tr>
                <tr>
        ...
        <td colspan="3">
            <table id="ntp32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.btnBreastFeeding"/>*</a></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_3.formEncourageCup"/></td>
                </tr>
                <tr>
            ...
            <table id="edt3" style="font-size: 8pt;" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <td valign="top"><b><a
                            ...
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_3.formCarSeat"/></a>*</b></td>
                    <td colspan="4">&nbsp;</td>
                ...
                <tr>
                    <td colspan="4" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formChildProof"/>
                    ...
                    <td valign="top"><i><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formFalls"/>*</a></i></td>
                ...
                <tr>
                    <td valign="top" colspan="20"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formBehaviour"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><b><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote2"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_3.formHomeVisit"/>**</a></b></td>
                    <td colspan="4">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formParenting"/></td>
                ...
                <tr>
                    <td valign="top" colspan="20"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_1.formOtherIssues"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formTeething"/>*</a></td>
                    ...
                    <td colspan="5" valign="top"><i><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_2.formPacifierUse"/>*</a></i></td>
                </tr>
                <tr>
                    ...
                    <td colspan="5" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formFootwear"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formEnvHealth"/></td>
        ...
        <td colspan="3" align="center">
            <table id="dt31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_3.formThumb&Index"/></td>
                </tr>
        ...
        <td colspan="3" align="center">
            <table id="dt32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009_3.formCrawls"/></td>
                </tr>
        ...
        <td colspan="3">
            <table id="dt33" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formFingerFoods"/></td>
                </tr>
        ...
        <td colspan="3">
            <table id="pt31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.formRedReflex"/>*</a>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formCornealReflex"/>*</a></td>
                </tr>
        ...
        <td colspan="3">
            <table id="pt32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formTonsilSize"/>*</a>
                    </td>
                </tr>
    ...
    <tr id="problemsPlansp3">
        <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke1.msgProblemsAndPlans"/></a>
            <br>
            <img height="15" width="20" src="graphics/Checkmark_Lwhite.gif">
            <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2009.msgProblemsLegendp2"/>
        </td>
        <td colspan="3">
            <table id="prbt31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formAntiHB"/>*</a></b><br/>
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formAntiHBcond"/></td>
                </tr>
                <tr>
                    ...
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke2006_3.formHemoglobin"/>*</a></i></td>
                </tr>
