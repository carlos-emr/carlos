    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <table cellspacing="0" cellpadding="0" class="Header" class="hidePrint">
            <tr>
                ...
                <td nowrap="true"><a
                        href="form/formrourkep1.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:message key="encounter.formRourke2.btnpage1"/></a>&nbsp;|&nbsp; <a><fmt:message key="encounter.formRourke2.msgPage2"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourkep3.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:message key="encounter.formRourke2.btnPage3"/></a></td>
            </tr>
        </table>
                ...
                <td width="65%" nowrap align="center">
                    ...
                    <p><fmt:message key="encounter.formRourke2.formLenght"/>:
                        ...
                        <fmt:message key="encounter.formRourke2.msgBirthWtUnit"/> &nbsp;&nbsp; <fmt:message key="encounter.formRourke2.formDischargeWt"/>: <input
                                ...
                                value="<%= Encode.forHtmlAttribute(props.getProperty("c_dischargeWeight", "")) %>"> <fmt:message key="encounter.formRourke2.msgDischargeWtUnit"/></p>
                </td>
            </tr>
        </table>
                ...
                <td colspan="3" valign="top">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute((resource == null ? "" : resource) + "n_breastFeeding")%>');return false;"><fmt:message key="encounter.formRourke2.btnBreastFeeding"/></a><fmt:message key="encounter.formRourke2.msgBreastFeedingUnit"/></b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>n_breastFeeding');return false;"><fmt:message key="encounter.formRourke2.btnBreastFeeding"/></a><fmt:message key="encounter.formRourke2.msgBreastFeedingUnit"/></b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><a href="#"
                                   onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>s_choking');return false;"><fmt:message key="encounter.formRourke2.formChokingSafeFood"/></a>*
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="3" valign="top">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>s_motorVehicleAccidents');return false;"><fmt:message key="encounter.formRourke2.formCarSeat"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><i><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>s_drowning');return false;"><fmt:message key="encounter.formRourke2.formBathSafety"/></a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>s_poisons');return false;"><fmt:message key="encounter.formRourke2.btnPoisons"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>b_nightWaking');return false;"><fmt:message key="encounter.formRourke2.formNightWaking"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                ...
                <td colspan="3" valign="top">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>hri_dayCare');return false;"><fmt:message key="encounter.formRourke2.formAssessDay"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p2_homeVisit9m"
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>hri_homeVisits');return false;"><fmt:message key="encounter.formRourke2.formAssessHomeVisit"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>o_secondHandSmoke');return false;"><fmt:message key="encounter.formRourke2.formSecondHandSmoke"/></a>*</b></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>Carbon monoxide/<br>
                                &nbsp;&nbsp;<i><a href="#"
                                                  onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>s_burns');return false;"><fmt:message key="encounter.formRourke2.formSmokeDetectors"/></a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p2_hotWater12m"
                        ...
                        <tr>
                            ...
                            <td><fmt:message key="encounter.formRourke2.formTeething"/><b><a href="#"
                                                                                         onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>o_dentalCare');return false;"><fmt:message key="encounter.formRourke2.btnDentalCare"/></a>*</b></td>
                        </tr>
                    </table>
                </td>
            </tr>
                ...
                <td colspan="3" valign="top">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>pe_cover');return false;"><fmt:message key="encounter.formRourke2.formCover"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td width="100%"><b><a href="#"
                                                   onclick="popup('<%=Encode.forJavaScriptAttribute(StringUtils.noNull(resource))%>i_hepB');return false;"><fmt:message key="encounter.formRourke2.btnAntiHB"/></a><fmt:message key="encounter.formRourke2.formAntiHB"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
