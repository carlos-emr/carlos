...
<html>
    <head>
        ...
        <title><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.title"/></title>
...
//            ret = confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgSaveAndPrintPreview"/>");
...
//        return ret;
        ...
        function onSave() {
            ...
            if (ret == true) {
                ...
                ret = confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgSave"/>");
        ...
        function onSaveExit() {
            ...
            if (ret == true) {
                ...
                ret = confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgSaveExit"/>");
...
// Declaring valid date character, minimum year and maximum year
        ...
        function checkTypeIn(obj) {
            ...
            if (!checkTypeNum(obj.value)) {
                ...
                alert("<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgTypeANumber"/>");
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <input type="hidden" name="c_lastVisited"
               value=<%=Encode.forHtml(props.getProperty("c_lastVisited", "p3"))%>/>
        ...
        <table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
            ...
            <tr>
                ...
                <td nowrap="true"><input type="submit"
                                         value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.btnSave"/>"
                                         onclick="javascript:return onSave();"/> <input type="submit"
                                                                                        value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.btnSaveExit"/>"
                                                                                        onclick="javascript:return onSaveExit();"/>
                    <input type="submit"
                           value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.btnExit"/>"
                           onclick="javascript:return onExit();"> <input type="button"
                                                                         value="<fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.btnPrint"/>"
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr class="titleBar">
                ...
                <th><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgRourkeBabyRecord"/></th>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="1">
            ...
            <tr align="center">
                ...
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgAge"/></a></td>

                <td class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msg18Months"/></a></td>

                <td class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msg2-3years"/></a></td>

                <td class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msg4-5years"/></a></td>
            ...
            <tr align="center">
                ...
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgGrowth"/></a></td>
            ...
            <tr>
                ...
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgNutrition"/></a>:
                </td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_bottle18m" <%=Encode.forHtml(props.getProperty("p3_bottle18m", ""))%> />
                            </td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_milk2y" <%=Encode.forHtml(props.getProperty("p3_milk2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_food2y" <%=Encode.forHtml(props.getProperty("p3_food2y", ""))%>></td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_milk4y" <%=Encode.forHtml(props.getProperty("p3_milk4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_food4y" <%=Encode.forHtml(props.getProperty("p3_food4y", ""))%>></td>
                ...
                <td class="column" valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="center" nowrap="true"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgEducationalAdvice"/></b></td>

                        </tr>

                        <tr>

                            <td align="right"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgSafety"/></b></td>
                        ...
                        <tr>
                            ...
                            <td align="right"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgBehaviour"/></b></td>
                        ...
                        <tr>
                            ...
                            <td align="right"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msfFamily"/></b></td>
                        ...
                        <tr>
                            ...
                            <td align="right"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgOther"/></b></td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_bath18m" <%=Encode.forHtml(props.getProperty("p3_bath18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_choking18m" <%=Encode.forHtml(props.getProperty("p3_choking18m", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_temperment18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_limit18m" <%=Encode.forHtml(props.getProperty("p3_limit18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_social18m" <%=Encode.forHtml(props.getProperty("p3_social18m", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_dental18m" <%=Encode.forHtml(props.getProperty("p3_dental18m", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_toilet18m" <%=Encode.forHtml(props.getProperty("p3_toilet18m", ""))%>>
                            </td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_bike2y" <%=Encode.forHtml(props.getProperty("p3_bike2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_matches2y" <%=Encode.forHtml(props.getProperty("p3_matches2y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_carbon2y" <%=Encode.forHtml(props.getProperty("p3_carbon2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_parent2y" <%=Encode.forHtml(props.getProperty("p3_parent2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_social2y" <%=Encode.forHtml(props.getProperty("p3_social2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_dayCare2y" <%=Encode.forHtml(props.getProperty("p3_dayCare2y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_dental2y" <%=Encode.forHtml(props.getProperty("p3_dental2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_toilet2y" <%=Encode.forHtml(props.getProperty("p3_toilet2y", ""))%>></td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_bike4y" <%=Encode.forHtml(props.getProperty("p3_bike4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_matches4y" <%=Encode.forHtml(props.getProperty("p3_matches4y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_carbon4y" <%=Encode.forHtml(props.getProperty("p3_carbon4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_water4y" <%=Encode.forHtml(props.getProperty("p3_water4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_social4y" <%=Encode.forHtml(props.getProperty("p3_social4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_dental4y" <%=Encode.forHtml(props.getProperty("p3_dental4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_school4y" <%=Encode.forHtml(props.getProperty("p3_school4y", ""))%>></td>
            ...
            <tr>
                ...
                <td class="column">
                    ...
                    <div align="center"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgDevelopment"/></b><br>

                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgDevelopmentDesc"/>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_points18m" <%=Encode.forHtml(props.getProperty("p3_points18m", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_words18m" <%=Encode.forHtml(props.getProperty("p3_words18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_picks18m" <%=Encode.forHtml(props.getProperty("p3_picks18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_walks18m" <%=Encode.forHtml(props.getProperty("p3_walks18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_stacks18m" <%=Encode.forHtml(props.getProperty("p3_stacks18m", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_affection18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_showParents18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_looks18m" <%=Encode.forHtml(props.getProperty("p3_looks18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_noParentsConcerns18m", ""))%>></td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msg2Years"/></b></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_word2y" <%=Encode.forHtml(props.getProperty("p3_word2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_sentence2y" <%=Encode.forHtml(props.getProperty("p3_sentence2y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_run2y" <%=Encode.forHtml(props.getProperty("p3_run2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_container2y"
                                    <%=Encode.forHtml(props.getProperty("p3_container2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_copies2y" <%=Encode.forHtml(props.getProperty("p3_copies2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_skills2y" <%=Encode.forHtml(props.getProperty("p3_skills2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_noParentsConcerns2y", ""))%>></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msg3Years"/></b></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_understands3y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_twists3y" <%=Encode.forHtml(props.getProperty("p3_twists3y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_turnPages3y"
                                    <%=Encode.forHtml(props.getProperty("p3_turnPages3y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_share3y" <%=Encode.forHtml(props.getProperty("p3_share3y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_listens3y" <%=Encode.forHtml(props.getProperty("p3_listens3y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_noParentsConcerns3y", ""))%>></td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msg4Years"/></b></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_understands4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_questions4y"
                                    <%=Encode.forHtml(props.getProperty("p3_questions4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_oneFoot4y" <%=Encode.forHtml(props.getProperty("p3_oneFoot4y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_draws4y" <%=Encode.forHtml(props.getProperty("p3_draws4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_toilet4y" <%=Encode.forHtml(props.getProperty("p3_toilet4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_comfort4y" <%=Encode.forHtml(props.getProperty("p3_comfort4y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_noParentsConcerns4y", ""))%>></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msg5Years"/></b></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_counts5y" <%=Encode.forHtml(props.getProperty("p3_counts5y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_speaks5y" <%=Encode.forHtml(props.getProperty("p3_speaks5y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_ball5y" <%=Encode.forHtml(props.getProperty("p3_ball5y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_hops5y" <%=Encode.forHtml(props.getProperty("p3_hops5y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_shares5y" <%=Encode.forHtml(props.getProperty("p3_shares5y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_alone5y" <%=Encode.forHtml(props.getProperty("p3_alone5y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_separate5y" <%=Encode.forHtml(props.getProperty("p3_separate5y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(props.getProperty("p3_noParentsConcerns5y", ""))%>></td>
            ...
            <tr>
                ...
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgPhysicalExamination"/></a><br>

                    <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgPhysicalExaminationDecs"/></td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_eyes18m" <%=Encode.forHtml(props.getProperty("p3_eyes18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_cover18m" <%=Encode.forHtml(props.getProperty("p3_cover18m", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_hearing18m" <%=Encode.forHtml(props.getProperty("p3_hearing18m", ""))%>>
                            </td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_visual2y" <%=Encode.forHtml(props.getProperty("p3_visual2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_cover2y" <%=Encode.forHtml(props.getProperty("p3_cover2y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_hearing2y" <%=Encode.forHtml(props.getProperty("p3_hearing2y", ""))%>>
                            </td>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_visual4y" <%=Encode.forHtml(props.getProperty("p3_visual4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_cover4y" <%=Encode.forHtml(props.getProperty("p3_cover4y", ""))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_hearing4y" <%=Encode.forHtml(props.getProperty("p3_hearing4y", ""))%>>
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_blood4y" <%=Encode.forHtml(props.getProperty("p3_blood4y", ""))%>></td>
            ...
            <tr>
                ...
                <td class="column">
                    ...
                    <div align="center"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgProblems"/></b></div>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_serum2y" <%=Encode.forHtml(props.getProperty("p3_serum2y", ""))%>></td>
            ...
            <tr>
                ...
                <td class="column">
                    ...
                    <div align="center"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgImmunization"/></b><br>

                        <fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.msgImmunizationDesc"/>
            ...
            <tr>
                ...
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="encounter.formRourke3.formSignature"/></a></td>
