 ...
 *   /documentManager/ManageDocument?method=searchDocumentDescriptions&term=<keyword>
...
function setupDocDescriptionTypeahead(docId) {
    ...
    function fetchSuggestions(term) {
        ...
        const url = contextPath + '/documentManager/ManageDocument?method=searchDocumentDescriptions&term=' +
