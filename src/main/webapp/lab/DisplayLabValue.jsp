    ...
    <%
        for (int k = 0; k < list.size(); k++) {
            ...
            if (labType.equals(LabResultData.MDS)) {
                labDisplayLink = request.getContextPath() + "/oscarMDS/SearchPatient.do?segmentID=" + java.net.URLEncoder.encode(labNo, java.nio.charset.StandardCharsets.UTF_8) + "&providerNo=" + java.net.URLEncoder.encode(providerNo, java.nio.charset.StandardCharsets.UTF_8);
