                ...
                <table cellpadding="0" cellspacing="2"
                    ...
                    <tr>
                        <td width="0%" valign="top">
                            <div class="DivCCBreadCrumbs"><a href="SearchDrug.jsp"> <fmt:message key="SearchDrug.title"/></a>&nbsp;&gt;&nbsp; <a
                                    href="ShowAllergies.jsp"> <fmt:message key="EditAllergies.title"/></a>&nbsp;&gt;&nbsp; <b><fmt:message key="AddReaction.title"/></b></div>
                        </td>
                    </tr>
                    <!----Start new rows here-->
                    <tr>
