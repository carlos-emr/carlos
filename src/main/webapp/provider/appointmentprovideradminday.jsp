                ...
                <ul id="userSettingsMenu" style="display: flex; gap:5px;">
                    ...
                    <li>
                        <a href="javascript:void(0)" style="display: flex; align-items: flex-end;"
                           onClick="popupPage(800,1000,'providerpreference.jsp?provider_no=<%= Encode.forJavaScriptAttribute(Encode.forUriComponent(loggedInInfo1.getLoggedInProviderNo())) %>')"
