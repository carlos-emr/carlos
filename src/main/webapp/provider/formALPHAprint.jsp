...
<TABLE BORDER BORDERCOLOR="#000000" CELLSPACING=1 CELLPADDING=4>
    ...
    <TR>
        ...
        <TD VALIGN="TOP"
            WIDTH="50%"><%= request.getParameter("xml_ff_socialsupport") == null || request.getParameter("xml_ff_socialsupport").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_ff_socialsupport")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_ff_recentstressfullifeevents") == null || request.getParameter("xml_ff_recentstressfullifeevents").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_ff_recentstressfullifeevents")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT SIZE="-1"
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_ff_couplerelationship") == null || request.getParameter("xml_ff_couplerelationship").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_ff_couplerelationship")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR bgcolor="#f9f9f9">
        <TD colspan="2" VALIGN="TOP"><FONT FACE="Arial, Helvetica"
    ...
    <TR>
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_mf_prenatalcare") == null || request.getParameter("xml_mf_prenatalcare").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_mf_prenatalcare")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_mf_prenataleducation") == null || request.getParameter("xml_mf_prenataleducation").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_mf_prenataleducation")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
            ...
            <FONT SIZE="-1" FACE="Arial, Helvetica">�How do you feel about
                it now?</FONT></TD>
        <TD VALIGN="TOP"><%= request.getParameter("xml_mf_feelingstopregnancy20") == null || request.getParameter("xml_mf_feelingstopregnancy20").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_mf_feelingstopregnancy20")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_mf_relationshipwithparents") == null || request.getParameter("xml_mf_relationshipwithparents").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_mf_relationshipwithparents")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_mf_selfesteem") == null || request.getParameter("xml_mf_selfesteem").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_mf_selfesteem")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_mf_historypsychiatricemaotional") == null || request.getParameter("xml_mf_historypsychiatricemaotional").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_mf_historypsychiatricemaotional")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
        ...
        <TD VALIGN="TOP"><%= request.getParameter("xml_mf_depression") == null || request.getParameter("xml_mf_depression").isEmpty() ? "&nbsp;" : Encode.forHtml(request.getParameter("xml_mf_depression")) %> <%-- NOSONAR java:S5131 — encoded via Encode.forHtml() --%>
        </TD>
    </TR>
    <TR>
