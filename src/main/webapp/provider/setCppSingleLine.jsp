...
<html>
    <head>
        ...
        <fmt:message key="global.javascript.calendar" var="calendarLanguageFile"/>
        <script type="text/javascript"
                src="${e:forHtmlAttribute(ctx)}/share/calendar/lang/${e:forUri(calendarLanguageFile)}"></script>
