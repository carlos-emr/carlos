...
%>
 ...
 <div class="form-group row" id="macro_new">
    ...
    <div class="col-sm-3 ">
     <label for="timeUnits_new"><fmt:setBundle basename="oscarResources"/><fmt:message key="tickler.ticklerMain.msgDate" /></label><br><input type="number" id="quantity_new" class="" style="width:50px;" value="0"><select id="timeUnits_new">
