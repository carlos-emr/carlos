...
List providerList = providerDao.getActiveProviders();
...
<div>
  ...
  <textarea name="labMacroJSON.value" id="macroJSON" style="width:80%;height:80%" rows="25"><%=Encode.forHtmlAttribute((up != null)?up.getValue():"")%></textarea>
