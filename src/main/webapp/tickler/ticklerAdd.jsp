    ...
    <div class="container-fluid well">
        <form name="ADDAPPT" method="post" action="<%= request.getContextPath() %>/appointment/appointmentcontrol.jsp">
            <table class="table-condensed">
                ...
                <tr>
                    <td width="35%" class="tickler-label"><fmt:message key="tickler.ticklerAdd.formDemoName"/>:</td>
                    <td width="65%">
        ...
        <form name="serviceform" method="post">
            <table class="table-condensed">
                ...
                <tr>
                    <td width="35%" class="tickler-label"><fmt:message key="tickler.ticklerAdd.formChartNo"/>:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" name="Button" class="btn btn-primary"
                        ...
                        <input type="button" name="Button" class="btn btn-danger"
                               value="<fmt:message key="tickler.ticklerAdd.btnCancel"/>" onClick="window.close()">
                    </td>
                </tr>
