 ...
 * @since 2026-03-07
 */
@DisplayName("CriteriaType Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("pmmodule")
@Transactional
public class CriteriaTypeDaoIntegrationTest extends CarlosTestBase {
    ...
    class CrudOperations {
        ...
        void shouldFind_whenValidIdProvided() {
            CriteriaType saved = new CriteriaType();
            criteriaTypeDao.persist(saved);
            CriteriaType found = criteriaTypeDao.find(saved.getId());
