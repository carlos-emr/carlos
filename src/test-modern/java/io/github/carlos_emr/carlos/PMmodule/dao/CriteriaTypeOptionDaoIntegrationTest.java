 ...
 * @since 2026-03-07
 */
@DisplayName("CriteriaTypeOption Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("pmmodule")
@Transactional
public class CriteriaTypeOptionDaoIntegrationTest extends CarlosTestBase {
    ...
    class CrudOperations {
        ...
        void shouldFind_whenValidIdProvided() {
            CriteriaTypeOption saved = new CriteriaTypeOption();
            criteriaTypeOptionDao.persist(saved);
            CriteriaTypeOption found = criteriaTypeOptionDao.find(saved.getId());
