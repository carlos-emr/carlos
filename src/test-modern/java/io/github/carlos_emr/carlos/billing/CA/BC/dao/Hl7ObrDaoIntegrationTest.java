 ...
 * @since 2026-03-07
 */
@DisplayName("Hl7Obr Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("billing-bc")
@Transactional
public class Hl7ObrDaoIntegrationTest extends CarlosTestBase {
    ...
    class CrudOperations {
        ...
        void shouldFind_whenValidIdProvided() {
            Hl7Obr saved = new Hl7Obr();
            hl7ObrDao.persist(saved);
            Hl7Obr found = hl7ObrDao.find(saved.getId());
