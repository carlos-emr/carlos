...
/**
 * Integration tests for {@link WcbBpCodeDao}.
 * <p>Migrated from legacy JUnit 4 / DaoTestFixtures.</p>
 * @since 2026-03-07
 */
@DisplayName("WcbBpCode Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("billing-bc")
@Transactional
public class WcbBpCodeDaoIntegrationTest extends CarlosTestBase {

    @Autowired
    private WcbBpCodeDao wcbBpCodeDao;
