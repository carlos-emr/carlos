...
/**
 * Integration tests for {@link BatchEligibilityDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code BatchEligibilityDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see BatchEligibilityDao
 */
@DisplayName("BatchEligibility Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("billing")
@Transactional
public class BatchEligibilityDaoIntegrationTest extends CarlosTestBase {
