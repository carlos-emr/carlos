...
/**
 * Integration tests for {@link BillCenterDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code BillCenterDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see BillCenterDao
 */
@DisplayName("BillCenter Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("billing")
@Transactional
public class BillCenterDaoIntegrationTest extends CarlosTestBase {

    @Autowired
    private BillCenterDao billCenterDao;
