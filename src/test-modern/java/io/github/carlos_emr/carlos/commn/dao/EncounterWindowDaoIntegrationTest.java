...
/**
 * Integration tests for {@link EncounterWindowDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code EncounterWindowDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see EncounterWindowDao
 */
@DisplayName("EncounterWindow Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("encounter")
@Transactional
public class EncounterWindowDaoIntegrationTest extends CarlosTestBase {
