...
/**
 * Integration tests for {@link FunctionalCentreDao}.
 *
 * <p>Migrated from legacy JUnit 4 / DaoTestFixtures.</p>
 *
 * @since 2026-03-07
 * @see FunctionalCentreDao
 */
@DisplayName("FunctionalCentre Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("admin")
@Transactional
public class FunctionalCentreDaoIntegrationTest extends CarlosTestBase {
