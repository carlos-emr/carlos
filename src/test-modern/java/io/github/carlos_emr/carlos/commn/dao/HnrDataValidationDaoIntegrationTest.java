...
/**
 * Integration tests for {@link HnrDataValidationDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code HnrDataValidationDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see HnrDataValidationDao
 */
@DisplayName("HnrDataValidation Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("admin")
@Transactional
public class HnrDataValidationDaoIntegrationTest extends CarlosTestBase {

    @Autowired
    private HnrDataValidationDao hnrDataValidationDao;
