...
/**
 * Integration tests for {@link InstitutionDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code InstitutionDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see InstitutionDao
 */
@DisplayName("Institution Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("admin")
@Transactional
public class InstitutionDaoIntegrationTest extends CarlosTestBase {
