...
/**
 * Integration tests for {@link LogLettersDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code LogLettersDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see LogLettersDao
 */
@DisplayName("LogLetters Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("admin")
@Transactional
public class LogLettersDaoIntegrationTest extends CarlosTestBase {
