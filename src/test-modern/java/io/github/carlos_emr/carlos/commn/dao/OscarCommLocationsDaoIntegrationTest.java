...
/**
 * Integration tests for {@link OscarCommLocationsDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code OscarCommLocationsDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see OscarCommLocationsDao
 */
@DisplayName("OscarCommLocations Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("admin")
@Transactional
public class OscarCommLocationsDaoIntegrationTest extends CarlosTestBase {
