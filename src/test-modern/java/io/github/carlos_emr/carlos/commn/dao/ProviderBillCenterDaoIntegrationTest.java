...
/**
 * Integration tests for {@link ProviderBillCenterDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code ProviderBillCenterDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see ProviderBillCenterDao
 */
@DisplayName("ProviderBillCenter Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("provider")
@Transactional
public class ProviderBillCenterDaoIntegrationTest extends CarlosTestBase {
    ...
    class CrudOperations {
        ...
        void shouldPersistProviderBillCenter_whenValidDataProvided() throws Exception {
        ...
        void shouldFindProviderBillCenter_whenValidIdProvided() throws Exception {
    ...
    class QueryOperations {
        ...
        void shouldCountAllProviderBillCenters() throws Exception {
            ProviderBillCenter entity = new ProviderBillCenter();
            EntityDataGenerator.generateTestDataForModelClass(entity);
            providerBillCenterDao.persist(entity);
