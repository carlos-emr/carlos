...
/**
 * Integration tests for {@link QuickListUserDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code QuickListUserDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see QuickListUserDao
 */
@DisplayName("QuickListUser Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("admin")
@Transactional
public class QuickListUserDaoIntegrationTest extends CarlosTestBase {

    @Autowired
    private QuickListUserDao quickListUserDao;
