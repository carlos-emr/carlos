...
/**
 * Integration tests for {@link ReportProviderDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code ReportProviderDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see ReportProviderDao
 */
@DisplayName("ReportProvider Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("reporting")
@Transactional
public class ReportProviderDaoIntegrationTest extends CarlosTestBase {
