...
/**
 * Integration tests for {@link ReportTempDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code ReportTempDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see ReportTempDao
 */
@DisplayName("ReportTemp Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("reporting")
@Transactional
public class ReportTempDaoIntegrationTest extends CarlosTestBase {
