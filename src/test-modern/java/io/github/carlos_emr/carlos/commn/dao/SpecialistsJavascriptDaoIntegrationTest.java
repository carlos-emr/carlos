...
/**
 * Integration tests for {@link SpecialistsJavascriptDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code SpecialistsJavascriptDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see SpecialistsJavascriptDao
 */
@DisplayName("SpecialistsJavascript Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("admin")
@Transactional
public class SpecialistsJavascriptDaoIntegrationTest extends CarlosTestBase {

    @Autowired
    private SpecialistsJavascriptDao specialistsJavascriptDao;
