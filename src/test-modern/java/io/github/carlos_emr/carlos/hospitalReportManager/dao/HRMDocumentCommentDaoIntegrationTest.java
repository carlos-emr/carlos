...
/**
 * Integration tests for {@link HRMDocumentCommentDao} covering entity persistence.
 *
 * <p>Migrated from legacy {@code HRMDocumentCommentDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see HRMDocumentCommentDao
 */
@DisplayName("HRMDocumentCommentDao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("hrm")
@Transactional
public class HRMDocumentCommentDaoIntegrationTest extends CarlosTestBase {
    ...
    void shouldPersistHrmDocumentComment_whenValidDataProvided() throws Exception {
        ...
        assertThat(hrmDocumentCommentDao.find(entity.getId())).isNotNull();
    }
}
