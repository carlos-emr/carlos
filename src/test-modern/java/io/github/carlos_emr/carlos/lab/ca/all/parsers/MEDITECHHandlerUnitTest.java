 ...
 *
 * <p>
 * Migrated from legacy JUnit 4 MEDITECHHandlerTest to JUnit 5 for the CARLOS EMR project (2026).
 */
...
/**
 * Unit tests for {@link MEDITECHHandler} (rural Ontario HL7 lab parser).
 *
 * <p>Parameterized tests that validate HL7 message parsing across all test data
 * from the MEDITECH test archive. Each HL7 message from the ZIP is parsed and
...
@DisplayName("MEDITECHHandler parameterized unit tests")
class MEDITECHHandlerUnitTest {
    ...
    private MEDITECHHandler createHandler(String hl7Body) throws HL7Exception {
    ...
    void shouldReturnMsgType_asMEDITECH(String hl7Body) throws HL7Exception {
        MEDITECHHandler handler = createHandler(hl7Body);
