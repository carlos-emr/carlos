...
/**
 * Integration tests for {@link TeleplanAdjCodesDao}.
 * <p>Migrated from legacy JUnit 4 / DaoTestFixtures.</p>
 * @since 2026-03-07
 */
@DisplayName("TeleplanAdjCodes Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("billing-bc")
@Transactional
public class TeleplanAdjCodesDaoIntegrationTest extends CarlosTestBase {

    @Autowired
    private TeleplanAdjCodesDao teleplanAdjCodesDao;
