...
@DisplayName("BillingCodeSearchDataAssembler")
@Tag("unit")
@Tag("billing")
class BillingCodeSearchDataAssemblerUnitTest {
    ...
    void shouldBuildServiceDescriptionPatternsFromRawInputs() {
        ...
        BillingCodeSearchDataAssembler assembler =
                new BillingCodeSearchDataAssembler(billingServiceDao, ichppccodeDao);
