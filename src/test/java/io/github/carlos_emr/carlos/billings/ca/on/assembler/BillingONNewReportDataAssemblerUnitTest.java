...
@DisplayName("BillingONNewReportDataAssembler")
@Tag("unit")
@Tag("billing")
class BillingONNewReportDataAssemblerUnitTest {

    @Test
    void shouldEncodePlainReportCellsBeforeRawJspRendering() {
        String cell = BillingONNewReportDataAssembler.htmlCell("<img src=x onerror=alert(1)>");
    ...
    void shouldEncodeBillingNoLinkTextAndUrlParameter() {
        String html = BillingONNewReportDataAssembler.buildBillingNoLinkWithTitle(
                "/ctx",
                "123\" onclick=\"alert(1)",
                "Bill <OHIP>");
