...
/**
 * Unit tests for {@link BillingOnCorrectionViewModelAssembler}, the read-side
 ...
 * @since 2026-04-25
 */
@DisplayName("BillingOnCorrectionViewModelAssembler")
@Tag("unit")
@Tag("billing")
class BillingOnCorrectionViewModelAssemblerUnitTest extends CarlosUnitTestBase {
    ...
    private BillingOnCorrectionViewModelAssembler assembler;
    ...
    void setUp() {
        ...
        assembler = new BillingOnCorrectionViewModelAssembler(
                securityInfoManager,
                providerDao,
                providerSiteDao,
                siteDao,
     ...
     * BillingOnCorrectionViewModelAssembler#loadBillRecord} flow had several
