...
/**
 * Unit tests for {@link InrUpdateINRBillingDataAssembler}, the assembler
 * that pulls demographic-display fields out of {@link DemographicDao} for
 * {@code inr/updateINRbilling.jsp}.
 *
 * @since 2026-04-26
 */
@DisplayName("InrUpdateINRBillingDataAssembler")
@Tag("unit")
@Tag("billing")
class InrUpdateINRBillingDataAssemblerUnitTest extends CarlosUnitTestBase {
    ...
    private InrUpdateINRBillingDataAssembler assembler;

    @BeforeEach
    void setUp() {
        mockitoCloseable = MockitoAnnotations.openMocks(this);
        request = new MockHttpServletRequest();
        assembler = new InrUpdateINRBillingDataAssembler(mockDemographicDao);
    }
