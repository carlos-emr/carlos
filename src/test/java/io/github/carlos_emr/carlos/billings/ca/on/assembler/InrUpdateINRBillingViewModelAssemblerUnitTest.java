...
/**
 * Unit tests for {@link InrUpdateINRBillingViewModelAssembler}, the assembler
 * that pulls demographic-display fields out of {@link DemographicDao} for
 * {@code inr/updateINRbilling.jsp}.
 *
 * @since 2026-04-26
 */
@DisplayName("InrUpdateINRBillingViewModelAssembler")
@Tag("unit")
@Tag("billing")
class InrUpdateINRBillingViewModelAssemblerUnitTest extends CarlosUnitTestBase {
    ...
    private InrUpdateINRBillingViewModelAssembler assembler;

    @BeforeEach
    void setUp() {
        mockitoCloseable = MockitoAnnotations.openMocks(this);
        request = new MockHttpServletRequest();
        assembler = new InrUpdateINRBillingViewModelAssembler(mockDemographicDao);
    }
    ...
    void shouldFormatHinAndDob_fromDemographicLookup() {
        ...
        InrUpdateINRBillingViewModel m = assembler.assemble(request);
