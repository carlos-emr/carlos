...
@DisplayName("ON BillingCodeLookup")
@Tag("unit")
@Tag("billing")
class BillingCodeLookupUnitTest {
    ...
    void shouldUseInjectedDao_whenSearchingMostRecentBillingCode() {
        ...
        BillingCodeLookup billingCodeData = new BillingCodeLookup(billingServiceDao);

        assertThat(billingCodeData.searchBillingCode("A001A"))
    ...
    void shouldUseInjectedDao_whenInsertingBillingCode() throws Exception {
        ...
        assertThat(billingCodeData.insertBillingCode("33.70", "A001A",
