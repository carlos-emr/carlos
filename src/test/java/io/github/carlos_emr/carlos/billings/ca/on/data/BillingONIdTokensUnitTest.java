 ...
 * {@link BillingONIdTokens#sanitize(String)} helper.
 *
 ...
 * @since 2026-04-25
 */
@DisplayName("BillingONIdTokens.sanitize")
@Tag("unit")
@Tag("billing")
class BillingONIdTokensUnitTest {

    @Test
    @DisplayName("should return empty string for null input")
    void shouldReturnEmptyString_forNullInput() {
        assertThat(BillingONIdTokens.sanitize(null)).isEqualTo("");
    }

    @Test
    @DisplayName("should leave alphanumeric codes unchanged")
    void shouldLeaveCodeUnchanged_whenAlphanumeric() {
        assertThat(BillingONIdTokens.sanitize("0010")).isEqualTo("0010");
        assertThat(BillingONIdTokens.sanitize("PRI")).isEqualTo("PRI");
        assertThat(BillingONIdTokens.sanitize("ABC123")).isEqualTo("ABC123");
    }
    ...
    void shouldPreserveHyphenAndUnderscore_whenInputContainsThem() {
        assertThat(BillingONIdTokens.sanitize("safe-id_1")).isEqualTo("safe-id_1");
        assertThat(BillingONIdTokens.sanitize("_-_-_")).isEqualTo("_-_-_");
    }

    @Test
    @DisplayName("should replace whitespace with underscore")
    void shouldReplaceWhitespace_withUnderscore() {
        assertThat(BillingONIdTokens.sanitize("FOO BAR")).isEqualTo("FOO_BAR");
        assertThat(BillingONIdTokens.sanitize("A\tB")).isEqualTo("A_B");
        assertThat(BillingONIdTokens.sanitize(" leading"))
                .isEqualTo("_leading");
        assertThat(BillingONIdTokens.sanitize("trailing "))
                .isEqualTo("trailing_");
    }
    ...
    void shouldReplaceHtmlSignificantChars_withUnderscore() {
        assertThat(BillingONIdTokens.sanitize("A&B<C>")).isEqualTo("A_B_C_");
        assertThat(BillingONIdTokens.sanitize("\"quoted\"")).isEqualTo("_quoted_");
        assertThat(BillingONIdTokens.sanitize("a'b")).isEqualTo("a_b");
    }
    ...
    void shouldReplaceUriSignificantChars_withUnderscore() {
        assertThat(BillingONIdTokens.sanitize("a/b")).isEqualTo("a_b");
        assertThat(BillingONIdTokens.sanitize("a?b=c"))
                .isEqualTo("a_b_c");
        assertThat(BillingONIdTokens.sanitize("a;jsessionid=x"))
    ...
    void shouldReturnEmptyString_forEmptyInput() {
        assertThat(BillingONIdTokens.sanitize("")).isEqualTo("");
    }
    ...
    void shouldProduceWellFormedToken_whenAllCharsAreReplaced() {
        ...
        assertThat(BillingONIdTokens.sanitize("!@#$%"))
                .isEqualTo("_____");
    }
    ...
    void shouldReplaceNonAsciiLetters_withUnderscore() {
        ...
        assertThat(BillingONIdTokens.sanitize("Café"))
                .isEqualTo("Caf_");
        assertThat(BillingONIdTokens.sanitize("mañana"))
                .isEqualTo("ma_ana");
        ...
        assertThat(BillingONIdTokens.sanitize("日本"))
                .matches("_+");
    }
    ...
    void shouldPreserveHyphen_adjacentToReplacedChar() {
        ...
        // "a__b" or "a-b".
        assertThat(BillingONIdTokens.sanitize("a- b"))
                .isEqualTo("a-_b");
        assertThat(BillingONIdTokens.sanitize("-a-"))
                .isEqualTo("-a-");
        assertThat(BillingONIdTokens.sanitize("a -b"))
                .isEqualTo("a_-b");
    }
