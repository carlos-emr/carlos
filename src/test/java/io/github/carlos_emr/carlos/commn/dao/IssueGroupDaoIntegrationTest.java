...
/**
 * Integration tests for {@link IssueGroupDao} covering basic CRUD operations.
 *
 * <p>Migrated from legacy {@code IssueGroupDaoTest} (JUnit 4 / DaoTestFixtures).</p>
 *
 * @since 2026-03-07
 * @see IssueGroupDao
 */
@DisplayName("IssueGroup Dao Integration Tests")
@Tag("integration")
@Tag("dao")
@Tag("clinical")
@Transactional
public class IssueGroupDaoIntegrationTest extends CarlosTestBase {
