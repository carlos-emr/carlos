...
public class PreventionGuideLineTest {
    ...
    byte[] getRuleSet() throws Exception {
        try (InputStream is = this.getClass().getResourceAsStream("/io/github/carlos_emr/carlos/decisionSupport/prevention/guidelineExample.xml")) {
            assertNotNull("Test resource guidelineExample.xml should be present on the classpath", is);
