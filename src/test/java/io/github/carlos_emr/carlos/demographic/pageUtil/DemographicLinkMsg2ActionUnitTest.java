 ...
 * message link forwarding action, which requires read privilege on
 * {@code _demographic}.
 *
 * @since 2026-04-04
 */
...
@Tag("web")
@Tag("demographic")
class DemographicLinkMsg2ActionUnitTest extends CarlosWebTestBase {
    ...
    void setUp() {
        ...
        action = new DemographicLinkMsg2Action(mockSecurityInfoManager);
