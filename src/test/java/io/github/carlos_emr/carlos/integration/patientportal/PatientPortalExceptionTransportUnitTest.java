...
class PatientPortalExceptionTransportUnitTest {
    ...
    static Stream<Arguments> causes() {
        return Stream.of(
                ...
                Arguments.of(new org.apache.hc.client5.http.ConnectTimeoutException("Connect to portal.example timed out"),
                        "connect timeout"),
                Arguments.of(new org.apache.hc.client5.http.impl.classic.RequestFailedException("Request aborted"),
                        "request cancelled"),
