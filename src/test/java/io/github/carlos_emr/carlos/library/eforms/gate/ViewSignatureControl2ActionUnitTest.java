...
@DisplayName("ViewSignatureControl2Action Unit Tests")
@Tag("unit")
@Tag("gate")
class ViewSignatureControl2ActionUnitTest extends CarlosUnitTestBase {
    ...
    private ViewSignatureControl2Action action;
    ...
    void setUp() {
        ...
        when(mockSecurityInfoManager.hasPrivilege(any(LoggedInInfo.class), eq("_con"), eq("w"), isNull()))
                .thenReturn(true);
        action = new ViewSignatureControl2Action();
    }
