...
class EmailManagerPassphraseUnitTest extends CarlosUnitTestBase {
    ...
    void shouldNotPersistPassword_whenPreparingEmailForOutbox() {
        ...
        EmailManager emailManager = new EmailManager(mock(EmailConsentResolver.class), mock(EmailSenderFactory.class), securityInfoManager, org.mockito.Mockito.mock(OutboundEmailArchiveService.class));
    ...
    void shouldReportActiveStatus_whenSenderConfigIsChecked() {
        EmailConfigDaoImpl emailConfigDao = mock(EmailConfigDaoImpl.class);
        EmailManager emailManager = new EmailManager(mock(EmailConsentResolver.class), mock(EmailSenderFactory.class), mock(SecurityInfoManager.class), org.mockito.Mockito.mock(OutboundEmailArchiveService.class));
        injectDependency(emailManager, "emailConfigDao", emailConfigDao);
