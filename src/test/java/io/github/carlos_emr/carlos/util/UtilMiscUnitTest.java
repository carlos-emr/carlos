...
class UtilMiscUnitTest {
    ...
    class RhtmlEscape {
        ...
        @Test
        void shouldPreserveUnknownAndIncompleteEntities_withoutDoubleDecoding() {
            assertThat(UtilMisc.rhtmlEscape("&unknown; &am; &lt &amp;lt;"))
                    .isEqualTo("&unknown; &am; &lt &lt;");
            assertThat(UtilMisc.rhtmlEscape("&AMP;&LT;&GT;&QUOT;"))
                    .isEqualTo("&<>\"");
        }
