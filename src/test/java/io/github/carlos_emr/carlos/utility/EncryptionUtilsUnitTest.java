...
@Tag("utility")
@Tag("security")
@org.junit.jupiter.api.parallel.Isolated("Mutates shared legacy state")
class EncryptionUtilsUnitTest {
    ...
    class AesGcmStringEncryption {
        ...
        @Test
        void shouldRejectTamperedCiphertext_withAuthenticationFailure() throws Exception {
            byte[] encrypted = EncryptionUtils.encrypt("synthetic data".getBytes(java.nio.charset.StandardCharsets.UTF_8));
