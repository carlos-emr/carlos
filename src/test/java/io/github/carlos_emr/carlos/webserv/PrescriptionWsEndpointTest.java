...
class PrescriptionWsEndpointTest extends CarlosSoapTestBase {
    ...
    class GetPrescription {
        ...
        void shouldReturnPrescriptionTransfer_whenFound() {
            ...
            prescription.setComments("Synthetic prescription");
            ...
            assertThat(result.getComments()).isEqualTo("Synthetic prescription");
        }
    ...
    class GetPrescriptionUpdatedAfterDate {
        ...
        void shouldReturnPrescriptionArray_whenResultsExist() {
            ...
            p.setComments("Synthetic prescription");
            prescriptions.add(p);
            ...
            assertThat(result[0].getComments()).isEqualTo("Synthetic prescription");
        }

        @Test

        @DisplayName("should contain no SOAP entries when no results")
        void shouldContainNoSoapEntries_whenNoResults() {
            when(prescriptionManager.getPrescriptionUpdatedAfterDate(any(LoggedInInfo.class), any(Date.class), anyInt()))
            ...
            // SOAP omits an empty return array, which JAXB may deserialize as null.
