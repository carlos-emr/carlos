...
class ProviderWsEndpointTest extends CarlosSoapTestBase {
    ...
    void shouldReturnLoggedInProviderTransfer_viaSoap() {
        ...
        assertThat(result.getProviderNo()).isEqualTo("999998");
        assertThat(result.getLastName()).isEqualTo("Doctor");
    }
    ...
    void shouldReturnActiveProviders_viaSoap() {
        ...
        assertThat(results[0].getProviderNo()).isEqualTo("100");
    }
    ...
    void shouldReturnProviderProperties_viaSoap() {
        ...
        property.setName("rxAddress");
        property.setValue("Synthetic clinic address");
        ...
        assertThat(results).hasSize(1);
        assertThat(results[0].getValue()).isEqualTo("Synthetic clinic address");
    }
}
