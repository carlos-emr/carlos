...
/**
 * CXF local-transport endpoint tests for {@link ConsultationWebService} using CXF local transport.
 *
...
class ConsultationWebServiceEndpointTest extends CarlosRestTestBase {
    ...
    protected Object getServiceBean() {
        registerMock(io.github.carlos_emr.carlos.commn.dao.DocumentDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.DocumentDao.class));
        registerMock(io.github.carlos_emr.carlos.managers.ProgramManager2.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.managers.ProgramManager2.class));
        registerMock(io.github.carlos_emr.carlos.commn.dao.EFormDataDao.class,
        ...
        registerMock(io.github.carlos_emr.carlos.commn.dao.ProviderLabRoutingDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.ProviderLabRoutingDao.class));
        registerMock(io.github.carlos_emr.carlos.commn.dao.QueueDocumentLinkDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.QueueDocumentLinkDao.class));
        registerMock(io.github.carlos_emr.carlos.managers.SecurityInfoManager.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.managers.SecurityInfoManager.class));
        registerMock(io.github.carlos_emr.carlos.commn.dao.ConsultDocsDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.ConsultDocsDao.class));
        registerMock(io.github.carlos_emr.carlos.commn.dao.ConsultResponseDocDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.ConsultResponseDocDao.class));
        registerMock(io.github.carlos_emr.carlos.commn.dao.LabPatientPhysicianInfoDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.LabPatientPhysicianInfoDao.class));
        registerMock(io.github.carlos_emr.carlos.commn.dao.EFormDocsDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.EFormDocsDao.class));
    ...
    class SearchRequests {
        ...
        void shouldReturn200WithResults_whenConsultationsFound() {
            ...
            result.setServiceName("Cardiology");
            results.add(result);
            ...
            assertThat(wireJson.at("/content/0/serviceName").textValue()).isEqualTo("Cardiology");
        }
    ...
    class GetRequest {
        ...
        void shouldReturn200WithRequest_whenValidIdProvided() {
            ...
            var clinic = new io.github.carlos_emr.carlos.commn.model.Clinic();
            clinic.setClinicName("Synthetic Clinic");
            when(mockClinicDAO.getClinic()).thenReturn(clinic);
            // No lab integrations are configured in this endpoint fixture. Keep
            // singleton properties scoped to the request, on the CXF caller thread.
            try (var properties = org.mockito.Mockito.mockStatic(io.github.carlos_emr.CarlosProperties.class)) {
                properties.when(io.github.carlos_emr.CarlosProperties::getInstance)
                        .thenReturn(org.mockito.Mockito.mock(io.github.carlos_emr.CarlosProperties.class));
                ...
                assertThat(response.getStatus()).isEqualTo(200);
                var wireJson = responseJson(response);
                assertThat(wireJson.at("/demographicId").intValue()).isEqualTo(1);
                assertThat(wireJson.at("/providerNo").textValue()).isEqualTo("999001");
            }
