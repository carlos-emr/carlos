...
/**
 * CXF local-transport endpoint tests for {@link DemographicMergeService} using CXF local transport.
 *
 * @since 2026-03-31
...
class DemographicMergeServiceEndpointTest extends CarlosRestTestBase {
    ...
    protected Object getServiceBean() {
        ...
        var security = org.mockito.Mockito.mock(io.github.carlos_emr.carlos.managers.SecurityInfoManager.class);
        org.mockito.Mockito.when(security.hasPrivilege(org.mockito.ArgumentMatchers.any(),
                org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.anyString(),
                org.mockito.ArgumentMatchers.isNull())).thenReturn(true);
    ...
    class GetMergedDemographics {
        ...
        void shouldReturn200_whenMergedDemographicsExist() {
            ...
            assertThat(wireJson.at("/Item/0/demographicNo").intValue()).isEqualTo(0);
        }
