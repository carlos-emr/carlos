...
/**
 * CXF local-transport endpoint tests for {@link FormsService} using CXF local transport.
 *
...
class FormsServiceEndpointTest extends CarlosRestTestBase {
    ...
    class GetAllEForms {
        ...
        void shouldReturn200WithAllEFormNames_whenEFormsExist() {
            ...
            assertThat(wireJson.at("/content/0/formName").textValue()).isEqualTo("Intake Form");
        }
    ...
    class GetAllEncounterForms {
        ...
        void shouldReturn200WithAllEncounterForms_whenFormsExist() {
            ...
            assertThat(wireJson.at("/content").isArray()).isTrue();
            assertThat(wireJson.at("/content")).hasSize(1);
            assertThat(wireJson.at("/content/0/formName").textValue()).isEqualTo("Physical Exam");
            assertThat(wireJson.at("/content/0/formTable").textValue()).isEqualTo("formPhysicalExam");
        }
    }
    ...
    class GetGroupNames {
        ...
        void shouldReturn200WithGroupNames_whenGroupsExist() {
            ...
            assertThat(wireJson.at("/content/0").textValue()).isEqualTo("Cardiology");
            assertThat(wireJson.at("/content/1").textValue()).isEqualTo("Neurology");
        }
