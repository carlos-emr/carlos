...
/**
 * CXF local-transport endpoint tests for {@link PatientDetailStatusService} using CXF local transport.
 *
 * @since 2026-03-31
...
class PatientDetailStatusServiceEndpointTest extends CarlosRestTestBase {
    ...
    void shouldRejectAccessBeforeLookup_whenPrivilegeIsDenied() {
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(() -> request().path("/patientDetailStatusService/getStatus").get())
    ...
    class GetStatus {
        ...
        void shouldReturn200_withStatus() {
            ...
            assertThat(wireJson.at("/billregion").textValue()).isEqualTo("BC");
            assertThat(wireJson.at("/defaultView").textValue()).isEqualTo("summary");
        }
    }
    ...
    class IsUniqueHC {
        ...
        void shouldReturn200Success_whenHinIsUnique() {
            ...
            assertThat(response.getStatus()).isEqualTo(200);
            assertThat(response.readEntity(String.class)).contains("\"status\":\"SUCCESS\"");
        }
