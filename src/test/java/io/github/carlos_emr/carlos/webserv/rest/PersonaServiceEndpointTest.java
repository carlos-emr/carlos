...
/**
 * CXF local-transport endpoint tests for {@link PersonaService} using CXF local transport.
 *
...
class PersonaServiceEndpointTest extends CarlosRestTestBase {
    ...
    class HasRight {
        ...
        void shouldReturnError_whenPrivilegeDenied() {
            ...
            assertThat(response.getStatus()).isEqualTo(200);
            var wireJson = responseJson(response);
            assertThat(wireJson.at("/error/message").textValue()).isEqualTo("Access denied");
    ...
    class GetMyNavbar {
        ...
        void shouldReturn200WithNavbar_whenProviderHasPrograms() {
            ...
            assertThat(response.getStatus()).isEqualTo(200);
            var wireJson = responseJson(response);
            assertThat(wireJson.at("/menus/patientSearchMenu/items").isArray()).isTrue();
            assertThat(wireJson.at("/menus/patientSearchMenu/items")).hasSize(2);
            assertThat(wireJson.at("/menus/patientSearchMenu/items/0/id").intValue()).isEqualTo(0);
            assertThat(wireJson.at("/menus/patientSearchMenu/items/0/label").textValue()).isEqualTo("New patient");
            assertThat(wireJson.at("/menus/patientSearchMenu/items/1/id").intValue()).isEqualTo(1);
            assertThat(wireJson.at("/menus/patientSearchMenu/items/1/label").textValue()).isEqualTo("Advanced search");
            assertThat(wireJson.at("/menus/menu/items").isArray()).isTrue();
            assertThat(wireJson.at("/menus/menu/items")).hasSize(7);
            assertThat(wireJson.at("/menus/menu/items/0/id").intValue()).isEqualTo(0);
            assertThat(wireJson.at("/menus/menu/items/0/label").textValue()).isEqualTo("Schedule");
            assertThat(wireJson.at("/menus/menu/items/1/id").intValue()).isEqualTo(1);
            assertThat(wireJson.at("/menus/menu/items/1/label").textValue()).isEqualTo("Inbox");
            assertThat(wireJson.at("/menus/userMenu/items").isArray()).isTrue();
            assertThat(wireJson.at("/menus/userMenu/items")).hasSize(3);
            assertThat(wireJson.at("/menus/userMenu/items/0/id").intValue()).isEqualTo(0);
            assertThat(wireJson.at("/menus/userMenu/items/0/label").textValue()).isEqualTo("Settings");
            assertThat(wireJson.at("/menus/userMenu/items/1/id").intValue()).isEqualTo(1);
            assertThat(wireJson.at("/menus/userMenu/items/1/label").textValue()).isEqualTo("Support");
            assertThat(wireJson.at("/menus/messengerMenu/items").isArray()).isTrue();
            assertThat(wireJson.at("/menus/messengerMenu/items")).hasSize(2);
            assertThat(wireJson.at("/menus/messengerMenu/items/0/id").intValue()).isEqualTo(0);
            assertThat(wireJson.at("/menus/messengerMenu/items/0/label").textValue()).isEqualTo("Patient messages");
            assertThat(wireJson.at("/menus/messengerMenu/items/1/id").intValue()).isEqualTo(1);
            assertThat(wireJson.at("/menus/messengerMenu/items/1/label").textValue()).isEqualTo("Messages");
            assertThat(wireJson.at("/program").isArray()).isTrue();
