...
/**
 * CXF local-transport endpoint tests for {@link ProviderService} using CXF local transport.
 *
...
class ProviderServiceEndpointTest extends CarlosRestTestBase {
    ...
    class GetProvidersAsJSON {
        ...
        void shouldReturn200WithProviders_whenActiveProvidersExist() {
            ...
            assertThat(wireJson.at("/content/0/providerNo").textValue()).isEqualTo("100");
            assertThat(wireJson.at("/content/0/lastName").textValue()).isEqualTo("Smith");
            assertThat(wireJson.at("/content/0/firstName").textValue()).isEqualTo("John");
            assertThat(wireJson.at("/content/0/name").textValue()).isEqualTo("Smith, John");
        }
    ...
    class GetLoggedInProvider {
        ...
        void shouldReturn200WithProvider_whenProviderLoggedIn() {
            ...
            assertThat(response.getStatus()).isEqualTo(200);
            var wireJson = responseJson(response);
            assertThat(wireJson.at("/providerNo").textValue()).isEqualTo("100");
            assertThat(wireJson.at("/lastName").textValue()).isEqualTo("Smith");
            assertThat(wireJson.at("/firstName").textValue()).isEqualTo("John");
            assertThat(wireJson.at("/id").textValue()).isEqualTo("100");
        }
        ...
        void shouldReturn404_whenNoProviderLoggedIn() {
            ...
            var wireJson = responseJson(response);
            assertThat(wireJson.at("/error").textValue()).isEqualTo("Provider not found");
        }
    }
    ...
    class GetActiveTeams {
        ...
        void shouldReturn200WithTeams_whenActiveTeamsExist() {
            ...
            assertThat(wireJson.at("/content/0").textValue()).isEqualTo("TeamA");
            assertThat(wireJson.at("/content/1").textValue()).isEqualTo("TeamB");
        }
