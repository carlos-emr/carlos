...
/**
 * CXF local-transport endpoint tests for {@link ReportingService} using CXF local transport.
 *
...
class ReportingServiceEndpointTest extends CarlosRestTestBase {
    ...
    void authorizeFixture() {
        registerMock(io.github.carlos_emr.carlos.commn.dao.EFormDao.class,
                org.mockito.Mockito.mock(io.github.carlos_emr.carlos.commn.dao.EFormDao.class));
    ...
    void shouldRejectAccessBeforeLookup_whenPrivilegeIsDenied() {
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(() -> request().path("/reporting/demographicSets/list").get())
        ...
        org.mockito.Mockito.verifyNoInteractions(mockDemographicSetsManager);
    }
    ...
    class ListDemographicSets {
        ...
        void shouldReturn200WithSetNames_whenSetsExist() {
            ...
            assertThat(wireJson.at("/total").intValue()).isEqualTo(2);
            assertThat(wireJson.at("/content").isArray()).isTrue();
            assertThat(wireJson.at("/content")).hasSize(2);
            assertThat(wireJson.at("/content/0").textValue()).isEqualTo("Diabetes Patients");
            assertThat(wireJson.at("/content/1").textValue()).isEqualTo("Heart Failure Cohort");
        }
    ...
    class EformReportToolList {
        ...
        void shouldReturn200WithEntries_whenReportToolsExist() {
            ...
            assertThat(wireJson.at("/content/0/id").intValue()).isEqualTo(1);
            assertThat(wireJson.at("/content/0/name").textValue()).isEqualTo("Blood Pressure Tracker");
        }
    ...
    class GetPreventionReports {
        ...
        void shouldReturn200WithReports_whenReportsExist() {
            ...
            assertThat(wireJson).hasSize(1);
            assertThat(wireJson.at("/0/label").textValue()).isEqualTo("(null) Flu Vaccination Report");
        }
