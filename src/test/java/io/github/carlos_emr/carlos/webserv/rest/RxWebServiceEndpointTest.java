...
/**
 * CXF local-transport endpoint tests for {@link RxWebService} using CXF local transport.
 *
...
class RxWebServiceEndpointTest extends CarlosRestTestBase {
    ...
    private DrugTo1 aspirinTransfer() {
    ...
    class GetAllDrugs {
        ...
        void shouldReturn200_whenDrugsExist() throws Exception {
            ...
            assertThat(wireJson.at("/drug").isArray()).isTrue();
            assertThat(wireJson.at("/drug")).hasSize(1);
            assertThat(wireJson.at("/drug/0/brandName").textValue()).isEqualTo("Aspirin");
            assertThat(wireJson.at("/drug/0/drugId").intValue()).isEqualTo(1);
            assertThat(wireJson.at("/drug/0/brandName").textValue()).isEqualTo("Aspirin");
        }
        ...
        void shouldReturn200WithEmptyList_whenNoDrugs() throws Exception {
            ...
            assertThat(wireJson.at("/total").intValue()).isEqualTo(0);
            assertThat(wireJson.at("/drug").isArray()).isTrue();
            assertThat(wireJson.at("/drug")).hasSize(0);
        }
    }
    ...
    class GetCurrentDrugs {
        ...
        void shouldReturn200_whenCurrentDrugsExist() throws Exception {
            ...
            when(mockRxManager.getDrugs(any(LoggedInInfo.class), eq(1), eq(RxManager.CURRENT)))
                .thenReturn(List.of(drug));
            when(mockDrugConverter.getAllAsTransferObjects(any(LoggedInInfo.class), any()))
                .thenReturn(List.of(aspirinTransfer()));
    ...
    class GetRxStatus {
        ...
        void shouldReturn200_withStatusValues() {
            ...
            assertThat(wireJson.at("/0").textValue()).isEqualTo("ALL");
            assertThat(wireJson.at("/1").textValue()).isEqualTo("CURRENT");
        }
    }
}
